...
function harness() {
  ...
  const impl = {
    ...
    agentsStop: make("agentsStop", true),
    agentsNew: make("agentsNew", true),
    agentsRemove: make("agentsRemove", true),
    ...
    logsPanel: make("logsPanel", false),
    ...
    runProvider: make("runProvider", false),
...
describe("runRuntimeRequest", () => {
  ...
  it.each([
    ...
    [{ feature: "agents", action: "stop", arg: "bg-1" }, "agentsStop"],
    [{ feature: "agents", action: "new", arg: "scout" }, "agentsNew"],
    [{ feature: "agents", action: "rm", arg: "scout" }, "agentsRemove"],
    ...
    [{ feature: "logs", action: "panel" }, "logsPanel"],
    ...
    [{ feature: "provider", action: "models" }, "runProvider"],
    [{ feature: "provider", action: "inspect", arg: "openai" }, "runProvider"],

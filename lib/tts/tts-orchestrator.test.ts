...
jest.mock("@/lib/tts/tts-cache", () => ({
  generateCacheKey: jest.fn(() => "cache-key"),
  getCachedOrGenerate: jest.fn(),
}))

jest.mock("@/lib/tts/providers/openai", () => ({
  generateOpenAITTS: jest.fn(),
}))
jest.mock("@/lib/tts/providers/gemini", () => ({
  generateGeminiTTS: jest.fn(),
}))
jest.mock("@/lib/tts/providers/edge", () => ({
  generateEdgeTTS: jest.fn(),
}))
jest.mock("@/lib/tts/providers/elevenlabs", () => ({
  generateElevenLabsTTS: jest.fn(),
}))
jest.mock("@/lib/tts/providers/lmnt", () => ({
  generateLMNTTTS: jest.fn(),
}))
jest.mock("@/lib/tts/providers/hume", () => ({
  generateHumeTTS: jest.fn(),
}))
jest.mock("@/lib/tts/providers/cartesia", () => ({
  generateCartesiaTTS: jest.fn(),
}))
jest.mock("@/lib/tts/providers/deepgram", () => ({
  generateDeepgramTTS: jest.fn(),
}))
jest.mock("@/lib/tts/providers/openai-realtime", () => ({
  synthesizeRealtimeStream: jest.fn(),
}))
jest.mock("@/lib/tts/streaming/pcm-player", () => ({

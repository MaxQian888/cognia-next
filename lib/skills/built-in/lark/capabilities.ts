...
export const LARK_CLI_CAPABILITY_MANIFEST = {
  ...
  "lark.calendar.list_calendars": ["calendar", "calendars", "list"],
  ...
  "lark.sheets.list_sheets": ["sheets", "+workbook-info"],
  ...
  "lark.task.search_tasklists": ["task", "+tasklist-search"],
...
export const LARK_CLI_REQUIRED_FLAGS = {
  ...
  "lark.calendar.list_calendars": ["--page-size"],
  ...
  "lark.sheets.list_sheets": ["--spreadsheet-token"],
  ...
  "lark.task.search_tasklists": ["--query", "--page-limit"],

...
jest.mock("./workspace/registry-controller", () => ({
...
jest.mock("./teammate/twin-context", () => ({
...
import { __setSquadReviewTestHooksForTesting, settleSquadReview } from "./gates/squad-review-gate"

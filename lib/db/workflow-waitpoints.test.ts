...
beforeEach(async () => {
  ...
  jest.mocked(decideNativeWorkflowWaitpoint).mockReset().mockResolvedValue(undefined)
  ...
  jest.mocked(pruneNativeWorkflowWaitEvents).mockReset().mockResolvedValue(undefined)

...
import {
  ...
  SmilePlus as ReactionIcon,
  Trash2 as DeleteIcon,
  Forward as ForwardIcon,
  MessageCircleReply as WaitReplyIcon,
...
const ICONS: Partial<Record<WorkflowNodeKind, LucideIcon>> = {
  ...
  "trigger.connector.system": BellIcon,
  ...
  "action.connector.reaction": ReactionIcon,
  "action.connector.delete": DeleteIcon,
  "action.connector.forward": ForwardIcon,
  "action.connector.waitReply": WaitReplyIcon,

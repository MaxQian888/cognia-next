...
const ACTION_SEGMENT_SECTION: Record<string, PaletteSection> = {
  ...
  approval: "human",
  humanInput: "human",
  // A notification is the non-blocking sibling of approval and human input:
  // same audience, same place in a graph, no waitpoint. A fourth section for
  // three nodes would split that reading for nothing.
  notify: "human",
  scheduler: "scheduler",
  browser: "browser",
  desktop: "desktop",

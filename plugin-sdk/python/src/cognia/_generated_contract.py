...
MANIFEST_CONTRIBUTIONS = [
    ...
    },
    {
        ...
        "execution": "javascript",
        "pythonExecution": "supported",
        "entryPath": "decisionProviders[].entry",
    },
    {
...
API_NAMESPACE_CONTRACTS = [
    ...
    },
    {
        ...
        "methods": [
            ...
            {
                "id": "agent.runCharacterTurn",
                "name": "runCharacterTurn",
                "requiredPermissions": [
                    "agent:control",
                ],
                "consentTier": "policy",
    ...
    {
        "id": "browser",
        "authorPath": "ctx.browser",
        "type": "PluginBrowserAPI",
        "stability": "stable",
        "introducedIn": "0.3.228",
        "runtimes": [
            "frontend",
            "hybrid",
        ],
        ...
        "methods": [
            {
                "id": "browser.isDomainAuthorized",
                "name": "isDomainAuthorized",
                "requiredPermissions": [
                    "agent:control",
                ],
                "consentTier": "policy",
            ...
            {
                "id": "browser.primeDomainGrants",
                "name": "primeDomainGrants",
                "requiredPermissions": [
                    "agent:control",
                ],
                "consentTier": "policy",
    ...
    {
        "id": "characterPacks",
        "authorPath": "ctx.characterPacks",
        "type": "PluginCharacterPacksAPI",
        "stability": "stable",
        "introducedIn": "0.3.228",
        "runtimes": [
            "frontend",
        ...
        "transport": "direct",
        "factory": "context.characterPacks",
        "enforcement": "shadow",
        "dataClassification": "internal",
        "timeoutMs": None,
        "retry": "never",
        ...
        "methods": [
            ...
            {
                "id": "characterPacks.listRegistered",
                "name": "listRegistered",
                "requiredPermissions": [],
                "consentTier": "none",
                "risk": "low",
    ...
    {
        "id": "decisions",
        "authorPath": "ctx.decisions",
        "type": "PluginDecisionsAPI",
        "stability": "stable",
        "introducedIn": "0.1.0",
        "runtimes": [
            "frontend",
        ...
        "methods": [
            ...
            {
                "id": "decisions.getSelectedProviderId",
                "name": "getSelectedProviderId",
                "requiredPermissions": [],
                "consentTier": "none",
                "risk": "low",
                "idempotent": True,
    ...
    },
    {
        ...
        "methods": [
            {
                "id": "resources.listAdapterInstances",
                "name": "listAdapterInstances",
                "requiredPermissions": [
                    "database:read",
                ],
                "consentTier": "policy",
    ...
    {
        "id": "recorder",
        "authorPath": "ctx.recorder",
        "type": "PluginRecorderAPI",
        "stability": "stable",
        "introducedIn": "0.3.228",
        "runtimes": [
            "frontend",
        ...
        "methods": [
            ...
            {
                "id": "recorder.listCaptureTargets",
                "name": "listCaptureTargets",
                "requiredPermissions": [
                    "native:screen",
                ],
                "consentTier": "policy",
            ...
            {
                "id": "recorder.listRecoverable",
                "name": "listRecoverable",
                "requiredPermissions": [
                    "media:image:read",
                ],
                "consentTier": "policy",
            ...
            {
                "id": "recorder.publishAvailability",
                "name": "publishAvailability",
                "requiredPermissions": [],
                "consentTier": "none",
                "risk": "low",
                "idempotent": False,
            ...
            {
                "id": "recorder.subscribeAvailability",
                "name": "subscribeAvailability",
                "requiredPermissions": [],
                "consentTier": "none",
                "risk": "low",
                "idempotent": False,
    ...
    },
    {
        ...
        "methods": [
            {
                "id": "sandbox.activeRefForSession",
                "name": "activeRefForSession",
                "requiredPermissions": [
                    "session:read",
                ],
                "consentTier": "policy",
            ...
            {
                "id": "sandbox.assertWritablePath",
                "name": "assertWritablePath",
                "requiredPermissions": [
                    "native:filesystem",
                ],
                "consentTier": "policy",
            ...
            {
                "id": "sandbox.decorateComputerUseContext",
                "name": "decorateComputerUseContext",
                "requiredPermissions": [
                    "native:input",
                    "session:read",
                ],
            ...
            {
                "id": "sandbox.registerMicrovmAdapter",
                "name": "registerMicrovmAdapter",
                "requiredPermissions": [
                    "native:process",
                ],
                "consentTier": "policy",
    ...
    {
        "id": "securityScans",
        "authorPath": "ctx.securityScans",
        "type": "PluginSecurityScansAPI",
        "stability": "stable",
        "introducedIn": "0.3.228",
        "runtimes": [
            "frontend",
        ...
        "methods": [
            {
                "id": "securityScans.registerRunController",
                "name": "registerRunController",
                "requiredPermissions": [
                    "terminal:kill",
                ],
                "consentTier": "policy",
            ...
            {
                "id": "securityScans.syncExecutionRun",
                "name": "syncExecutionRun",
                "requiredPermissions": [
                    "database:write",
                ],
                "consentTier": "policy",
    ...
    },
    {
        ...
        "methods": [
            ...
            {
                "id": "session.startSeededSession",
                "name": "startSeededSession",
                "requiredPermissions": [
                    "session:write",
                ],
                "consentTier": "policy",
    ...
    },
    {
        ...
        "methods": [
            {
                "id": "sites.getProductionUrl",
                "name": "getProductionUrl",
                "requiredPermissions": [
                    "database:read",
                ],
                "consentTier": "policy",
    ...
    {
        "id": "userScheduler",
        "authorPath": "ctx.userScheduler",
        "type": "PluginUserSchedulerAPI",
        "stability": "stable",
        "introducedIn": "0.3.228",
        "runtimes": [
            "frontend",
    ...
    },
    {
        ...
        "methods": [
            {
                "id": "workflow.approvalActorScope",
                "name": "approvalActorScope",
                "requiredPermissions": [],
                "consentTier": "none",
                "risk": "low",
                "idempotent": True,
            ...
            {
                "id": "workflow.autoLayoutEditor",
                "name": "autoLayoutEditor",
                "requiredPermissions": [
                    "canvas:write",
                ],
                "consentTier": "none",
            ...
            {
                "id": "workflow.buildApprovalSurface",
                "name": "buildApprovalSurface",
                "requiredPermissions": [],
                "consentTier": "none",
                "risk": "low",
                "idempotent": True,
            ...
            {
                "id": "workflow.executeRunWorkflowTyped",
                "name": "executeRunWorkflowTyped",
                "requiredPermissions": [
                    "canvas:run",
                ],
                "consentTier": "confirm",
            ...
            {
                "id": "workflow.explainEditorLastRun",
                "name": "explainEditorLastRun",
                "requiredPermissions": [
                    "workflow:read",
                ],
                "consentTier": "none",
            ...
            {
                "id": "workflow.explainEditorValidation",
                "name": "explainEditorValidation",
                "requiredPermissions": [
                    "workflow:read",
                ],
                "consentTier": "none",
            ...
            {
                "id": "workflow.findWorkflowById",
                "name": "findWorkflowById",
                "requiredPermissions": [
                    "workflow:read",
                ],
                "consentTier": "none",
            ...
            {
                "id": "workflow.findWorkflowByName",
                "name": "findWorkflowByName",
                "requiredPermissions": [
                    "workflow:read",
                ],
                "consentTier": "none",
            ...
            {
                "id": "workflow.getNodeCatalogEntry",
                "name": "getNodeCatalogEntry",
                "requiredPermissions": [
                    "workflow:read",
                ],
                "consentTier": "none",
            ...
            {
                "id": "workflow.getRunnerToolDefinition",
                "name": "getRunnerToolDefinition",
                "requiredPermissions": [
                    "workflow:read",
                ],
                "consentTier": "none",
            ...
            {
                "id": "workflow.listCopilotTemplates",
                "name": "listCopilotTemplates",
                "requiredPermissions": [
                    "workflow:read",
                ],
                "consentTier": "none",
            ...
            {
                "id": "workflow.listNodeCatalog",
                "name": "listNodeCatalog",
                "requiredPermissions": [
                    "workflow:read",
                ],
                "consentTier": "none",
            ...
            {
                "id": "workflow.listWorkflowSummaries",
                "name": "listWorkflowSummaries",
                "requiredPermissions": [
                    "workflow:read",
                ],
                "consentTier": "none",
            ...
            {
                "id": "workflow.materializeCopilotTemplate",
                "name": "materializeCopilotTemplate",
                "requiredPermissions": [
                    "workflow:read",
                ],
                "consentTier": "none",
            ...
            {
                "id": "workflow.recordCallbackBinding",
                "name": "recordCallbackBinding",
                "requiredPermissions": [
                    "connectors:send",
                ],
                "consentTier": "none",
            ...
            {
                "id": "workflow.refreshTemplateWarnings",
                "name": "refreshTemplateWarnings",
                "requiredPermissions": [],
                "consentTier": "none",
                "risk": "low",
                "idempotent": True,
            ...
            {
                "id": "workflow.resolveTriggerOrigin",
                "name": "resolveTriggerOrigin",
                "requiredPermissions": [
                    "session:read",
                ],
                "consentTier": "none",

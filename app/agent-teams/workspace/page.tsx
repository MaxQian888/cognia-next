 ...
 * build time. All callers route here via search params.
 */
...
export default function AgentTeamWorkspacePage() {
  // `useSearchParams()` is a CSR-only hook; wrap in Suspense so the static
  // export shell can prerender without bailing out at build time.
  return (

...
/**
 * Agent Teams workspace — per-team detail (client child).
 *
...
interface AgentTeamWorkspaceClientProps {
  params: Promise<{ teamId: string }>
}

export function AgentTeamWorkspaceClient({ params }: AgentTeamWorkspaceClientProps) {

...
- **Axes:** X at y=420 (baseline), Y at x=80. Both use system mono 8px gridline labels. Gridlines 4–6 per axis at equal intervals.
...
- **Labels on points (optional):** system mono 8px next to a point. Use a paper-fill rect mask behind the label. Label at most 2–3 points; not all.
...
- **Quadrant dividers (optional):** light dashed lines at the median x and y to split into quadrants. Label each quadrant in system mono 8px, muted.

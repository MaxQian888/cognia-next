...
- **Left label column:** x=20–200 (180px). Task names in system sans sans 11px 600. Phase labels as system mono 7px eyebrows above each group.
...
- **Time axis:** system mono 8px week/month labels at x=200+i×pitch, y=56 (just above first task row). A hairline separator at y=64.
...
<text x="X_start+8" y="ROW_Y+25" fill="#2d3142" font-size="10" font-weight="600"
      font-family="system-ui, sans-serif">Task name</text>
...
<text x="X_start+8" y="ROW_Y+25" fill="#eb6c36" font-size="10" font-weight="600"
      font-family="system-ui, sans-serif">Key task</text>
```

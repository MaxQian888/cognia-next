...
- **Set labels** placed outside the circle, NEVER crossing the stroke. system sans 12–14px 600 for the set name, optional system mono 9px sublabel.
- **system sanssection labels** placed inside the overlap region, system sans 12px 600, centered. For small overlaps, use a leader line to a label in clear space.

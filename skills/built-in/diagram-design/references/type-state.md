...
## Layout conventions
- States are rounded rectangles (`rx=8`), labeled in system sans.
- **Start**: filled ink dot (`r=6`). **End**: ringed dot (outer `r=8` outline, inner filled `r=5`).
- Transitions: curved arrows labeled in system mono as `event [guard] / action` (omit sections you don't need).

...
- Each level labeled at the top-left in system mono eyebrow style (7–8px, letter-spacing 0.14em). Labels sit on a paper-colored mask rect over the ring's top border.
...
- Italic system serif callouts (see `references/primitive-annotation.md`) — 1–2 max.

...
- Each layer has:
  - **Name label** centered inside the trapezoid — system sans 12–14px 600.
  - **Sublabel** below or beside the name — system mono 9–10px.
...
- Optional left-margin axis arrow + system mono label (`rarer ↑`, `drop-off ↓`).

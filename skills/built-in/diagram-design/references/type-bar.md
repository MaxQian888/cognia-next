...
- **Y-axis labels:** right-aligned system mono 8px muted, at x=72 (8px left of the plot area).
- **X-axis labels:** centered below each bar, system sans sans 11px 600 for category names.
- **Value labels:** system mono 8px above each bar. Focal bar label in accent; others in muted.
...
<text x="X+W/2" y="Y-8" fill="#4f5d75" font-size="8" font-family="ui-monospace, monospace" text-anchor="middle">VALUE</text>
```

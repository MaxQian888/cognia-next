...
/**
 * Standard Anthropic-wire model ids that Claude-Code relays route by default
 * (opus / sonnet / haiku). Used as the model list for pass-through relays that
 * forward Claude's own model names rather than exposing their own catalog.
 */
const CLAUDE_WIRE_MODEL_IDS = ["claude-opus-4-8", "claude-sonnet-4-6", "claude-haiku-4-5-20251001"]
...
export const BUILT_IN_PROVIDER_IDS = [
  ...
  // expansion). family "anthropic-native" → surfaced as one-click Anthropic
  // subscription preset templates (via `buildPresetTemplates`) and matched by
  // the quota/balance sources (GLM / Kimi / MiniMax windows; DeepSeek /
  // OpenRouter / SiliconFlow / Novita / Kimi balances). Distinct ids from the
  // existing OpenAI-compatible entries of the same brand (different wire).
  "deepseek-anthropic",
  "glm-anthropic",
  "glm-anthropic-intl",
  "kimi-anthropic",
...
const CATALOG_ENTRIES: Record<BuiltInProviderId, BuiltInProviderCatalogEntry> = {
  openai: {
    ...
    models: [
      ...
      },
      {
        ...
        supportsStreaming: true,
        supportsReasoning: true,
        pricing: { promptPer1M: 2.5, completionPer1M: 15, cachedInputPer1M: 0.25 },
      },
      {
        id: "gpt-5.6-luna",
        name: "GPT-5.6 Luna",
        ...
        supportsStreaming: true,
        supportsReasoning: true,
        pricing: { promptPer1M: 1, completionPer1M: 6, cachedInputPer1M: 0.1 },
      },
    ],
  },
  anthropic: {
    ...
    models: [
      {
        ...
        supportsReasoning: true,
        recommendedFor: ["coding"],
        pricing: { promptPer1M: 10, completionPer1M: 50 },
      },
      {
        id: "claude-opus-4-8",
  ...
  google: {
    ...
    category: "flagship",
    description:
      "Gemini 3.6 Flash, 3.5 Flash-Lite, and multimodal Gemini models with 1M context windows",
    ...
    models: [
      {
        ...
        supportsVideo: true,
        supportsReasoning: true,
        pricing: { promptPer1M: 1.5, completionPer1M: 7.5 },
      },
      {
  ...
  groq: {
    ...
    category: "specialized",
    description: "Ultra-fast production inference for GPT-OSS, Qwen, and Groq Compound systems",
    ...
    models: [
      ...
      },
      {
        ...
        supportsVideo: false,
        supportsReasoning: true,
        pricing: { promptPer1M: 0.6, completionPer1M: 3 },
      },
      {
        id: "groq/compound",
        name: "Groq Compound",
  ...
  mistral: {
    ...
    defaultEnabled: false,
    category: "specialized",
    description: "European AI company — Mistral Medium 3.5, Small 4, Large 3, and Codestral",
    ...
    models: [
      {
        ...
        supportsVideo: false,
        supportsReasoning: true,
        pricing: { promptPer1M: 2, completionPer1M: 6, cachedInputPer1M: 0.3 },
      },
      {
        id: "grok-4.1",
        name: "Grok 4.1",
  ...
  // 2026-06-07). API keys come either from Settings → Providers or — when
  // left blank — from the active subscription-vault account (auto-fallback in
  // build-options).
  opencode: {
    id: "opencode",
    name: "OpenCode Zen",
    ...
    category: "aggregator",
    description:
      "OpenCode Zen — pay-per-request gateway to curated coding models (Claude, GPT, Gemini, Kimi, GLM, Qwen)",
  ...
  "opencode-go": {
    ...
    category: "aggregator",
    description:
      "OpenCode Go — flat-rate subscription for open coding models (Kimi, GLM, Qwen, MiniMax, DeepSeek, MiMo)",
  ...
  codex: {
    ...
    quickAdd: { mode: "shortcut", category: "global" },
    // Mirrors the Codex model picker (developers.openai.com/codex/models):
    // the GPT-5.6 family, then GPT-5.5 and the GPT-5.4 tier as fallbacks.
    // `gpt-5.2` and `gpt-5.3-codex` are deprecated in Codex under a ChatGPT
    // login, and the whole 5.1/5.2-codex generation they belonged to is gone
    // from the picker — so none of them are listed here. `gpt-5.3-codex-spark`
    // is omitted deliberately: it is a ChatGPT-Pro research preview with no
    // public API model page, so an API-key config could not call it.
    models: [
      {
        id: "gpt-5.6-sol",
        name: "GPT-5.6 Sol",
      ...
      },
      {
        ...
        supportsReasoning: true,
        recommendedFor: ["coding"],
        pricing: { promptPer1M: 0.75, completionPer1M: 4.5, cachedInputPer1M: 0.075 },
      },
    ],
  },
  cohere: {
  ...
  moonshot: {
    ...
    category: "specialized",
    description: "Kimi K2 family models with long-context options",
    ...
    // Refreshed to the current Kimi K2 coding model (verified on the same
    // api.moonshot.cn/v1 endpoint via cc-switch v3.17) merged with the legacy
    // moonshot-v1-* ids (kept for backward compatibility).
  ...
  // -------------------------------------------------------------------------
  // cc-switch Anthropic-wire relay presets (subscription provider expansion).
  // Each points Claude Code / the sidecar at a third-party ANTHROPIC_BASE_URL.
  // `family: "anthropic-native"` makes them one-click Anthropic subscription
  // preset templates; `defaultModel` is aligned to cognia's existing catalog
  // for that brand (Claude default for pure claude relays). Endpoints verified
  // against cc-switch v3.17 `src/config/claudeProviderPresets.ts`.
  // -------------------------------------------------------------------------
  "deepseek-anthropic": {
    ...
    category: "specialized",
    description: "Route Claude Code through DeepSeek's Anthropic-compatible endpoint.",
  ...
  "glm-anthropic": {
    ...
    category: "specialized",
    description: "Zhipu GLM Coding Plan (CN) over the Anthropic wire, with 5h/weekly quota.",
    website: "https://open.bigmodel.cn",
    quickAdd: { mode: "shortcut", category: "china" },
  },
  "glm-anthropic-intl": {
    ...
    category: "specialized",
    description: "Zhipu GLM Coding Plan (international Z.ai host) over the Anthropic wire.",
    website: "https://z.ai",
    quickAdd: { mode: "shortcut", category: "global" },
  },
  "kimi-anthropic": {
    ...
    baseURLRequired: false,
    defaultModel: "kimi-k2.7-code",
    models: createQuickAddModelEntries(["kimi-k2.7-code"]),
    defaultEnabled: false,
    defaultBaseURL: "https://api.moonshot.cn/anthropic",
    category: "specialized",
    description: "Moonshot Kimi over the Anthropic wire; shows the Moonshot credit balance.",
  ...
  "kimi-coding": {
    ...
    models: createQuickAddModelEntries(["kimi-for-coding"]),
    defaultEnabled: false,
    defaultBaseURL: "https://api.kimi.com/coding/",
    category: "specialized",
    description: "Kimi For Coding subscription plan, with 5-hour usage quota.",
  ...
  "minimax-anthropic": {
    ...
    category: "specialized",
    description: "MiniMax Token Plan (CN) over the Anthropic wire, with 5h/weekly quota.",
  ...
  "minimax-anthropic-intl": {
    ...
    category: "specialized",
    description: "MiniMax Token Plan (international host) over the Anthropic wire.",
  ...
  "stepfun-anthropic": {
    ...
    category: "specialized",
    description: "StepFun (阶跃星辰) Step Plan over the Anthropic wire; shows the CNY balance.",
  ...
  "volcengine-agentplan": {
    ...
    models: createQuickAddModelEntries(["ark-code-latest", "doubao-pro-256k"]),
    defaultEnabled: false,
    defaultBaseURL: "https://ark.cn-beijing.volces.com/api/coding",
    category: "specialized",
    description: "Volcengine Ark Agent Plan (火山方舟) over the Anthropic wire.",
  ...
  "longcat-anthropic": {
    ...
    models: createQuickAddModelEntries(["LongCat-2.0"]),
    defaultEnabled: false,
    defaultBaseURL: "https://api.longcat.chat/anthropic",
    category: "specialized",
    description: "Meituan LongCat over the Anthropic wire.",
  ...
  "qianfan-coding": {
    ...
    models: createQuickAddModelEntries(["qianfan-code-latest"]),
    defaultEnabled: false,
    defaultBaseURL: "https://qianfan.baidubce.com/anthropic/coding",
    category: "specialized",
    description: "Baidu Qianfan Coding Plan over the Anthropic wire.",
  ...
  "bailian-anthropic": {
    ...
    baseURLRequired: false,
    defaultModel: "claude-sonnet-4-6",
    models: createQuickAddModelEntries([...CLAUDE_WIRE_MODEL_IDS]),
    defaultEnabled: false,
    defaultBaseURL: "https://dashscope.aliyuncs.com/apps/anthropic",
    category: "specialized",
    description: "Alibaba Cloud Bailian (百炼 / DashScope) over the Anthropic wire.",
  ...
  "xiaomi-mimo-anthropic": {
    ...
    models: createQuickAddModelEntries(["mimo-v2.5-pro"]),
    defaultEnabled: false,
    defaultBaseURL: "https://api.xiaomimimo.com/anthropic",
    category: "specialized",
    description: "Xiaomi MiMo over the Anthropic wire.",
  ...
  "openrouter-anthropic": {
    ...
    category: "aggregator",
    description: "OpenRouter's Anthropic-compatible endpoint; shows the OpenRouter credit balance.",
    website: "https://openrouter.ai",
    quickAdd: { mode: "shortcut", category: "global" },
  },
  "siliconflow-anthropic": {
    ...
    models: createQuickAddModelEntries([
      ...
      "Pro/Qwen/Qwen3-Coder-480B-A35B-Instruct",
      "MiniMaxAI/MiniMax-M2.7",
    ]),
    defaultEnabled: false,
    defaultBaseURL: "https://api.siliconflow.cn",
    category: "aggregator",
    description: "SiliconFlow (硅基流动) over the Anthropic wire; shows the CNY balance.",
    website: "https://siliconflow.cn",
    quickAdd: { mode: "shortcut", category: "china" },
  },
  "novita-anthropic": {
    ...
    baseURLRequired: false,
    defaultModel: "claude-sonnet-4-6",
    models: createQuickAddModelEntries(["zai-org/glm-5.1", ...CLAUDE_WIRE_MODEL_IDS]),
    defaultEnabled: false,
    defaultBaseURL: "https://api.novita.ai/anthropic",
    category: "aggregator",
    description: "Novita AI's Anthropic-compatible endpoint; shows the Novita credit balance.",
    website: "https://novita.ai",
    quickAdd: { mode: "shortcut", category: "global" },
  },
  "qiniu-anthropic": {
    ...
    category: "aggregator",
    description: "Qiniu (七牛) AI gateway over the Anthropic wire.",
  ...
  "modelscope-anthropic": {
    ...
    models: createQuickAddModelEntries(["ZhipuAI/GLM-5.1"]),
    defaultEnabled: false,
    defaultBaseURL: "https://api-inference.modelscope.cn",
    category: "aggregator",
    description: "ModelScope (魔搭) inference gateway over the Anthropic wire.",
    website: "https://modelscope.cn",
    quickAdd: { mode: "shortcut", category: "china" },
  },
  shengsuanyun: {
    id: "shengsuanyun",
    name: "Shengsuanyun 胜算云 (Claude)",
    type: "cloud",
    protocol: "anthropic",
    family: "anthropic-native",
    adapter: "anthropic",
    ...
    models: createQuickAddModelEntries([...CLAUDE_WIRE_MODEL_IDS]),
    defaultEnabled: false,
    defaultBaseURL: "https://router.shengsuanyun.com/api",
    category: "aggregator",
    description: "Shengsuanyun (胜算云) router over the Anthropic wire.",
  ...
  packycode: {
    ...
    category: "aggregator",
    description: "PackyCode Claude relay over the Anthropic wire.",
    website: "https://www.packyapi.com",
    quickAdd: { mode: "shortcut", category: "proxy" },
  },
}

...
/** Map exact answer claims to retrieval chunks and apply the caller-specific submission policy. */
...
/** Add only aggregate grounding state to a content-free retrieval trace. */

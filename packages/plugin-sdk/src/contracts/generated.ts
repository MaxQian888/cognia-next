...
export const PLUGIN_CONTRACT_VERSION = "1.2.0" as const
...
export const PLUGIN_API_RESOURCE_EFFECTS = {
  ...
  "ctx.automation.performAction": {
    kind: "none",
  },
  "ctx.automation.pickAtPoint": {
    kind: "none",
  },
  "ctx.automation.queryElements": {
    kind: "none",
  },
  ...
  "ctx.browser.primeDomainGrants": {
    kind: "none",
  },
  "ctx.browser.routeEngine": {
    kind: "none",
  },
  ...
  "ctx.characterPacks.get": {
    kind: "none",
  },
  "ctx.characterPacks.listRegistered": {
    kind: "none",
  },
  "ctx.characterPacks.register": {
  ...
  "ctx.eval.listDatasets": {
    kind: "none",
  },
  "ctx.eval.runCalibration": {
    kind: "none",
  },
  "ctx.eval.runDataset": {
    kind: "none",
  ...
  "ctx.ocr.extractScreen": {
    kind: "none",
  },
  "ctx.ocr.isReady": {
    kind: "none",
  },
  "ctx.ocr.listAvailableProviders": {
    kind: "none",
  },
  ...
  "ctx.resources.listAdapterInstances": {
    kind: "none",
  },
  ...
  "ctx.resources.listPlugins": {
    kind: "none",
  },
  "ctx.resources.listSkills": {
    kind: "none",
  },
  "ctx.resources.listTwins": {
    kind: "none",
  },
  "ctx.recorder.deleteBundle": {
    kind: "none",
  },
  "ctx.recorder.getAvailability": {
    kind: "none",
  },
  "ctx.recorder.interrupt": {
    kind: "none",
  },
  "ctx.recorder.listCaptureTargets": {
    kind: "none",
  },
  "ctx.recorder.listRecoverable": {
    kind: "none",
  },
  "ctx.recorder.loadBundle": {
    kind: "none",
  },
  "ctx.recorder.onEvent": {
    kind: "returned-disposer",
  },
  "ctx.recorder.open": {
    kind: "none",
  ...
  "ctx.recorder.preflight": {
    kind: "none",
  },
  "ctx.recorder.publishAvailability": {
    kind: "returned-disposer",
  },
  "ctx.recorder.readAsset": {
    kind: "none",
  },
  "ctx.recorder.resume": {
    kind: "none",
  ...
  "ctx.recorder.statusSnapshot": {
    kind: "none",
  },
  "ctx.recorder.stop": {
    kind: "none",
  },
  "ctx.recorder.subscribeAvailability": {
    kind: "returned-disposer",
  },
  "ctx.recorder.undoLast": {
    kind: "none",
  },
  "ctx.sandbox.activeRefForSession": {
    kind: "none",
  },
  "ctx.sandbox.assertWritablePath": {
    kind: "none",
  },
  "ctx.sandbox.clampRequest": {
    kind: "none",
  },
  "ctx.sandbox.decorateComputerUseContext": {
    kind: "none",
  },
  "ctx.sandbox.execute": {
    kind: "none",
  },
  "ctx.sandbox.registerMicrovmAdapter": {
    kind: "returned-disposer",
  },
  ...
  "ctx.securityScans.registerRunController": {
    kind: "returned-disposer",
  },
  "ctx.securityScans.syncExecutionRun": {
    kind: "none",
  },
  ...
  "ctx.session.startSeededSession": {
    kind: "none",
  },
  ...
  "ctx.sites.getProductionUrl": {
    kind: "none",
  },
  "ctx.sites.listDeployments": {
    kind: "none",
  },
  "ctx.sites.listOperations": {
    kind: "none",
  },
  "ctx.sites.listSites": {
    kind: "none",
  },
  "ctx.sites.listVersions": {
    kind: "none",
  },
  "ctx.storage.clear": {
    kind: "none",
  ...
  "ctx.workflow.approvalActorScope": {
    kind: "none",
  },
  "ctx.workflow.autoLayoutEditor": {
    kind: "none",
  },
  "ctx.workflow.buildApprovalSurface": {
    kind: "none",
  },
  "ctx.workflow.emitTriggerEvent": {
    kind: "none",
  },
  "ctx.workflow.emitWaitEvent": {
    kind: "none",
  },
  "ctx.workflow.executeRunWorkflowTyped": {
    kind: "none",
  },
  "ctx.workflow.explainEditorLastRun": {
    kind: "none",
  },
  "ctx.workflow.explainEditorValidation": {
    kind: "none",
  },
  "ctx.workflow.findWorkflowById": {
    kind: "none",
  },
  "ctx.workflow.findWorkflowByName": {
    kind: "none",
  },
  "ctx.workflow.getNodeCatalogEntry": {
    kind: "none",
  },
  "ctx.workflow.getRunnerToolDefinition": {
    kind: "none",
  },
  "ctx.workflow.listCopilotTemplates": {
    kind: "none",
  },
  "ctx.workflow.listNodeCatalog": {
    kind: "none",
  },
  "ctx.workflow.listWorkflowSummaries": {
    kind: "none",
  },
  "ctx.workflow.materializeCopilotTemplate": {
    kind: "none",
  },
  "ctx.workflow.mutateEditor": {
    kind: "none",
  },
  "ctx.workflow.recordCallbackBinding": {
    kind: "none",
  },
  ...
  "ctx.workflow.resolveEditor": {
    kind: "none",
  },
  "ctx.workflow.resolveTriggerOrigin": {
    kind: "none",
  },
  "ctx.workflow.runWorkflow": {
    kind: "none",
  },
  "ctx.workflow.stageProposal": {
    kind: "none",
  },

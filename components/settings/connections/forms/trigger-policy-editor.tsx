...
export function TriggerPolicyEditor({
  ...
  const gaps = triggerCoverageGaps(fromTriggerPolicyDraft(value))
  const warnings = triggerDraftWarnings(value)
    ...
    <div className="space-y-4" data-testid={`${idPrefix}-policy-editor`}>
      <section className="space-y-2">
        ...
        <ToggleRow
          ...
          disabled={disabled}
          onCheckedChange={(checked) =>
            patchRules({ channelAllowlist: { ...value.rules.channelAllowlist, enabled: checked } })
          }
        >
          <ChipInput
      ...
      <section className="space-y-2">
        ...
        <ToggleRow
          ...
          disabled={disabled}
          onCheckedChange={(checked) =>
            patchBlockers({ userBlocklist: { ...value.blockers.userBlocklist, enabled: checked } })
          }
        >
          <ChipInput

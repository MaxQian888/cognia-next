...
const REGISTRY: Partial<Record<WorkflowNodeKind, NodeConfigComponent>> = {
  ...
  "trigger.connector.system": ConnectorSystemTriggerConfig,
  ...
  "action.team.reconcile": TeamReconcileConfig,
  "action.team.compose": TeamComposeConfig,
  "action.team.status": TeamStatusConfig,
  "action.team.delegate": TeamDelegateConfig,
  "action.team.message": TeamMessageConfig,
  // Actions: skills
  ...
  "action.connector.reaction": ConnectorReactionConfig,
  "action.connector.delete": ConnectorDeleteConfig,
  "action.connector.forward": ConnectorForwardConfig,
  "action.connector.waitReply": ConnectorWaitReplyConfig,

...
/**
 * Vendored from the AI Elements registry (https://elements.ai-sdk.dev/components/inline-citation)
 * into ai-elements/ — coverage- & i18n-excluded per CLAUDE.md. Inline citation
 * badge that opens a hover-card carousel of sources. Used by the chat
 * sources-part to surface web/footnote URL sources with title/url/snippet.
 * Tokens are already semantic; copied verbatim from the registry.
 */

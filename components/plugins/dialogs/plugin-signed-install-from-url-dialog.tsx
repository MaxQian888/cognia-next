...
export interface PluginSignedInstallFromUrlDialogProps {
  open: boolean
    ...
    <>
      <Dialog open={open} onOpenChange={handleOpenChange}>
        {/* Bounded to the viewport: header and footer stay put and the stage
            body is the one scroller, so three inputs plus an error (or the
            preview + trust checkbox) under a phone keyboard can't push the
            action buttons off screen. The body's `-m-1 p-1` keeps input focus
            rings from being clipped by it. */}
        <DialogContent
        ...
        >
          ...
          <div
            ...
            data-testid="install-from-url-dialog-body"
          >

...
// Detail content rendered inside `plugin-detail-panel.tsx`. Tabbed shell:
// Overview / Manifest / Capabilities / Permissions / Lifecycle. Pulls a
// fresh row from Dexie so external mutations (manager updates) reflect

...
import { ChevronDownIcon, KeyRoundIcon, ShieldCheckIcon, ShieldXIcon, XIcon } from "lucide-react"
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <Icon className={cn("mt-0.5 size-4 shrink-0", TONE_ICON_CLASS[tone])} aria-hidden="true" />

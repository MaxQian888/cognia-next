...
export function ActivityTab({ row }: { row: DeviceRow }) {
  ...
  return (
    <div className="space-y-4" data-testid="device-activity-tab">
      <section data-testid="device-dispatch-queue">
      ...
      <section data-testid="device-placement-provides">
        <h3 className="mb-1 text-xs font-medium uppercase tracking-wide text-muted-foreground">
          {t("activity.placement")}
        </h3>
        {dimensions.length === 0 ? (

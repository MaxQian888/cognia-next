define("vs/mdx-DEWtB1K5", ["exports", "./editor.api-CalNCsUg"], function (t, e) {
  "use strict"
  const o = {
      ...
      onEnterRules: [
        {
          beforeText: /^\s*- .+/,
          action: { indentAction: e.languages.IndentAction.None, appendText: "- " },
        },
        {
          beforeText: /^\s*\+ .+/,
          action: { indentAction: e.languages.IndentAction.None, appendText: "+ " },
        ...
        { beforeText: /<\w+/, action: { indentAction: e.languages.IndentAction.Indent } },
        { beforeText: /\s+>\s*$/, action: { indentAction: e.languages.IndentAction.Indent } },
        { beforeText: /<\/\w+>/, action: { indentAction: e.languages.IndentAction.Outdent } },
        ...Array.from({ length: 100 }, (s, n) => ({
          beforeText: new RegExp(`^${n}\\. .+`),
          action: { indentAction: e.languages.IndentAction.None, appendText: `${n + 1}. ` },
        })),
      ],
    },
    i = {

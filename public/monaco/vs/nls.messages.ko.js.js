define("vs/nls.messages.ko.js", function () {
   ...
   *-----------------------------------------------------------*/ ;((globalThis._VSCODE_NLS_MESSAGES =
    [
      ...
      "편집기",
      "현재 편집기에 액세스할 수 없습니다.",
      "{0} 화면 읽기 프로그램 최적화 모드를 사용하도록 설정하려면 {1}을(를) 사용합니다.",
      ...
      "찾기 위젯에서 검색 기록을 저장하지 않습니다.",
      "활성 작업 영역에 검색 기록 저장",
      "위젯 찾기 기록을 저장하는 방법을 제어합니다.",
      "바꾸기 위젯의 기록을 저장하지 마세요.",
      "활성 작업 영역에서 바꾸기 기록 저장",
      ...
      "편집기의 가로 스크롤 막대를 사용하여 고정 스크롤의 스크롤을 사용하도록 설정합니다.",
      "편집기에서 인레이 힌트를 활성화합니다.",
      "인레이 힌트가 활성화됨",
      "인레이 힌트는 기본값으로 표시되고 {0}을(를) 길게 누르면 숨겨집니다.",
      ...
      "편집기에서 인레이 힌트 주위의 패딩을 활성화합니다.",
      "편집기에서 잘리기 전 한 줄에 대한 인레이 힌트의 최대 전체 길이입니다. 자르지 않으려면 `0`으로 설정하세요.",
      `선 높이를 제어합니다. \r
 ...
 - 8보다 크거나 같은 값이 유효 값으로 사용됩니다.`,
      "미니맵 표시 여부를 제어합니다.",
      "미니맵은 항상 표시됩니다.",
      "마우스가 미니맵 위에 있지 않으면 미니맵이 숨겨지고, 마우스가 미니맵 위에 있으면 미니맵이 표시됩니다.",
      "미니맵은 편집기가 스크롤될 때만 표시됩니다.",
      ...
      "더 큰 제안은 공간이 충분하면 나란히 표시되고, 그렇지 않으면 아래에 표시됩니다.",
      "더 큰 제안은 나란히 표시되지 않으며 항상 아래에 표시됩니다.",
      ...
      "편집기에서 마우스 가운데 버튼을 클릭할 때 동작을 제어합니다.",
...
char* str="hello\\n\r
           world"\r
\`\`\``,
      "색 데코레이터를 제공하는 확장이 없는 경우에만 기본 색 데코레이터를 표시합니다.",
      "항상 기본 색 데코레이터를 표시합니다.",
      "기본 색 데코레이터를 표시하지 않습니다.",
      ...
      "소스 작업...",
      "가져오기 구성",
      "현재 파일에서 가져오기를 구성합니다. 일부 도구에서 '가져오기 최적화'라고도 합니다.",
      "모두 수정",
      "자동 수정...",
      ...
      "Color Picker를 닫는 아이콘",
      "색 옵션을 토글하려면 클릭하세요(rgb/hsl/hex).",
      "여기에 Color Picker가 있습니다.",
      "독립 실행형 Color Picker 표시 또는 포커스(&&S)",
      "독립 실행형 Color Picker 표시 또는 포커스",
      "기본 색 공급자를 사용하는 독립 실행형 Color Picker를 표시하거나 포커스를 지정합니다. hex/rgb/hsl 색을 표시합니다.",
      "Color Picker 숨기기",
      "독립 실행형 Color Picker를 숨깁니다.",
      "독립 실행형 Color Picker로 색 삽입",
      "포커스가 있는 독립 실행형 Color Picker를 사용하여 hex/rgb/hsl 색을 삽입합니다.",
      "줄 주석 설정/해제(&&T)",
      "블록 주석 설정/해제(&&B)",
      "줄 주석 설정/해제",
      "줄 주석 추가",
...
기본 설정과 일치하는 첫 번째 편집이 적용됩니다.`,
      ...
      "'{0}' 붙여넣기 편집을 확인하는 중입니다. 취소하려면 클릭하세요.",
...
{1}`,
      ...
      "커서가 인라인 편집에 있는지 여부",
      "인라인 편집 표시 여부",
      "탭을 인라인 편집으로 이동할지 여부입니다.",
      "탭에서 인라인 편집을 허용할지 여부입니다.",
      "현재 코드 편집기에서 인라인 편집 미리 보기를 표시하는지 여부",
      "접근성 보기에서 이를 검사({0})",
      "여기에 인라인 완성이 있습니다.",
      "제안:",
      ...
      "인라인 편집의 원래 텍스트에서 변경된 텍스트의 오버레이 색입니다.",
      "인라인 편집의 수정된 텍스트에서 변경된 줄의 배경색입니다.",
      "인라인 편집의 수정된 텍스트에서 변경된 텍스트의 오버레이 색입니다.",
      "기본 인라인 편집 여백 표시기 전경색입니다.",
      "기본 인라인 편집 여백 표시기의 테두리 색입니다.",
      "기본 인라인 편집 여백 표시기 배경색입니다.",
      "보조 인라인 편집 여백 표시기 전경색입니다.",
      "보조 인라인 편집 여백 표시기의 테두리 색입니다.",
      "보조 인라인 편집 여백 표시기 배경색입니다.",
      "성공한 인라인 편집 여백 표시기 전경색입니다.",
      "성공적인 인라인 편집 여백 표시기의 테두리 색입니다.",
      "성공한 인라인 편집 여백 표시기 배경색입니다.",
      "인라인 편집 여백 표시기 배경색입니다.",
      "인라인 편집에서 원래 텍스트의 테두리 색입니다.",
      "인라인 편집에서 수정된 텍스트의 테두리 색입니다.",
      "탭에서 허용하는 경우 인라인 편집 위젯의 수정된 테두리 색입니다.",
      "인라인의 원래 테두리 색은 탭에서 허용할 때 원래 텍스트 위에 위젯을 편집합니다.",
      "이전 값으로 바꾸기",
      "다음 값으로 바꾸기",
      "마지막 줄 바꿈 삽입",
      "선 선택 영역 확장",
      ...
      "피킹 뷰 편집기의 고정 스크롤의 홈통 부분에 대한 배경색입니다.",
      ...
      "자세한 정보",
      "단어 끝에 있을 때 true인 컨텍스트 키입니다. 탭 완성을 사용하도록 설정한 경우에만 정의됩니다.",
...
수신됨: '{1}'.`,
      ...
      "경고",
      "정보",
      '"{0}" 때문에 문제가 일시 중지되었습니다.',
      '"{0}" 및 기타 {1} 때문에 문제가 일시 중지되었습니다.',
      "최근에 사용한 항목",
      "유사한 명령",
      "일반적으로 사용됨",
      "기타 명령",
      ...
      "빠른 입력 컨텍스트에서 사용됩니다. 이 명령에 대한 하나의 키 바인딩을 변경하는 경우 이 명령의 다른 모든 키 바인딩(한정자 변형)도 변경해야 합니다.",
      ...
      "일부 빠른 입력 컨텍스트에서 사용됩니다. 이 명령에 대한 하나의 키 바인딩을 변경하는 경우 이 명령의 다른 모든 키 바인딩(한정자 변형)도 변경해야 합니다.",
      "모든 확인란 선택/해제",
      "{0}개 결과",
      "{0} 선택됨",
      "확인",
      ...
      "기본 색을 사용합니다.",
      "글꼴 ID는 문자, 숫자, 밑줄 및 대시만 포함해야 합니다.",

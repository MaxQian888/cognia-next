define("vs/freemarker2-Cz_sV6Md", ["exports", "./editor.api-CalNCsUg"], function (i, c) {
  "use strict"
  const s = [
      "assign",
      "flush",
    ...
    a = { close: ">", id: "angle", open: "<" },
    r = { close: "\\]", id: "bracket", open: "\\[" },
    f = { close: "[>\\]]", id: "auto", open: "[<\\[]" },
    p = { close: "\\}", id: "dollar", open1: "\\$", open2: "\\{" },
    g = { close: "\\]", id: "bracket", open1: "\\[", open2: "=" }
  function l(t) {
    return {
      brackets: [
        ["<", ">"],
...
\r	 }]),.:;=`,
  ...
  function _(t, n) {
    const u = `_${t.id}_${n.id}`,
      e = (k) => k.replace(/__id__/g, u),
      o = (k) => {
        const D = k.source.replace(/__id__/g, u)
        return new RegExp(D, k.flags)
      }
    return {
      unicode: !0,
      includeLF: !1,
  ...
  function m(t) {
    ...
    return {
      ...
      tokenizer: { ...n.tokenizer, ...u.tokenizer, ...e.tokenizer },
    }
  }
  const F = { conf: l(a), language: _(a, p) },
    b = { conf: l(r), language: _(r, p) },
    x = { conf: l(a), language: _(a, g) },
    $ = { conf: l(r), language: _(r, g) },
    B = { conf: A(), language: m(p) },
    E = { conf: A(), language: m(g) }
  ;((i.TagAngleInterpolationBracket = x),
    (i.TagAngleInterpolationDollar = F),
    (i.TagAutoInterpolationBracket = E),
    (i.TagAutoInterpolationDollar = B),
    (i.TagBracketInterpolationBracket = $),
    (i.TagBracketInterpolationDollar = b),

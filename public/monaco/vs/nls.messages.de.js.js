define("vs/nls.messages.de.js", ["./_commonjsHelpers-CT9FvmAN"], function (r) {
  "use strict"
  var e = {}
  /*!-----------------------------------------------------------
    ...
    return (
      n ||
        ...
        (globalThis._VSCODE_NLS_MESSAGES = [
          ...
          "Alle auswählen",
          "Alle auswählen",
          "Verwenden des DOM-basierten Renderings",
          "Gibt an, ob der Standbymodus von Inlinevervollständigungen derzeit aktiviert ist",
          "Dauer für das Erinnern bei Inlinevorschlägen auswählen",
          "Standbymodus von Inlinevorschlägen aktivieren",
          "Aktivierung des Standbymodus von Inlinevorschlägen abbrechen",
          ...
          "Steuert, ob die Struktursitteranalyse aktiviert und Telemetriedaten erfasst werden sollen. Das Festlegen von „#editor.experimental.preferTreeSitter#“ für bestimmte Sprachen hat Vorrang.",
          "Steuert, ob die Struktursitteranalyse für „css“ aktiviert werden soll. Dies hat Vorrang vor „#editor.experimental.treeSitterTelemetry#“ für „css“.",
          "Steuert, ob die Struktursitteranalyse für TypeScript aktiviert werden soll. Dies hat Vorrang vor „#editor.experimental.treeSitterTelemetry#“ für TypeScript.",
          "Steuert, ob die Struktursitteranalyse für „ini“ aktiviert werden soll. Dies hat Vorrang vor „#editor.experimental.treeSitterTelemetry#“ für „ini“.",
          "Steuert, ob die Struktursitteranalyse für „RegEx“ aktiviert werden soll. Dies hat Vorrang vor „#editor.experimental.treeSitterTelemetry#“ für „RegEx“.",
          ...
          "Wenn diese Option aktiviert ist, zeigt der Diff-Editor einen speziellen Bundsteg für die Aktionen „Wiederherstellen“ und „Stagen“ an.",
          ...
          "Wenn diese Option aktiviert ist und der Editor die Inlineansicht verwendet, werden Wortänderungen inline gerendert.",
          ...
          "Speichern Sie den Suchverlauf nicht aus dem Suchwidget.",
          "Speichern des Suchverlaufs im aktiven Arbeitsbereich",
          "Steuert, wie der Suchverlauf des Suchwidgets gespeichert werden soll",
          "Verlauf aus dem Ersatzwidget nicht speichern.",
          "Speichern des Ersatz-Suchverlaufs im aktiven Arbeitsbereich",
          "Steuert, wie der Suchverlauf des Ersatz-Suchwidgets gespeichert werden soll",
          "Steuert, ob das Such-Widget während Ihrer Eingabe suchen soll.",
          ...
          "Hiermit aktivieren Sie fixiertem Bildlauf in der horizontalen Bildlaufleiste des Editors.",
          ...
          "Inlay-Hinweise sind standardmäßig ausgeblendet. Sie werden angezeigt, wenn {0} gedrückt gehalten wird",
          "Inlay-Hinweise sind deaktiviert",
          "Steuert den Schriftgrad von Inlay-Hinweisen im Editor. Standardmäßig wird {0} verwendet, wenn der konfigurierte Wert kleiner als {1} oder größer als der Schriftgrad des Editors ist.",
          'Steuert die Schriftartfamilie von Inlay-Hinweisen im Editor. Bei Festlegung auf "leer" wird {0} verwendet.',
          "Aktiviert den Abstand um die Inlay-Hinweise im Editor.",
          "Maximale Gesamtlänge von Inlay-Hinweisen für eine einzelne Zeile, bevor sie vom Editor abgeschnitten werden. Auf „0“ festlegen, damit sie nie abgeschnitten werden",
          `Steuert die Zeilenhöhe. \r
 ...
 – Werte größer oder gleich 8 werden als effektive Werte verwendet.`,
          ...
          "Die Minimap wird immer angezeigt.",
          "Die Minimap wird ausgeblendet, wenn sich der Cursor nicht über der Minimap befindet, und eingeblendet, wenn der Cursor auf die Minimap zeigt.",
          "Die Minimap wird nur angezeigt, wenn der Editor gescrollt wird.",
          ...
          "Steuert, ob Syntaxhervorhebungen für Inlinevorschläge im Editor angezeigt werden.",
          ...
          "Steuert, ob Inlinevorschläge im Snippetmodus unterdrückt werden.",
          "Steuert die minimale Verzögerung in Millisekunden, nach der Inlinevorschläge nach der Eingabe angezeigt werden.",
          "Unterdrückt Inline-Vervollständigungen für angegebene Erweiterungs-IDs – durch Kommas getrennt",
          "Steuert, ob Anforderungsinformationen vom Inlinevorschlagsanbieter gesendet werden.",
          "Steuert, ob ein Befehl ausgelöst wird, wenn sich der Anbieter von Inlinevorschlägen ändert.",
          "Steuert, ob Inline-Vorschläge angezeigt werden, wenn ein Vorschlagskonflikt besteht.",
          "Steuert die Schriftfamilie der Inlinevorschläge.",
          "Steuert, ob die Anzeige eines Vorschlags den Code verschiebt, um Platz für den Vorschlag zu schaffen.",
          "Steuert, ob größere Vorschläge nebeneinander angezeigt werden können.",
          "Größere Vorschläge werden nebeneinander angezeigt, wenn genügend Speicherplatz vorhanden ist, andernfalls werden sie unten angezeigt.",
          "Größere Vorschläge werden nie nebeneinander angezeigt und werden immer unten angezeigt.",
          "Steuert, ob der Vorschlag bis zum Springen als reduziert angezeigt wird.",
          ...
          "Steuert, ob ein Vorschlag ausgewählt wird, wenn das Widget angezeigt wird. Beachten Sie, dass dies nur für automatisch ausgelöste Vorschläge ({0} und {1}) gilt und dass ein Vorschlag immer ausgewählt wird, wenn er explizit aufgerufen wird, z. B. über STRG+LEERTASTE.",
          ...
          "Gebietsschemas, die für die Wortsegmentierung verwendet werden sollen, wenn wortbezogene Navigationen oder Vorgänge ausgeführt werden. Geben Sie das BCP 47-Sprachtag des Worts an, das Sie erkennen möchten (z. B. ja, zh-CN, zh-Hant-TW usw.).",
          ...
          "Steuert, ob die Verwendung variabler Zeilenhöhen im Editor zulässig ist.",
          "Steuert, ob die Verwendung von variablen Schriftarten im Editor zugelassen werden soll.",
          "Steuert, ob die Verwendung von variablen Schriftarten im Editor im Barrierefreiheitsmodus zugelassen werden soll.",
          "Editor-Inhalt",
          ...
          "Steuert, ob der Editor Inhalte automatisch mit Einzug einfügen soll.",
          "Steuert, ob der Editor Inhalte automatisch mit Einzug einfügen soll, wenn diese innerhalb einer Zeichenfolge eingefügt werden. Dies wird wirksam, wenn „autoIndentOnPaste“ auf „ true“ festgelegt ist.",
          ...
          "Steuert den Cursorstil im Einfügeeingabemodus.",
          "Steuert den Cursorstil im Überschreibeingabemodus.",
          ...
          "Steuert die Höhe des Cursors, wenn „#editor.cursorStyle#“ auf „line“ festgelegt ist. Die maximale Höhe des Cursors hängt von der Zeilenhöhe ab.",
          "Steuert, ob der Editor das Verschieben einer Auswahl per Drag and Drop zulässt.",
          "Legt fest, ob die EditContext-API anstelle des Textbereichs verwendet werden soll, um die Eingabe im Editor zu steuern.",
          "Gibt an, ob Sprachausgabeinhalte gerendert werden sollen, wenn die Einstellung „#editor.editContext#“ aktiviert ist.",
          "Verwenden Sie reguläres DOM-basiertes Rendering.",
          "GPU-Beschleunigung verwenden.",
          "Steuert, ob die experimentelle GPU-Beschleunigung zum Rendern des Editors verwendet wird.",
          ...
          "Träger Scrollvorgang – besonders nützlich bei einem Touchpad unter Linux.",
          ...
          "Steuert, was passiert, wenn im Editor die mittlere Maustaste gedrückt wird.",
          ...
          "Steuert die Verzögerung in Millisekunden, nach der Vorkommen hervorgehoben werden.",
          "Steuert, ob das Einfügen überschrieben werden soll.",
          ...
          "Steuert, ob durch Drücken der mittleren Maustaste durch den Editor gescrollt wird.",
          ...
          "Steuert, wie viele Zeichen in der Auswahl enthalten sein können, bevor ähnliche Übereinstimmungen nicht hervorgehoben werden. Auf Null festlegen für unbegrenzt.",
          "Steuert, ob der Editor Übereinstimmungen in der Auswahl hervorheben soll, die sich über mehrere Zeilen erstrecken.",
          ...
          "Steuert, ob der Editor beim Löschen eines Zeilenumbruchs auch das Einzugsleerzeichen der nächsten Zeile löscht.",
          ...
          "Leerzeichen und Registerkarten werden in Übereinstimmung mit Tabstopps eingefügt und gelöscht.",
          ...
          'Steuert, ob das Literal „\\n“ einen Zeilenumbruch auslösen soll, wenn „#editor.wordWrap#“ aktiviert ist.\r\n\r\nBeispiel:\r\n```c\r\nchar* str="hello\\nworld"\r\n```\r\nwird wie folgt angezeigt:\r\n```c\r\nchar* str="hello\\n\r\n           world"\r\n```',
          "Standardfarbdekoratoren nur anzeigen, wenn keine Erweiterung Farbdekoratoren bereitstellt.",
          "Standardfarbdekoratoren immer anzeigen.",
          "Standardfarbdekoratoren nie anzeigen.",
          ...
          "Farbe des primären Editorcursors, wenn mehrere Cursor vorhanden sind.",
          "Die Hintergrundfarbe des primären Editorcursors, wenn mehrere Cursor vorhanden sind. Erlaubt die Anpassung der Farbe von einem Zeichen, welches von einem Block-Cursor überdeckt wird.",
          "Farbe sekundärer Editorcursor, wenn mehrere Cursor vorhanden sind.",
          "Die Hintergrundfarbe sekundärer Editorcursor, wenn mehrere Cursor vorhanden sind. Erlaubt die Anpassung der Farbe von einem Zeichen, welches von einem Block-Cursor überdeckt wird.",
          ...
          "Gibt an, ob „geändert“ im Diff-Editor beschreibbar ist.",
          "Gibt an, ob „geändert“ im Diff-Editor beschreibbar ist.",
          "Der URI des ursprünglichen Dokuments",
          "Der URI des geänderten Dokuments",
          ...
          "Organisieren Sie Importe in der aktuellen Datei. Wird von einigen Tools auch als „Imports optimieren“ bezeichnet.",
          "Alle korrigieren",
          ...
          "Aktivieren Sie das Auslösen von {0}, wenn {1} auf {2} festgelegt ist. Codeaktionen müssen auf {3} festgelegt werden, um für Fenster- und Fokusänderungen ausgelöst zu werden.",
          ...
          "Umgeben mit",
          "Quellaktion",
          "Symbol, das das Menü „Codeaktionen“ aus dem Bundsteg erzeugt, wenn kein Platz im Editor vorhanden ist.",
          "Symbol, das das Menü „Codeaktionen“ aus dem Bundsteg erzeugt, wenn kein Platz im Editor vorhanden ist und eine schnelle Korrektur verfügbar ist.",
          "Symbol, das das Menü „Codeaktionen“ aus dem Bundsteg erzeugt, wenn kein Platz im Editor vorhanden ist und ein KI-Fix verfügbar ist.",
          "Symbol, das das Menü „Codeaktionen“ aus dem Bundsteg erzeugt, wenn kein Platz im Editor vorhanden ist und ein KI-Fix und eine schnelle Korrektur verfügbar sind.",
          "Symbol, das das Menü „Codeaktionen“ aus dem Bundsteg erzeugt, wenn kein Platz im Editor vorhanden ist und ein KI-Fix und eine schnelle Korrektur verfügbar sind.",
          "Ausführen: {0}",
          ...
          "Hier ist ein Farbwähler vorhanden.",
          "&&Eigenständige Farbwähler anzeigen oder fokussieren",
          "Eigenständige Farbwähler anzeigen oder konzentrieren",
          "Eigenständige Farbauswahl, die den Standardfarbanbieter verwendet, anzeigen oder fokussieren. Zeigt Hexadezimal-/RGB-/HSL-Farben an.",
          "Farbwähler ausblenden",
          "Eigenständige Farbauswahl ausblenden.",
          "Farbe mit eigenständigem Farbwähler einfügen",
          "Fügen Sie hexadezimale/rgb-/hsl-Farben mit der fokussierten eigenständigen Farbauswahl ein.",
          ...
          `Die Art der Einfügebearbeitung, für die Sie das Einfügen versuchen.\r
Wenn mehrere Bearbeitungen für diese Art vorhanden sind, zeigt der Editor eine Auswahl an. Wenn keine Bearbeitungen dieser Art vorhanden sind, zeigt der Editor eine Fehlermeldung an.`,
          `Liste der bevorzugten Einfügebearbeitungsarten, die angewendet werden sollen.\r
Die erste Bearbeitung, die den Einstellungen entspricht, wird angewendet.`,
          ...
          "Die Einfügebearbeitung für '{0}' wird aufgelöst. Klicken Sie hier, um den Vorgang abzubrechen.",
          "Einfügehandler werden ausgeführt. Klicken Sie hier, um den Vorgang abzubrechen und ein einfaches Einfügen auszuführen.",
          "Konfigurieren der Standardaktion zum Einfügen",
          ...
          `Fehler beim Auflösen der Bearbeitung "{0}":\r
{1}`,
...
{1}`,
          ...
          "Symbol {0} von {1}",
          "Statistik zum Protokolltexturatlas",
          "Texturatlas speichern",
          "Glyphe zeichnen",
          "Entwickler: Debug-Editor GPU-Renderer",
          ...
          "Leerzeichengröße entsprechend der Tabulatorgröße ändern.",
          "Einzug aus Inhalt erkennen",
          "Einzug aus dem Inhalt erkennen.",
          "Neuen Einzug für Zeilen festlegen",
          "Die Zeilen des Editors erneut einrücken.",
          "Gewählte Zeilen zurückziehen",
          "Die ausgewählten Zeilen des Editors erneut einrücken.",
          ...
          "Befehl ausführen",
          "Löst einen Inlinevorschlag im Editor aus.",
          "Optionen zum Auslösen von Inlinevorschlägen.",
          "Es ist kein Inlinevorschlag verfügbar.",
          "Wort annehmen",
          "Zeile annehmen",
          "Akzeptieren",
          "Akzeptieren",
          ...
          "Entwickler: Inline-Vorschlagsstatus extrahieren",
          ...
          "Zur nächsten Inline-Bearbeitung springen",
          "Inlinevorschlag ausblenden",
          "Inlinevorschläge ein-/ausschalten: Reduzierte anzeigen",
          ...
          "Gibt an, ob sich der Cursor im inaktiven Text befindet",
          "Gibt an, ob sich der Cursor im Einzug befindet",
          "Gibt an, ob im Editor eine Auswahl vorhanden ist",
          "Gibt an, ob sich der Cursor an einer Inline-Bearbeitung befindet",
          "Gibt an, ob eine Inline-Bearbeitung sichtbar ist.",
          "Gibt an, ob die Registerkarte zu einer Inlinebearbeitung springen soll.",
          "Gibt an, ob die Registerkarte die Inlinebearbeitung akzeptieren soll.",
          "Gibt an, ob der aktuelle Code-Editor eine Vorschau für Inlinebearbeitungen anzeigt.",
          "Überprüfen Sie dies in der barrierefreien Ansicht ({0}).",
          "Hier sind Inlineabschlüsse vorhanden.",
          "Vorschlag:",
          ...
          "Einstellungen",
          null,
          "Hintergrundfarbe für den Originaltext in Inlinebearbeitungen.",
          "Hintergrundfarbe für den geänderten Text in Inlinebearbeitungen.",
          "Hintergrundfarbe für die geänderten Zeilen im Originaltext von Inlinebearbeitungen.",
          "Überlagerungsfarbe für den geänderten Text im Originaltext von Inlinebearbeitungen.",
          "Hintergrundfarbe für die geänderten Zeilen im geänderten Text von Inlinebearbeitungen.",
          "Überlagerungsfarbe für den geänderten Text im geänderten Text von Inlinebearbeitungen.",
          "Vordergrundfarbe für den primären Inlinebearbeitungsstegindikator.",
          "Rahmenfarbe für den primären Inline-Bearbeitungbundstegssindikator.",
          "Hintergrundfarbe für den primären Inlinebearbeitungsstegindikator.",
          "Vordergrundfarbe für den sekundären Inlinebearbeitungsstegindikator.",
          "Rahmenfarbe für den sekundären Inline-Bearbeitungsbundstegsindikator.",
          "Hintergrundfarbe für den indikator für die sekundäre Inlinebearbeitungsstege.",
          "Vordergrundfarbe für den erfolgreichen Inlinebearbeitungsstegindikator.",
          "Rahmenfarbe für den erfolgreichen Inline-Bearbeitungsbundstegsindikator.",
          "Hintergrundfarbe für die erfolgreiche Inlinebearbeitung des Gutterindikators.",
          "Hintergrundfarbe für den Inline-Bearbeitungsstegindikator.",
          "Rahmenfarbe für den Originaltext in Inlinebearbeitungen.",
          "Rahmenfarbe für den geänderten Text in Inlinebearbeitungen.",
          "Geänderte Rahmenfarbe für das Inlinebearbeitungswidget, wenn die Registerkarte es akzeptiert.",
          "Ursprüngliche Rahmenfarbe für das Inlinebearbeitungswidget über dem ursprünglichen Text, wenn die Registerkarte es akzeptiert.",
          "Durch vorherigen Wert ersetzen",
          "Durch nächsten Wert ersetzen",
          "Abschließende neue Zeile einfügen",
          ...
          "Hintergrundfarbe für fixierten Bildlauf im Editor mit Peek-Ansicht.",
          ...
          null,
          "Nullbasierten Offset verwenden",
          "Öffnen Sie zuerst einen Text-Editor, um zu einer Zeile oder einem Offset zu wechseln.",
          "Geben Sie eine Zeichenposition ein, zu der gewechselt werden soll (von 0 bis {0}).",
          "Geben Sie eine Zeichenposition ein, zu der gewechselt werden soll (von 1 bis {0}).",
          "Drücken Sie die Eingabetaste, um zur Zeile {0} in der Spalte {1} zu wechseln.",
          "Geben Sie eine Zeilennummer ein, zu der gewechselt werden soll (von 1 bis {0}).",
          "Drücken Sie die Eingabetaste, um zu Zeile {0} zu wechseln, oder geben Sie einen Doppelpunkt : ein, um eine Spaltennummer hinzuzufügen.",
          "Drücken Sie die Eingabetaste, um zur Zeile {0} zu wechseln, oder geben Sie eine Spaltennummer ein (von 1 bis {1}).",
          "Drücken Sie die Eingabetaste, um zur Zeile {0} in der Spalte {1} zu wechseln.",
          ...
          "Vorschläge für neuen Namen generieren",
          "Abbrechen",
          "Auswahl &&erweitern",
          ...
          "Fixierter Bildlauf",
          "&&Fixierter Bildlauf",
          "&&Fixierten Bildlauf im Editor fokussieren",
          "Fixierten Bildlauf im Editor umschalten",
          "Fixierten Bildlauf im Editor umschalten/aktivieren, der die geschachtelten Bereiche am oberen Rand des Viewports anzeigt",
          "Fixierten Bildlauf im Editor fokussieren",
          "Nächste Zeile für fixierten Bildlauf im Editor auswählen",
          "Vorherige Zeile für fixierten Bildlauf auswählen",
          "Zur fokussierten Zeile für fixierten Bildlauf wechseln",
          "Editor auswählen",
          ...
          "Ein Kontextschlüssel, der true ist, wenn er am Ende eines Worts steht. Beachten Sie, dass dies nur definiert ist, wenn Tabvervollständigungen aktiviert sind.",
          ...
          "Bestimmt, ob die Tabulatortaste den Fokus um die Workbench verschiebt oder das Tabulatorzeichen im aktuellen Editor einfügt. Dies wird auch als Tabstopp, Tabulatornavigation oder Tabulatorfokusmodus bezeichnet.",
          ...
          `Die Datei "{0}" enthält mindestens ein ungewöhnliches Zeilenabschlusszeichen, z. B. Zeilentrennzeichen (LS) oder Absatztrennzeichen (PS).\r
\r
Es wird empfohlen, sie aus der Datei zu entfernen. Dies kann über "editor.unusualLineTerminators" konfiguriert werden.`,
          ...
          "Nächster Bearbeitungsvorschlag in der Zeile",
          ...
          "Geänderte Datei im Chat bearbeiten",
          "Aus Chatbearbeitungen geänderte Datei",
          "Chatanfrage gesendet",
          "Chatanfrage gesendet",
          "Chatantwort empfangen",
          "Codeaktionsanforderung ausgelöst",
          "Codeaktionsanforderung ausgelöst",
          "Angewendete Codeaktion",
          "Status",
          "Status",
          "Löschen",
          "Löschen",
          ...
          "Chatbenutzeraktion erforderlich",
          "Chatbenutzeraktion erforderlich",
          "Ansehen",
          "Hilfe",
          "Test",
...
[{1}] {2}`,
          ...
          "Konfigurieren Sie Einstellungen, die für {0} überschrieben werden sollen.",
...
Empfangen: „{1}“.`,
          ...
          'Probleme sind angehalten, Grund: "{0}" und {1} weitere',
          "zuletzt verwendet",
          "ähnliche Befehle",
          "häufig verwendet",
          "andere Befehle",
          ...
          "Die Ausrichtung der Schnelleingabe",
          ...
          "OK",
          "{0} (Drücken Sie die EINGABETASTE zur Bestätigung oder ESC, um den Vorgang abzubrechen.)",
          "Wird im Kontext einer beliebigen Art von Schnelleingabe verwendet. Wenn Sie eine Tastenzuordnung für diesen Befehl ändern, sollten Sie auch alle anderen Tastenzuordnungen (Modifizierervarianten) dieses Befehls ändern.",
          ...
          "Wird im Zusammenhang mit einer schnellen Eingabe verwendet. Wenn Sie eine Tastenzuordnung für diesen Befehl ändern, sollten Sie auch alle anderen Tastenzuordnungen (Modifizierervarianten) dieses Befehls ändern.",
          ...
          "Hintergrundfarbe für den Bundsteg des fixierten Bildlaufs im Editor",
          ...
          "Die Rahmenfarbe für eine IME-Komposition.",
          ...
          'Vordergrundfarbe für "aktive Radiooption"',
          'Hintergrundfarbe für "aktive Radiooption"',
          "Rahmenfarbe der aktiven Radiooption",
          "Vordergrundfarbe für „inaktive Radiooption“",
          "Hintergrundfarbe für „inaktive Radiooption“",
          ...
          "Hintergrund eines deaktivierten Kontrollkästchens.",
          "Vordergrund eines deaktivierten Kontrollkästchens.",
          ...
          "Die Hintergrundfarbe der Aktionenliste für das fokussierte Element.",
          "Die Hintergrundfarbe der Aktionenliste für das fokussierte Element.",
          ...
          "Vordergrundfarbe des Badges „Warnungsaktivität“",
          "Hintergrundfarbe des Badges „Warnungsaktivität“",
          "Vordergrundfarbe des Badges “Fehleraktivität“",
          "Hintergrundfarbe des Badges „Fehleraktivität“",
          ...
          "Linienfarbe für das Diagramm.",
          "Achsenfarbe für das Diagramm.",
          "Führungslinie für das Diagramm.",
          ...
          "Die Schriftart-ID darf nur Buchstaben, Ziffern, Unterstriche und Bindestriche enthalten.",
  ...
  var t = i()
  return r.getDefaultExportFromCjs(t)
})

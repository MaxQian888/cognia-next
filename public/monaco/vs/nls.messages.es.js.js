define("vs/nls.messages.es.js", ["./_commonjsHelpers-CT9FvmAN"], function (o) {
  "use strict"
  var e = {}
  /*!-----------------------------------------------------------
    ...
    return (
      a ||
        ...
        (globalThis._VSCODE_NLS_MESSAGES = [
          ...
          "Controla si se debe activar el análisis del establecedor de árbol y recopilar telemetría. Tendrá prioridad establecer `#editor.experimental.preferTreeSitter#` para idiomas específicos.",
          "Controla si el analizador de modelos de árbol debe activarse para CSS. Esto tendrá prioridad sobre `#editor.experimental.treeSitterTelemetry#` para CSS.",
          "Controla si se debe activar el análisis del establecedor de árbol para TypeScript. Esto tendrá prioridad sobre `#editor.experimental.treeSitterTelemetry#` para TypeScript.",
          "Controla si se debe activar el análisis del establecedor de árbol para ini. Esto tendrá prioridad sobre `#editor.experimental.treeSitterTelemetry#` para ini.",
          "Controla si se debe activar el análisis del establecedor de árbol para regex. Esto tendrá prioridad sobre `#editor.experimental.treeSitterTelemetry#` para regex.",
          ...
          "Cuando está habilitado, el editor de diferencias muestra un medianil especial para acciones de reversión y fase.",
          ...
          "Si está habilitado y el editor usa la vista insertada, los cambios de palabra se representan en línea.",
          ...
          "No almacene el historial del widget de reemplazo.",
          "Almacenar el historial de reemplazos en el área de trabajo activa",
          "Controla cómo se debe almacenar el historial del widget de reemplazo",
          "Controla si buscar widget debe buscar mientras escribe.",
 ...
 - Los valores mayores o igual que 8 se usarán como valores efectivos.`,
          ...
          "El minimapa se oculta cuando el ratón no está sobre él y se muestra cuando el ratón está sobre el minimapa.",
          "El minimapa solo se muestra cuando se desplaza el editor",
          ...
          "Controla si mostrar una sugerencia desplazará el código para crear espacio para la sugerencia insertada.",
          "Controla si las sugerencias más grandes se pueden mostrar en paralelo.",
          "Las sugerencias más grandes se mostrarán una al lado de la otra si hay espacio suficiente; de lo contrario, se mostrarán a continuación.",
          "Las sugerencias más grandes nunca se muestran una al lado de la otra y siempre se mostrarán a continuación.",
          "Controla si la sugerencia se mostrará como contraída hasta saltar a ella.",
          ...
          "Controla si se selecciona una sugerencia cuando se muestra el widget. Tenga en cuenta que esto solo se aplica a las sugerencias desencadenadas automáticamente ({0} y {1}) y que siempre se selecciona una sugerencia cuando se invoca explícitamente, por ejemplo, a través de 'Ctrl+Espacio'.",
          ...
          "Configuraciones regionales que se usarán para la segmentación de palabras al realizar operaciones o navegaciones relacionadas con palabras. Especifique la etiqueta de idioma BCP 47 de la palabra que desea reconocer (por ejemplo, ja, zh-CN, zh-Hant-TW, etc.).",
          ...
          "Controla si se permite el uso de alto de línea variable en el editor.",
          "Controla si se permite el uso de fuentes variables en el editor.",
          "Controla si se permite el uso de fuentes variables en el editor en el modo de accesibilidad.",
          ...
          "Controla si el editor debe aplicar sangría automática automáticamente.",
          "Controla si el editor deberá aplicar automáticamente sangría automática al contenido pegado cuando se pegue dentro de una cadena. Esto surte efecto cuando autoIndentOnPaste es verdadero.",
          ...
          "Controla el estilo del cursor en el modo de entrada de inserción.",
          "Controla el estilo del cursor en el modo de entrada de sobrescritura.",
          ...
          "Controla cuándo se debe aplicar '#editor.cursorSurroundingLines#'.",
          'Controla el ancho del cursor cuando "#editor.cursorStyle#" se establece en "line".',
          'Controla la altura del cursor cuando "#editor.cursorStyle#" se establece en "line". La altura máxima del cursor depende de la altura de la línea.',
          "Controla si el editor debe permitir mover las selecciones mediante arrastrar y colocar.",
          "Establece si se debe usar la API de EditContext en lugar del cuadro de texto para activar la entrada en el editor.",
          "Indica si se debe renderizar el contenido del lector de pantalla cuando la configuración `#editor.editContext#` está habilitada.",
          "Use la representación basada en DOM normal.",
          "Use la aceleración de GPU.",
          "Controla si se debe usar la aceleración de GPU experimental para representar el editor.",
          ...
          "Haga que el desplazamiento sea inercial, lo cual es especialmente útil con el panel táctil en Linux.",
          ...
          "Controla lo que ocurre al hacer clic con el botón central del ratón en el editor.",
          ...
          "Controla el retraso en milisegundos después del cual se resaltan las repeticiones.",
          "Controla si el pegado debe sobrescribirse.",
          ...
          "Controla si el editor se desplazará cuando se presione el botón central.",
          ...
          "Controla cuántos caracteres pueden estar en la selección antes de que no se resalten coincidencias similares. Establezca en cero para un valor ilimitado.",
          "Controla si el editor debe resaltar las coincidencias de selección que abarcan varias líneas.",
          ...
          "Controla si el editor también eliminará el espacio en blanco de sangría de la línea siguiente al eliminar un salto de línea.",
          ...
          "Los espacios y tabulaciones se insertan y eliminan en alineación con tabulaciones.",
          ...
          'Controla si el literal `\\n` desencadenará un ajuste de línea cuando se habilite `#editor.wordWrap#`.\r\n\r\nPor ejemplo:\r\n```c\r\nchar* str="hello\\nworld"\r\n```\r\nse mostrará como\r\n```c\r\nchar* str="hello\\n\r\n           world"\r\n```',
          "Muestra los elementos Decorator de color predeterminados solo cuando ninguna extensión proporciona elementos Decorator de colores.",
          "Mostrar siempre los elementos decorator de color predeterminados.",
          "No mostrar nunca los elementos decorator de color predeterminados.",
          "Controla si las decoraciones de color insertadas deben mostrarse con el proveedor de colores del documento predeterminado.",
          ...
          "Color de fondo de los cursores del editor principal cuando hay varios cursores presentes. Permite personalizar el color del carácter solapado por el bloque del cursor.",
          "Color de los cursores del editor secundario cuando hay varios cursores presentes.",
          "Color de fondo de los cursores del editor secundario cuando hay varios cursores presentes. Permite personalizar el color del carácter solapado por el bloque del cursor.",
          ...
          "Si el modo insertado está activo",
          "Indica si la modificación se puede escribir en el editor de diferencias",
          "Indica si la modificación se puede escribir en el editor de diferencias",
          ...
          'Organice las importaciones en el archivo actual. También se denomina "Optimizar importaciones" por parte de algunas herramientas',
          "Corregir todo",
          ...
          "Habilitar el desencadenamiento {0} cuando {1} se establece en {2}. Las acciones de código deben establecerse en {3} para que se desencadenen los cambios de ventana y de foco.",
          ...
          "Delimitar con",
          "Acción de origen",
          "Icono que genera el menú de acciones de código desde el medianil cuando no hay espacio en el editor.",
          "Icono que genera el menú de acciones de código desde el medianil cuando no hay espacio en el editor y hay disponible una corrección rápida.",
          "Icono que genera el menú de acciones de código desde el medianil cuando no hay espacio en el editor y hay disponible una corrección de IA.",
          "Icono que genera el menú de acciones de código desde el medianil cuando no hay espacio en el editor y hay disponible una corrección de IA y una corrección rápida.",
          "Icono que genera el menú de acciones de código desde el medianil cuando no hay espacio en el editor y hay disponible una corrección de IA y una corrección rápida.",
          "Ejecutar: {0}",
          ...
          "Mostrar comandos de CodeLens para la línea actual",
          "Icono para cerrar el selector de colores",
          "Haga clic para alternar las opciones de color (rgb/hsl/hex)",
          "Aquí hay un selector de colores.",
          "&&Mostrar o centrar Selector de colores independientes",
          "Mostrar o centrar Selector de colores independientes",
          "Mostrar o centrar un selector de color independiente que usa el proveedor de colores predeterminado. Muestra colores hexadecimales/rgb/hsl.",
          "Ocultar la Selector de colores",
          "Ocultar el selector de colores independiente.",
          "Insertar color con Selector de colores independiente",
          "Inserte colores hexadecimales/rgb/hsl con el selector de colores independiente centrado.",
          ...
          "Cursor Deshacer",
          "Cursor Rehacer",
          `El tipo de edición de pegado con la que se intentará pegar.\r
En caso de haber varias ediciones para esta variante, el editor mostrará un selector. En caso de que no haya ediciones de este tipo, el editor mostrará un mensaje de error.`,
          `Lista de variantes de edición de pegado preferidas para su intento de aplicación.\r
Se aplicará la primera edición que coincida con las preferencias.`,
          ...
          "Resolviendo la edición de pegado para '{0}'. Haga clic para cancelar",
          "Ejecutando controladores de pegado. Haga clic para cancelar y hacer pegado básico",
          "Configurar la acción de pegado predeterminada",
          ...
          `Error al resolver la edición "{0}":\r
{1}`,
          `Error al aplicar la edición ''{0}:\r
{1}`,
          ...
          "Alternar plegamiento de importación",
          ...
          "Color del texto contraído después de la primera línea de un rango doblado.",
          ...
          "Símbolo {0} de {1}",
          "Estadísticas de Atlas de textura de registro",
          "Guardar atlas de textura",
          "Glifo de dibujo",
          "Desarrollador: Representador de GPU del editor de depuración",
          ...
          "Desplácese hacia abajo al mantener el puntero sobre el editor.",
          "Desplazar al mantener el puntero a la izquierda",
          "Desplácese a la izquierda al mantener el puntero sobre el editor.",
          "Desplazar al mantener el puntero a la derecha",
          "Desplácese a la derecha al mantener el puntero sobre el editor.",
          "Desplazamiento de página hacia arriba",
          "Desplazar página hacia arriba al mantener el puntero sobre el editor.",
          "Desplazamiento de página hacia abajo",
          "Desplace la página hacia abajo al mantener el puntero sobre el editor.",
          ...
          "Convierta la sangría de tabulación en espacios.",
          "Convertir sangría en tabulaciones",
          "Convierte la sangría de espacios en tabulaciones.",
          "Aplicar sangría con tabulaciones",
          "Usar sangría con tabulaciones.",
          "Aplicar sangría con espacios",
          "Use sangría con espacios.",
          "Cambiar tamaño de visualización de tabulación",
          "Cambie el tamaño de espacio equivalente de la pestaña.",
          "Detectar sangría del contenido",
          "Detectar la sangría del contenido.",
          "Volver a aplicar sangría a líneas",
          "Vuelva a aplicar sangría a las líneas del editor.",
          "Volver a aplicar sangría a líneas seleccionadas",
          "Vuelve a aplicar sangría a las líneas seleccionadas del editor.",
          ...
          "Saltar a la siguiente edición insertada",
          ...
          "Si el cursor está en sangría",
          "Si el editor tiene texto seleccionado",
          "Si el cursor está en una edición insertada",
          "Si una edición alineada es visible",
          "Indica si la pestaña debe saltar a una edición insertada.",
          "Indica si la pestaña debe aceptar la edición insertada.",
          "Si el editor de código actual muestra una vista previa de ediciones insertadas",
          "Inspeccionar esto en la vista accesible ({0})",
          "Hay finalizaciones insertadas aquí",
          "Sugerencia:",
          ...
          "Color de superposición para el texto modificado en el texto original de las ediciones insertadas.",
          "Color de fondo de las líneas cambiadas en el texto modificado de las ediciones insertadas.",
          "Color de superposición del texto modificado en el texto modificado de las ediciones insertadas.",
          "Color de primer plano para el indicador de medianil de edición en línea principal.",
          "Color de borde para el indicador de medianil de edición insertada principal.",
          "Color de fondo para el indicador de medianil de edición en línea principal.",
          "Color de primer plano para el indicador de medianil de edición en línea secundario.",
          "Color del borde del indicador de medianil de edición insertada secundario.",
          "Color de fondo para el indicador de medianil de edición en línea secundario.",
          "Color de primer plano para el indicador de medianil alineado correcto.",
          "Color de borde para el indicador de medianil de edición insertada correcto.",
          "Color de fondo para el indicador de medianil de edición en línea correcto.",
          "Color de fondo del indicador de medianil de edición en línea.",
          "Color de borde del texto original en las ediciones insertadas.",
          "Color del borde del texto modificado en las ediciones insertadas.",
          "Color de borde modificado para el widget de ediciones insertadas cuando la pestaña lo aceptará.",
          "Color del borde original del widget de ediciones insertadas sobre el texto original cuando la pestaña lo acepte.",
          ...
          "Leer más",
          "Una clave de contexto que es true cuando se encuentra al final de una palabra. Tenga en cuenta que esto solo se define cuando están habilitadas las finalizaciones de pestañas",
          ...
          "Determina si la tecla tab mueve el foco alrededor del área de trabajo o inserta el carácter de tabulación en el editor actual. Esto también se denomina captura de pestañas, navegación por pestañas o modo de enfoque de pestañas.",
          ...
          `Este archivo "{0}" contiene uno o más caracteres de terminación de línea inusuales, como el separador de línea (LS) o el separador de párrafo (PS).\r
\r
Se recomienda eliminarlos del archivo. Esto puede configurarse mediante "editor.unusualLineTerminators".`,
          ...
          "Siguiente sugerencia de edición en línea",
          "Siguiente sugerencia de edición",
          ...
          "Editar archivo modificado de chat",
          "Archivo modificado desde ediciones de chat",
          "Se envió una solicitud de chat",
          "Se envió una solicitud de chat",
          "Respuesta de chat recibida",
          "Solicitud de acción de código desencadenada",
          "Solicitud de acción de código desencadenada",
          "Acción de código aplicada",
          "Progreso",
          "Progreso",
          "Borrar",
          "Borrar",
          ...
          "Grabación de voz detenida",
          "Ediciones guardadas",
          "Ediciones guardadas",
          "Deshacer ediciones",
          "Ediciones deshechas",
          "Acción necesaria por parte del usuario del chat",
          "Acción necesaria por parte del usuario del chat",
          "Ver",
          "Ayuda",
          "Probar",
...
[{1}] {2}`,
          ...
          "Configure los valores que se van a invalidar para {0}.",
...
recibido: '{1}'.`,
          ...
          "Advertencias",
          "Información",
          'Los problemas están en pausa porque: "{0}"',
          'Los problemas están en pausa porque: "{0}" y {1} más',
          "usado recientemente",
          "comandos similares",
          ...
          "Alineación de la entrada rápida",
          ...
          "Se usa en el contexto de cualquier tipo de entrada rápida. Si cambia un enlace de teclado para este comando, también debe cambiar todos los demás enlaces de teclado (variantes modificadoras) de este comando.",
          ...
          "Se usa en el contexto de algunas entradas rápidas. Si cambia un enlace de teclado para este comando, también debe cambiar todos los demás enlaces de teclado (variantes modificadoras) de este comando.",
          ...
          "Color del borde de una composición de IME.",
          ...
          "Color de primer plano de la opción de radio activa.",
          "Color de fondo de la opción de radio activa.",
          "Color de borde de la opción de radio activa.",
          "Color de primer plano de la opción de radio inactiva.",
          "Color de fondo de la opción de radio inactiva.",
          "Color de borde de la opción de radio inactiva.",
          "Color de fondo de la opción de radio activa inactiva al mantener el puntero.",
          ...
          "Fondo de una casilla de verificación deshabilitada.",
          ...
          "Color de primer plano del distintivo de actividad de advertencia",
          "Color de fondo del distintivo de actividad de advertencia",
          "Color de primer plano del distintivo de actividad de error",
          "Color de fondo del distintivo de actividad de error",
          ...
          "Este color debe ser transparente u ocultará el contenido",
          "Use el color predeterminado.",
          "El id. de fuente solo puede contener letras, números, guiones bajos y guiones.",
  ...
  var n = r()
  return o.getDefaultExportFromCjs(n)
})

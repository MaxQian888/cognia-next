define("vs/nls.messages.fr.js", ["./_commonjsHelpers-CT9FvmAN"], function (s) {
  "use strict"
  var e = {}
  /*!-----------------------------------------------------------
    ...
    return (
      r ||
        ...
        (globalThis._VSCODE_NLS_MESSAGES = [
          ...
          "Contrôle si l’analyse de sitter (système) d’arborescence doit être activée et la télémétrie collectée. La définition de `#editor.experimental.preferTreeSitter#` pour des langages spécifiques est prioritaire.",
          "Contrôle si l’analyse Tree-sitter doit être activée pour css. Cette opération a la priorité sur `#editor.experimental.treeSitterTelemetry#` pour css.",
          "Contrôle si l’analyse Tree-sitter doit être activée pour TypeScript. Cette opération aura la priorité sur `#editor.experimental.treeSitterTelemetry#` pour TypeScript.",
          "Contrôle si l’analyse Tree-sitter doit être activée pour ini. Cette opération aura la priorité sur `#editor.experimental.treeSitterTelemetry#` pour ini.",
          "Contrôle si l’analyse Tree-sitter doit être activée pour regex. Cette opération aura la priorité sur `#editor.experimental.treeSitterTelemetry#` pour regex.",
          ...
          "Lorsque cette option est activée, l’éditeur de différences affiche une marge spéciale pour les actions de rétablissement et d’index.",
          ...
          "Si cette option est activée et que l’éditeur utilise la vue inline, les modifications apportées aux mots sont restituées inline.",
          ...
          "Ne stockez pas l’historique de recherche à partir du widget de recherche.",
          "Stocker l’historique de recherche dans l’espace de travail actif",
          "Contrôle la façon dont l’historique du widget de recherche doit être stocké",
          "Ne pas stocker l'historique à partir du widget de remplacement.",
          "Stocker l'historique des remplacements dans l'espace de travail actif",
          "Contrôle la manière dont l'historique du widget de remplacement doit être stocké",
          "Contrôle si le widget de recherche doit effectuer une recherche au fur et à mesure de la saisie.",
          ...
          `Contrôle la hauteur de ligne. \r
 ...
 : les valeurs supérieures ou égales à 8 seront utilisées comme valeurs effectives.`,
          ...
          "Le minimap est masqué lorsque la souris n’est pas au-dessus du minimap et affiché lorsque la souris est au-dessus du minimap.",
          "Le minimap n’est affiché que lorsque l’éditeur est défilé.",
          ...
          "Contrôle si l'affichage d'une suggestion déplace le code pour faire de la place à la suggestion en ligne.",
          "Contrôle si les suggestions plus grandes peuvent être affichées côte à côte.",
          "Les suggestions plus grandes s’affichent côte à côte s’il y a suffisamment d’espace. Sinon, elles s’afficheront en dessous.",
          "Les suggestions plus grandes ne s’affichent jamais côte à côte et s’afficheront toujours en dessous.",
          "Contrôle si la suggestion s’affiche comme réduite jusqu’à ce qu’elle soit sautée.",
          ...
          "Contrôle si une suggestion est sélectionnée lorsque le widget s’affiche. Notez que cela ne s’applique qu’aux suggestions déclenchées automatiquement ({0} et {1}) et qu’une suggestion est toujours sélectionnée lorsqu’elle est explicitement invoquée, par exemple via `Ctrl+Espace`.",
          ...
          "Paramètres régionaux à utiliser pour la segmentation de mots lors de navigations ou d’opérations liées à un mot. Spécifiez la balise de langue BCP 47 du mot que vous souhaitez reconnaître (par exemple, ja, zh-CN, zh-Hant-TW, etc.).",
          ...
          "Permet d'autoriser ou non l'utilisation de hauteurs de ligne variables dans l'éditeur.",
          "Contrôle s’il faut autoriser l’utilisation de polices variables dans l’éditeur.",
          "Contrôle s’il faut autoriser l’utilisation de polices variables dans l’éditeur en mode d’accessibilité.",
          ...
          "Contrôle si l’éditeur doit automatiquement mettre en retrait le contenu collé.",
          "Contrôle si l’éditeur doit automatiquement mettre en retrait le contenu collé lorsqu’il est inséré dans une chaîne. Cela prend effet lorsque l’option autoIndentOnPaste est activée.",
          ...
          "Contrôle la condition permettant de faire apparaître un sélecteur de couleur à partir d'un décorateur de couleur.",
          ...
          "Contrôle le style du curseur en mode d’entrée d’insertion.",
          "Contrôle le style du curseur en mode d’entrée de surtype.",
          ...
          "Contrôle le moment où #editor.cursorSurroundingLines# doit être appliqué.",
          "Détermine la largeur du curseur lorsque `#editor.cursorStyle#` est à `line`.",
          "Détermine la hauteur du curseur lorsque `#editor.cursorStyle#` est à `line`. La hauteur maximale du curseur dépend de la hauteur de ligne.",
          "Contrôle si l’éditeur autorise le déplacement de sélections par glisser-déplacer.",
          "Définit si l’API EditContext doit être utilisée à la place de la zone de texte pour gérer l’entrée dans l’éditeur.",
          "Indique si le contenu enrichi pour les lecteurs d’écran doit être rendu lorsque le paramètre `#editor.editContext#` est activé.",
          "Utilisez le rendu DOM normal.",
          "Utilisez l’accélération GPU.",
          "Contrôle s’il faut utiliser l’accélération GPU expérimentale pour afficher l’éditeur.",
          ...
          "Rendez le défilement inertiel, principalement utile avec le pavé tactile sur Linux.",
          ...
          "Contrôle ce qui se passe lorsque le bouton central de la souris est cliqué dans l'éditeur.",
          ...
          "Contrôle le délai en millisecondes après lequel les occurrences sont mises en surbrillance.",
          "Contrôle si le collage doit être surtype.",
          ...
          "Contrôle si l’éditeur défile lorsque le bouton central est enfoncé.",
          ...
          "Contrôle combien de caractères peuvent être dans la sélection avant que les correspondances similaires ne soient pas mises en surbrillance. Définissez sur zéro pour un nombre illimité.",
          "Contrôle si l’éditeur doit mettre en surbrillance les correspondances de sélection qui s’étendent sur plusieurs lignes.",
          ...
          "Contrôle si l’éditeur supprime également l’espace blanc d’indentation de la ligne suivante lors de la suppression d’une nouvelle ligne.",
          ...
          "Les espaces et les onglets sont insérés et supprimés en alignement avec les taquets de tabulation.",
          ...
          'Contrôle si le littéral `\\n` doit déclencher un wordWrap lorsque `#editor.wordWrap#` est activé.\r\n\r\nPar exemple :\r\n```c\r\nchar* str="hello\\nworld"\r\n```\r\ns\'affichera comme suit\r\n```c\r\nchar* str="hello\\n\r\n           world"\r\n```',
          "Afficher les éléments décoratifs de couleurs par défaut uniquement lorsqu’aucune extension ne fournit de décorateurs de couleurs.",
          "Toujours afficher les éléments décoratifs de couleurs par défaut.",
          "Ne jamais afficher les éléments décoratifs de couleurs par défaut.",
          "Contrôle si les décorations de couleur inline doivent être affichées à l’aide du fournisseur de couleurs par défaut du document.",
          ...
          "Couleur du curseur de l’éditeur principal lorsque plusieurs curseurs sont présents.",
          "Couleur d’arrière-plan du curseur de l’éditeur principal lorsque plusieurs curseurs sont présents. Permet de personnaliser la couleur d'un caractère survolé par un curseur de bloc.",
          "Couleur des curseurs de l’éditeur secondaire lorsque plusieurs curseurs sont présents.",
          "Couleur d’arrière-plan des curseurs de l’éditeur secondaire lorsque plusieurs curseurs sont présents. Permet de personnaliser la couleur d'un caractère survolé par un curseur de bloc.",
          ...
          "Indique si la modification est accessible en écriture dans l’éditeur de différences",
          "Indique si la modification est accessible en écriture dans l’éditeur de différences",
          "URI du document d’origine",
          "URI du document modifié",
          ...
          "Organisez les importations dans le fichier actif. Également appelé « Optimiser les importations » par certains outils",
          "Tout corriger",
          ...
          "Activez le déclenchement de {0} lorsque {1} est défini sur {2}. Les actions de code doivent être définies sur {3} pour être déclenchées pour les modifications de fenêtre et de focus.",
          ...
          "Entourer de",
          "Action source",
          "Icône qui génère le menu Actions de code à partir de la reliure quand il n’y a pas d’espace dans l’éditeur.",
          "Icône qui génère le menu actions de code à partir de la reliure quand l’éditeur n’a pas d’espace et qu’un correctif rapide est disponible.",
          "Icône qui génère le menu actions de code à partir de la reliure quand il n’y a pas d’espace dans l’éditeur et qu’un correctif IA est disponible.",
          "Icône qui génère le menu actions de code à partir de la reliure quand il n’y a pas d’espace dans l’éditeur et qu’un correctif IA et un correctif rapide sont disponibles.",
          "Icône qui génère le menu actions de code à partir de la reliure quand il n’y a pas d’espace dans l’éditeur et qu’un correctif IA et un correctif rapide sont disponibles.",
          "Exécuter : {0}",
          ...
          "Il y a un sélecteur de couleurs ici.",
          "&&Afficher ou mettre le focus sur le sélecteur de couleurs autonome",
          "Afficher ou mettre le focus sur le sélecteur de couleurs autonome",
          "Affichez ou concentrez un sélecteur de couleurs autonome qui utilise le fournisseur de couleurs par défaut. Il affiche les couleurs hex/rgb/hsl.",
          "Masquer le sélecteur de couleurs",
          "Masquer le sélecteur de couleurs autonome.",
          "Insérer une couleur avec un sélecteur de couleurs autonome",
          "Insérez des couleurs hexadécimales/rgb/hsl avec le sélecteur de couleurs autonome prioritaire.",
          ...
          `Type de la modification de collage à essayer pour les opérations de collage.\r
S’il existe plusieurs modifications de ce type, l’éditeur affiche un sélecteur. S’il n’existe aucune modification de ce type, l’éditeur affiche un message d’erreur.`,
          `Liste du type de modification de collage préféré à appliquer.\r
La première modification correspondant aux préférences est appliquée.`,
          ...
          "Résolution de la modification du collage pour '{0}'. Cliquez pour annuler",
          "Exécution des gestionnaires de collage. Cliquez pour annuler et effectuer un collage de base",
          "Configurer l’action de collage par défaut",
...
{1}`,
          `Erreur lors de l’application de la modification «{0}» :\r
{1}`,
          ...
          "Activer/désactiver le repli récursif",
          ...
          "Activer/désactiver le pliage d’importation",
          "Niveau de pliage {0}",
          ...
          "Couleur du texte réduit après la première ligne d’une plage pliée.",
          ...
          "Symbole {0} sur {1}",
          "Statistiques de l’atlas de texture de journal",
          "Enregistrer l’Atlas de textures",
          "Dessiner un glyphe",
          "Développeur : débogage du convertisseur GPU Rédacteur",
          ...
          "Faites défiler le pointeur de l’éditeur vers le bas.",
          "Faire défiler vers la gauche au pointage",
          "Faites défiler vers la gauche le pointeur de l’éditeur.",
          "Faire défiler le pointage vers la droite",
          "Faites défiler vers la droite le pointeur de l’éditeur.",
          "Pointer vers le haut de la page",
          "Page précédente le pointage de l’éditeur.",
          "Pointer vers le bas de la page",
          "Page suivante le pointage de l’éditeur.",
          ...
          "Modifier la taille d’espace équivalente à l’onglet.",
          "Détecter la mise en retrait à partir du contenu",
          "Détectez la mise en retrait du contenu.",
          "Remettre en retrait les lignes",
          "Réinsérez les lignes de l’éditeur.",
          "Réindenter les lignes sélectionnées",
          "Réinsérez les lignes sélectionnées de l’éditeur.",
          ...
          "Développeur : extraire l’état de suggestion inline",
          ...
          "Accéder à la modification inline suivante",
          "Masquer la suggestion en ligne",
          "Activer/désactiver l’affichage des suggestions incluses réduit",
          ...
          "Indiquez si le curseur est sur le texte fantôme",
          "Indique si le curseur est en retrait",
          "Indique si l’éditeur a une sélection",
          "Indique si le curseur est à une modification inline",
          "Indique si une modification inline est visible",
          "Indique si l’onglet doit passer à une modification inline.",
          "Indique si l’onglet doit accepter la modification inline.",
          "Indique si l’éditeur de code actuel affiche un aperçu des modifications inline",
          "Inspecter ceci dans l’affichage accessible ({0})",
          "Il y a des complétions incluses ici",
          "Suggestion :",
          ...
          "Couleur de superposition du texte modifié dans le texte d’origine des modifications inline.",
          "Couleur d’arrière-plan des lignes modifiées dans le texte modifié des modifications inline.",
          "Couleur de superposition du texte modifié dans le texte modifié des modifications inline.",
          "Couleur de premier plan de l’indicateur de reliure d’édition inline principale.",
          "Couleur de bordure pour l’indicateur de modification en ligne principal.",
          "Couleur d’arrière-plan de l’indicateur de reliure de modification inline principale.",
          "Couleur de premier plan de l’indicateur de reliure d’édition inline secondaire.",
          "Couleur de bordure pour l’indicateur de modification en ligne secondaire.",
          "Couleur d’arrière-plan de l’indicateur de reliure de modification inline secondaire.",
          "Couleur de premier plan de l’indicateur de reliure de modification inline réussie.",
          "Couleur de bordure pour l’indicateur de modification en ligne réussie.",
          "Couleur d’arrière-plan de l’indicateur de reliure de modification inline réussie.",
          "Couleur d’arrière-plan de l’indicateur de reliure d’édition inline.",
          "Couleur de bordure du texte d’origine dans les modifications inline.",
          "Couleur de bordure du texte modifié dans les modifications inline.",
          "Couleur de bordure modifiée du widget d’édition en ligne lorsque la tabulation l’accepte.",
          "Couleur de bordure d’origine du widget d’édition en ligne sur le texte original lorsque la tabulation l’accepte.",
          ...
          "Prioriser la suggestion de changement de nom précédente",
          "Indique si le widget de renommage d'entrée est visible",
          "Indique si le widget de renommage d'entrée est prioritaire",
          ...
          "Lire la suite",
          "Clé de contexte true à la fin d’un mot. Notez que cette option est définie uniquement lorsque les complétions de tabulation sont activées",
          ...
          "Détermine si la touche d’onglet déplace le focus autour du workbench ou insère le caractère d’onglet dans l’éditeur actuel. Il s’agit également du verrouillage des onglets, de la navigation dans les onglets ou du mode focus des onglets.",
          ...
          "Prochaine suggestion de modification dans la ligne",
          "Prochaine suggestion de modification",
          ...
          "Ligne diff modifiée",
          "Modifier le fichier modifié de la conversation",
          "Fichier modifié à partir des modifications de conversation",
          "Demande de conversation envoyée",
          "Requête de conversation envoyée",
          "Réponse de conversation reçue",
          "Requête d'action de code déclenchée",
          "Requête d'action de code déclenchée",
          "Code Action Appliqué",
          "Progression",
          "Progression",
          "Effacer",
          "Effacer",
...
[{1}] {2}`,
          ...
          "{0} à Appliquer, {1} à la Préversion",
          "{0} pour appliquer",
          ...
          "Configurer les paramètres à remplacer pour {0}.",
...
Reçu : '{1}'.`,
          ...
          "Avertissements",
          "Infos",
          "Les problèmes sont suspendus car : « {0} »",
          "Les problèmes sont suspendus car : « {0} » et {1} de plus",
          "récemment utilisées",
          ...
          "Utilisé dans le contexte de tout type d’entrée rapide. Si vous modifiez une combinaison de touches pour cette commande, vous devez également modifier toutes les autres combinaisons de touches (variantes de modificateur) de cette commande.",
          ...
          "Utilisé dans le contexte d’une entrée rapide. Si vous modifiez une combinaison de touches pour cette commande, vous devez également modifier toutes les autres combinaisons de touches (variantes de modificateur) de cette commande.",
          ...
          "Couleur de bordure d’une composition IME.",
          ...
          "Couleur d’arrière-plan de l’option radio active.",
          "Couleur de bordure de l’option radio active.",
          "Couleur de premier plan de l’option radio inactive.",
          "Couleur d’arrière-plan de l’option radio inactive.",
          "Couleur de bordure de l’option radio inactive.",
          "Couleur d’arrière-plan de l’option radio active inactive lors du pointage.",
          ...
          "Arrière-plan d’une case à cocher désactivée.",
          "Avant-plan d’une case à cocher désactivée.",
          ...
          "Couleur d'arrière-plan de la liste d'actions.",
          "Couleur de premier plan de la liste d'actions.",
          "Couleur de premier plan de la liste d’actions pour l’élément focalisé.",
          ...
          "Couleur de premier plan du badge d’activité d’avertissement",
          "Couleur d’arrière-plan du badge d’activité d’avertissement",
          "Couleur de premier plan du badge d’activité d’erreur",
          "Couleur d’arrière-plan du badge d’activité d’erreur",
          ...
          "Ligne directrice pour le graphique.",
          ...
          "Cette couleur doit être transparente ou son contenu sera masqué",
          "Utiliser la couleur par défaut.",
          "L’ID de police doit contenir uniquement des lettres, des chiffres, des traits de soulignement et des tirets.",
  ...
  var t = i()
  return s.getDefaultExportFromCjs(t)
})

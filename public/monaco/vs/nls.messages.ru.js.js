define("vs/nls.messages.ru.js", ["./_commonjsHelpers-CT9FvmAN"], function (n) {
  "use strict"
  var e = {}
  /*!-----------------------------------------------------------
    ...
    return (
      t ||
        ...
        (globalThis._VSCODE_NLS_MESSAGES = [
          ...
          'Определяет, следует ли включать синтаксический анализ tree sitter для CSS. Этот параметр имеет приоритет над параметром "#editor.experimental.treeSitterTelemetry#" для CSS.',
          'Определяет, следует ли включать синтаксический анализ tree sitter для TypeScript. Этот параметр имеет приоритет над параметром "#editor.experimental.treeSitterTelemetry#" для TypeScript.',
          'Определяет, следует ли включать синтаксический анализ tree sitter для ini. Этот параметр имеет приоритет над параметром "#editor.experimental.treeSitterTelemetry#" для ini.',
          'Определяет, следует ли включать синтаксический анализ tree sitter для регулярного выражения. Этот параметр имеет приоритет над параметром "#editor.experimental.treeSitterTelemetry#" для регулярного выражения.',
          ...
          "Не сохранять журнал поиска из мини-приложения поиска.",
          "Сохранение журнала поиска в активной рабочей области.",
          "Управляет тем, как должен храниться журнал мини-приложения поиска",
          "Не сохраняйте журнал из мини-приложения замены.",
          "Сохранение журнала замен во всей активной рабочей области",
          "Управляет хранением журнала мини-приложения замен",
          'Определяет, должна ли функция "Найти мини-приложение" выполнять поиск при вводе текста.',
          ...
          'Определяет время задержки в миллисекундах перед скрытием наведения. Требуется включить "#editor.linkedEditing#".',
          ...
          "Включить закрепленную прокрутку с помощью горизонтальной полосы прокрутки редактора.",
          "Включает вложенные указания в редакторе.",
          "Вложенные указания включены.",
          "Вложенные указания отображаются по умолчанию и скрываются удержанием клавиш {0}.",
          "Вложенные указания по умолчанию скрыты и отображаются при удержании {0}.",
          "Вложенные указания отключены.",
          "Управляет размером шрифта вложенных указаний в редакторе. По умолчанию {0} используется, когда сконфигурированное значение меньше {1} или больше размера шрифта редактора.",
          "Управляет семейством шрифтов для вложенных указаний в редакторе. Если значение не задано, используется {0}.",
          "Включает поля вокруг вложенных указаний в редакторе.",
          'Максимальная общая длина вложенных указаний для одной строки, прежде чем они будут обрезаны редактором. Задайте значение "0", чтобы никогда не усекать',
          `Определяет высоту строки. \r
...
– Значения больше или равные 8 будут использоваться в качестве действующих значений.`,
          ...
          "Мини-карта всегда отображается.",
          "Мини-карта скрыта, когда мышь не находится над мини-картой, и отображается, когда мышь наведена на мини-карту.",
          "Мини-карта отображается только при прокрутке редактора",
          ...
          "Определяет, отображаются ли именованные области в виде заголовков разделов на мини-карте.",
          'Определяет, отображаются ли комментарии "MARK:" в виде заголовков разделов на мини-карте.',
          'Определяет регулярное выражение, используемое для поиска заголовков разделов в комментариях. Регулярное выражение должно содержать именованную группу соответствия "label" (записанную как "(?<label>.+)"), которая инкапсулирует заголовок раздела, в противном случае она не будет работать. При необходимости можно включить другую группу совпадений с именем "разделитель". Используйте \\n в шаблоне для сопоставления многострокового заголовка.',
          "Определяет размер шрифта заголовков разделов на мини-карте.",
          "Управляет объемом пространства (в пикселях) между символами заголовка раздела. Это улучшает удобочитаемость заголовка при небольших размерах шрифтов.",
          ...
          "Определяет, будет ли предложение отображаться как свернутое до прыжка к нему.",
          ...
          "Определяет, выбирается ли предложение при отображении мини-приложения. Обратите внимание, что этот параметр применяется только к автоматически активированным предложениям ({0} и {1}) и что предложение всегда выбирается при явном вызове, например с помощью клавиш CTRL+ПРОБЕЛ.",
          ...
          "Языки, используемые для сегментации слов при навигации, связанной со словами, или при выполнении операций, связанных со словами. Укажите тег BCP 47 языка распознаваемого слова (пример: ja, zh-CN, zh-Hant-TW, и т. д.).",
          ...
          "Управляет стилем курсора в режиме ввода со вставкой.",
          "Управляет стилем курсора в режиме ввода с заменой.",
          ...
          'Управляет высотой курсора, когда для параметра "#editor.cursorStyle#" установлено значение "line". Максимальная высота курсора зависит от высоты строки.',
          ...
          'Следует ли отображать форматированное содержимое средства чтения с экрана, когда включен параметр "#editor.editContext#".',
          ...
          "Сделать прокрутку инерционной — это особенно полезно при использовании сенсорной панели в Linux.",
          ...
          "Управляет задержкой в миллисекундах, после которой выделяются вхождения.",
          "Управляет заменой при вставке.",
          ...
          'Управляет тем, сколько символов может быть в выделении, прежде чем похожие совпадения не будут выделены. Установите значение "ноль" для неограниченного количества.',
          "Определяет, должен ли редактор выделять в выбранном фрагменте совпадения, охватывающие несколько строк.",
          ...
          "Управляет тем, будет ли редактор также удалять пробелы отступа следующей строки при удалении новой строки.",
          ...
          "Пробелы и табуляции вставляются и удаляются в соответствии с позициями табуляции.",
          ...
          'Управляет тем, должен литерал "\\n" запускать перенос по словам, когда включен параметр "#editor.wordWrap#".\r\n\r\nНапример:\r\n```c\r\nchar* str="hello\\nworld"\r\n```\r\nбудет отображаться как\r\n```c\r\nchar* str="hello\\n\r\n           world"\r\n```',
          "Показывать декораторы цвета по умолчанию, только если ни один из расширений не предоставляет декораторы цветов.",
          "Всегда отображать декораторы цвета по умолчанию.",
          "Никогда не показывать декораторы цвета по умолчанию.",
          ...
          "Находится ли закрепленная прокрутка в фокусе",
          "Отображается ли закрепленная прокрутка",
          ...
          'Упорядочение импорта в текущем файле. Также называется "Оптимизация импорта" в некоторых средствах',
          "Исправить все",
          "Автоисправление...",
          ...
          "Действие с исходным кодом",
          "Значок, который вызывает меню действий кода из переплета, если в редакторе нет места.",
          "Значок, который вызывает меню действий кода из переплета, если в редакторе нет места и доступно быстрое исправление.",
          "Значок, который вызывает меню действий кода из переплета, если в редакторе нет места и доступно ИИ-исправление.",
          "Значок, который вызывает меню действий кода из переплета, если в редакторе нет места и доступно ИИ-исправление и быстрое исправление.",
          "Значок, который вызывает меню действий кода из переплета, если в редакторе нет места и доступно ИИ-исправление и быстрое исправление.",
          "Запустить: {0}",
          ...
          "Скрыть отдельную палитру.",
          "Вставка цвета с помощью автономной палитры цветов",
          "Вставка цветов (в шестнадцатеричном формате, RGB или HSL) с помощью отдельной палитре, на которую наведен фокус.",
          ...
          `Тип применяемой правки вставки.\r
Если существует несколько правок для этого типа, в редакторе будет отображаться средство выбора. Если правки такого типа отсутствуют, в редакторе будет отображаться сообщение об ошибке.`,
          `Список предпочитаемых вариантов правок вставки для применения.\r
Будет применена первая правка соответствующая настройкам.`,
          ...
          "Разрешение правки вставки для '{0}'. Щелкните, чтобы отменить",
          "Запуск обработчиков вставки. Щелкните, чтобы отменить и выполнить обычную вставку",
          "Настроить действие вставки по умолчанию",
          ...
          `Ошибка при разрешении правки "{0}":\r
{1}`,
          `Ошибка при применении изменения "{0}":\r
{1}`,
          ...
          "Цвет свернутого текста после первой строки сложенного диапазона.",
          ...
          "Показать мини-приложение наведения в редакторе или перенести на него фокус. В этом мини-приложении отображается документация, ссылки и другое содержимое для символа в текущей позиции курсора.",
          "Отображать предварительный просмотр определения при наведении курсора мыши",
          "Показывать предварительный просмотр определения в мини-приложении наведения в редакторе.",
          "Скрыть наведение",
          "Прокрутить наведение вверх",
          "Прокрутить вверх в редакторе в мини-приложении наведения.",
          "Прокрутить наведение вниз",
          "Прокрутить вниз в редакторе в мини-приложении наведения.",
          "Прокрутить наведение влево",
          "Прокрутить влево в редакторе в мини-приложении наведения.",
          "Прокрутить наведение вправо",
          "Прокрутить вправо в редакторе в мини-приложении наведения.",
          "Перейти на страницу вверх в наведении",
          "Предыдущая страница в редакторе при наведении.",
          "Перейти на страницу вниз в наведении",
          "Следующая страница в редакторе при наведении.",
          ...
          "Увеличить уровень детализации при наведении ({0})",
          "Увеличить уровень детализации при наведении",
          "Уменьшить уровень детализации при наведении ({0})",
          "Уменьшить уровень детализации при наведении",
          ...
          "Преобразовать отступы пробелами в табуляцию.",
          ...
          "Изменение эквивалента размера пространства для вкладки.",
          ...
          "Переключить отображение свернутых встроенных предложений",
          ...
          "Находится ли курсор на фантомном тексте",
          "Находится ли курсор в отступе",
          "Есть ли в редакторе выделенный фрагмент",
          "Находится ли курсор на встроенной правке",
          "Видно ли встроенную правку",
          "Должна ли вкладка переходить к встроенному редактированию.",
          "Должна ли вкладка принимать встроенное редактирование.",
          "Отображается ли в текущем редакторе кода предварительный просмотр встроенных параметров редактирования",
          "Проверить этот аспект в представлении с поддержкой специальных возможностей ({0})",
          "Здесь есть встроенные завершения",
          "Предложение:",
          ...
          "Цвет наложения для измененного текста в исходном тексте встроенных изменений.",
          "Цвет фона для измененных строк в измененном тексте встроенных изменений.",
          "Цвет наложения для измененного текста в измененном тексте встроенных изменений.",
          "Цвет переднего плана для основного встроенного индикатора редактирования.",
          "Цвет границы для основного индикатора поля редактирования.",
          "Цвет фона основного встроенного индикатора редактирования.",
          "Цвет переднего плана для вторичного встроенного индикатора редактирования.",
          "Цвет границы для индикатора вторичного встроенного редактирования.",
          "Цвет фона для вторичного встроенного индикатора редактирования канавок.",
          "Цвет переднего плана для индикатора успешного встроенного редактирования канавы.",
          "Цвет границы индикатора выполненного встроенного редактирования.",
          "Цвет фона для индикатора успешного встроенного редактирования канавы.",
          "Цвет фона для индикатора встроенной правки.",
          "Цвет границы для исходного текста во встроенных изменениях.",
          "Цвет границы для измененного текста во встроенных изменениях.",
          "Измененный цвет границы для мини-приложения встроенного редактирования, когда вкладка примет его.",
          "Исходный цвет границы для мини-приложения встроенного редактирования поверх оригинального текста, когда вкладка примет его.",
          "Заменить предыдущим значением",
          "Заменить следующим значением",
          "Вставить последнюю новую строку",
          ...
          "Добавить выделенный фрагмент в следующее найденное совпадение",
          "Добавить выделенный фрагмент в предыдущее найденное совпадение",
          "Переместить последний выделенный фрагмент в следующее найденное совпадение",
          ...
          "Цвет фона закрепленной прокрутки в окне быстрого редактора.",
          ...
          "Ноя",
          "Дек",
          "&&Переключить закрепленную прокрутку редактора",
          "Закрепленная прокрутка",
          "&&Закрепленная прокрутка",
          "&&Установить фокус на закрепленной прокрутке редактора",
          "Переключить закрепленную прокрутку редактора",
          "Включение или переключение закрепленной прокрутки редактора, которая показывает закрепленные области в верхней части области просмотра",
          "Установить фокус на закрепленной прокрутке редактора",
          "Выберите следующую линию закрепленной прокрутки редактора",
          "Выбрать предыдущую строку закрепленной прокрутки",
          "Перейти к строке закрепленной прокрутки, которая находится в фокусе",
          "Выберите редактор",
          ...
          "Подробнее",
          "Ключ контекста, который имеет значение true, когда в конце слова. Обратите внимание, что это определяется только при включении завершения табуляции",
          ...
          "Определяет действие при нажатии клавиши TAB: перемещение фокуса по рабочему интерфейсу или вставка знака табуляции в текущем редакторе. Это также называется захватом фокуса на вкладках, навигацией по вкладкам или режимом фокусировки на вкладках.",
          ...
          `Файл "{0}" содержит один или несколько необычных символов завершения строки, таких как разделитель строк (LS) или разделитель абзацев (PS).\r
\r
Рекомендуется удалить их из файла. Удаление этих символов можно настроить с помощью параметра "editor.unusualLineTerminators".`,
          ...
          "Следующее предложение правки в строке",
          "Следующее предложение правки",
          "Быстрое исправление терминала",
          "Быстрое исправление",
          "Отладчик остановлен в точке останова",
          "Точка останова",
          "Отсутствие вложенных указаний в строке",
          ...
          "Изменить измененный файл чата",
          "Файл изменен из изменений чата",
          "Отправлен запрос на чат",
          "Отправлен запрос на чат",
          "Получен ответ чата",
          "Запрос на действие кода активирован",
          "Запрос на действие кода активирован",
          "Действие кода применено",
          "Ход выполнения",
          "Ход выполнения",
          "Очистить",
          "Очистка",
          ...
          "Отменить изменения",
          "Изменения отменены",
          "Требуется действие пользователя чата",
          "Требуется действие пользователя чата",
          "Представление",
          "Справка",
          "Тест",
...
[{1}] {2}`,
          ...
          "Настройка переопределяемых параметров для {0}.",
...
Получено: "{1}".`,
          ...
          "Определяет, включена ли закрепленная прокрутка в деревьях.",
          ...
          'Проблемы приостановлены по следующей причине: "{0}"',
          'Проблемы приостановлены по следующим причинам: "{0}" и еще {1}',
          ...
          "Выравнивание быстрого ввода",
          "Тип видимого в данный момент быстрого ввода",
          "Находится ли курсор при быстром вводе в конце поля ввода",
          "Назад",
          ...
          "Цвет фона закрепленной прокрутки в редакторе",
          "Цвет фона переплета для закрепленной прокрутки в редакторе",
          "Цвет фона закрепленной прокрутки при наведении курсора мыши в редакторе",
          "Цвет тени закрепленной прокрутки в редакторе",
          " Цвет тени закрепленной прокрутки в редакторе",
          ...
          "Цвет границы для композиции IME.",
          "Цвет текущего поиска совпадений.",
          "Цвет текста текущего результата поиска.",
          ...
          "Цвет переднего плана других результатов поиска.",
          ...
          "Цвет переднего плана активного переключателя.",
          "Цвет фона активного переключателя.",
          "Цвет границы активного переключателя.",
          "Цвет переднего плана неактивного переключателя.",
          "Цвет фона неактивного переключателя.",
          "Цвет границы неактивного переключателя.",
          "Цвет фона неактивного переключателя при наведении указателя мыши.",
          ...
          "Фон отключенного флажка.",
          "Передний план отключенного флажка.",
          ...
          "Цвет переднего плана в списке или дереве для элементов, выделение которых уменьшено.",
          ...
          "Цвет фона списка действий.",
          "Цвет переднего плана списка действий.",
          "Цвет переднего плана списка действий для элемента, на котором находится фокус.",
          "Цвет фона списка действий для элемента, на котором находится фокус.",
          "Цвет границ меню.",
          ...
          "Цвет переднего плана значка предупреждения об активности",
          "Цвет фона значка предупреждения об активности",
          "Цвет переднего плана значка активности при ошибке",
          "Цвет фона значка активности при ошибке",
          ...
          "Идентификатор шрифта должен содержать только буквы, цифры, символы подчеркивания и дефисы.",
  ...
  var r = i()
  return n.getDefaultExportFromCjs(r)
})

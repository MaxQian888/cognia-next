...
` +
  ...
  function Sn(t) {
    if (t instanceof Error) {
      ...
      return {
        ...
        message: n,
        stack: r,
        noTelemetry: nt.isErrorNoTelemetry(t),
        cause: i ? Sn(i) : void 0,
        code: t.code,
      }
    }
  ...
  const An = "Canceled"
  function ro(t) {
    return t instanceof Ii ? !0 : t instanceof Error && t.name === An && t.message === An
  }
  class Ii extends Error {
    constructor() {
      ;(super(An), (this.name = this.message))
    }
  }
  ...
  class le extends Error {
    constructor(e) {
      ;(super(e || "An unexpected bug occurred."), Object.setPrototypeOf(this, le.prototype))
    }
  }
  function so(t, e = "Unreachable") {
    throw new Error(e)
  }
  function ao(t, e = "unexpected state") {
    if (!t) throw typeof e == "string" ? new le(`Assertion Failed: ${e}`) : e
  }
  function Ot(t) {
    if (!t()) {
      debugger
      ;(t(), qt(new le("Assertion Failed")))
    }
  }
  function zi(t, e) {
    let n = 0
  ...
  ;(function (t) {
    ...
    function c(b, g) {
      let v = 0
      for (const N of b) if (g(N, v++)) return !0
      return !1
    }
    t.some = c
    function d(b, g) {
      let v = 0
      for (const N of b) if (!g(N, v++)) return !1
      return !0
    }
    t.every = d
    function m(b, g) {
      for (const v of b) if (g(v)) return v
    }
    t.find = m
    function* f(b, g) {
      for (const v of b) g(v) && (yield v)
    }
    t.filter = f
    function* w(b, g) {
      let v = 0
      for (const N of b) yield g(N, v++)
    }
    t.map = w
    function* p(b, g) {
      let v = 0
    ...
    t.flatMap = p
    function* x(...b) {
      for (const g of b) lo(g) ? yield* g : yield g
    }
    t.concat = x
    function T(b, g, v) {
      let N = v
    ...
    t.length = y
    function* A(b, g, v = b.length) {
      for (
        g < -b.length && (g = 0),
          g < 0 && (g += b.length),
          v < 0 ? (v += b.length) : v > b.length && (v = b.length);
        g < v;
        g++
      )
        yield b[g]
    ...
    async function H(b) {
      const g = []
      for await (const v of b) g.push(v)
      return g
    }
    t.asyncToArray = H
    async function P(b) {
      let g = []
      for await (const v of b) g = g.concat(v)
      return g
    }
  ...
  const _n = class _n {
    ...
    add(e) {
      if (!e || e === Xe.None) return e
      if (e === this) throw new Error("Cannot register a disposable on itself!")
      return (
        this._isDisposed
          ? _n.DISABLE_DISPOSED_WARNING ||
            console.warn(
              new Error(
  ...
  Mi.None = Object.freeze({ dispose() {} })
  let Xe = Mi,
    te =
      ((Be = class {
        constructor(e) {
          ;((this.element = e), (this.next = Be.Undefined), (this.prev = Be.Undefined))
        }
      }),
      (Be.Undefined = new Be(void 0)),
      Be)
  class ho {
    constructor() {
  ...
  ;(function (t) {
    t.None = () => Xe.None
    function e(_, L) {
      return m(_, () => {}, 0, void 0, !0, void 0, L)
    }
    t.defer = e
    function n(_) {
      return (L, D = null, k) => {
        ...
        return (
          (M = _(
            (W) => {
              if (!R) return (M ? M.dispose() : (R = !0), L.call(D, W))
            },
            null,
            k
          )),
    ...
    t.once = n
    function i(_, L) {
      return t.once(t.filter(_, L))
    }
    t.onceIf = i
    function r(_, L, D) {
      return c((k, R = null, M) => _((W) => k.call(R, L(W)), null, M), D)
    }
    t.map = r
    function s(_, L, D) {
      return c(
    ...
    t.forEach = s
    function a(_, L, D) {
      return c((k, R = null, M) => _((W) => L(W) && k.call(R, W), null, M), D)
    }
    t.filter = a
    function l(_) {
      return _
    ...
    function o(..._) {
      return (L, D = null, k) => {
        const R = uo(..._.map((M) => M((W) => L.call(D, W))))
        return d(R, k)
      }
    }
    t.any = o
    ...
    function c(_, L) {
      ...
      const k = {
        ...
        R = new Ee(k)
      return (L?.add(R), R.event)
    }
    function d(_, L) {
      return (L instanceof Array ? L.push(_) : L && L.add(_), _)
    }
    function m(_, L, D = 100, k = !1, R = !1, M, W) {
      let F,
        U,
        O,
        Y = 0,
      ...
      const xe = {
          ...
          onWillAddFirstListener() {
            F = _((ih) => {
              ;(Y++,
                (U = L(U, ih)),
                k && !O && (Ce.fire(U), (U = void 0)),
                (Z = () => {
                  const rh = U
                  ;((U = void 0), (O = void 0), (!k || Y > 1) && Ce.fire(rh), (Y = 0))
                }),
                typeof D == "number"
                  ? (O && clearTimeout(O), (O = setTimeout(Z, D)))
                  : O === void 0 && ((O = null), queueMicrotask(Z)))
            })
          },
        ...
        Ce = new Ee(xe)
      return (W?.add(Ce), Ce.event)
    }
    t.debounce = m
    function f(_, L = 0, D) {
      return t.debounce(_, (k, R) => (k ? (k.push(R), k) : [R]), L, void 0, !0, void 0, D)
    }
    t.accumulate = f
    function w(_, L = (k, R) => k === R, D) {
      let k = !0,
        R
      return a(
        _,
    ...
    t.latch = w
    function p(_, L, D) {
      return [t.filter(_, L, D), t.filter(_, (k) => !L(k), D)]
    }
    t.split = p
    function x(_, L = !1, D = [], k) {
      let R = D.slice(),
        M = _((U) => {
          R ? R.push(U) : F.fire(U)
        })
      k && k.add(M)
      const W = () => {
          ;(R?.forEach((U) => F.fire(U)), (R = null))
        },
        F = new Ee({
          onWillAddFirstListener() {
            M || ((M = _((U) => F.fire(U))), k && k.add(M))
          },
    ...
    class A {
      ...
      forEach(L) {
        return (this.steps.push((D) => (L(D), D)), this)
      }
      filter(L) {
        return (this.steps.push((D) => (L(D) ? D : y)), this)
      }
      reduce(L, D) {
        let k = D
        return (this.steps.push((R) => ((k = L(k, R)), k)), this)
      }
      latch(L = (D, k) => D === k) {
        let D = !0,
          k
        return (
          this.steps.push((R) => {
            const M = D || !L(R, k)
            return ((D = !1), (k = R), M ? R : y)
          }),
          this
        )
      }
      evaluate(L) {
        for (const D of this.steps) if (((L = D(L)), L === y)) break
        return L
      }
    }
    function I(_, L, D = (k) => k) {
      const k = (...F) => W.fire(D(...F)),
        R = () => _.on(L, k),
        M = () => _.removeListener(L, k),
        W = new Ee({ onWillAddFirstListener: R, onDidRemoveLastListener: M })
      return W.event
    }
    t.fromNodeEventEmitter = I
    function H(_, L, D = (k) => k) {
      const k = (...F) => W.fire(D(...F)),
        R = () => _.addEventListener(L, k),
        M = () => _.removeEventListener(L, k),
        W = new Ee({ onWillAddFirstListener: R, onDidRemoveLastListener: M })
      return W.event
    }
    ...
    function P(_, L) {
      let D
      const k = new Promise((R, M) => {
        const W = n(_)(R, null, L)
        D = () => W.dispose()
      })
      return ((k.cancel = D), k)
    }
    ...
    class v {
      constructor(L, D) {
        ...
        ;((this.emitter = new Ee(k)), D && D.add(this.emitter))
      }
      beginUpdate(L) {
        this._counter++
      }
    ...
    function N(_, L) {
      return new v(_, L).emitter.event
    }
    t.fromObservable = N
    function S(_) {
      return (L, D, k) => {
        ...
        const W = {
          ...
          endUpdate() {
            ;(R--, R === 0 && (_.reportChanges(), M && ((M = !1), L.call(D))))
          },
        ...
        return (k instanceof xt ? k.add(F) : Array.isArray(k) && k.push(F), F)
      }
    }
  ...
  const _t = class _t {
    constructor(e) {
      ;((this.listenerCount = 0),
        ...
        (this.durations = []),
        (this.name = `${e}_${_t._idPool++}`),
        _t.all.add(this))
    }
    start(e) {
      ;((this._stopWatch = new $t()), (this.listenerCount = e))
    }
    stop() {
      if (this._stopWatch) {
  ...
  ;((_t.all = new Set()), (_t._idPool = 0))
  let Cn = _t,
    fo = -1
  const vn = class vn {
    constructor(e, n, i = (vn._idPool++).toString(16).padStart(3, "0")) {
...
`)
  ...
  class Ee {
    constructor(e) {
      ;((this._size = 0),
        ...
        (this._leakageMon = this._options?.leakWarningThreshold
          ? new En(e?.onListenerError ?? qt, this._options?.leakWarningThreshold ?? fo)
          : void 0),
        (this._perfMon = this._options?._profName ? new Cn(this._options._profName) : void 0),
      ...
      return (
        (this._event ??= (e, n, i) => {
          if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
            ...
            console.warn(l)
            const o = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1],
              u = new go(`${l}. HINT: Stack shows most frequent listener (${o[1]}-times)`, o[0])
            return ((this._options?.onListenerError || qt)(u), Xe.None)
          }
          if (this._disposed) return Xe.None
          n && (e = e.bind(n))
          const r = new Dn(e)
          let s
          ;(this._leakageMon &&
            this._size >= Math.ceil(this._leakageMon.threshold * 0.2) &&
            ((r.stack = Rn.create()), (s = this._leakageMon.check(r.stack, this._size + 1))),
            this._listeners
              ? this._listeners instanceof Dn
                ? ((this._deliveryQueue ??= new wo()), (this._listeners = [this._listeners, r]))
          ...
          return (i instanceof xt ? i.add(a) : Array.isArray(i) && i.push(a), a)
        }),
        this._event
      )
    }
    ...
    _deliver(e, n) {
      if (!e) return
      const i = this._options?.onListenerError || qt
      if (!i) {
        e.value(n)
        return
      }
    ...
    fire(e) {
      if (
        ...
        if (this._listeners instanceof Dn) this._deliver(this._listeners, e)
        else {
  ...
  function Pi(t, e) {
    ...
    return (
      ...
      vo && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"),
      n
    )
  }
  function q(t, e, ...n) {
    return Pi(typeof t == "number" ? yo(t, e) : e, n)
  }
  function yo(t, e) {
    const n = _o()?.[t]
    if (typeof n != "string") {
  ...
  const Je = globalThis
  let he
  typeof Je.vscode < "u" && typeof Je.vscode.process < "u"
    ? (he = Je.vscode.process)
    : typeof process < "u" && typeof process?.versions?.node == "string" && (he = process)
  const xo = typeof he?.versions?.electron == "string" && he?.type === "renderer"
  if (typeof he == "object") {
    ;((Mn = he.platform === "win32"),
      (Nn = he.platform === "darwin"),
      (In = he.platform === "linux"),
      In && he.env.SNAP && he.env.SNAP_REVISION,
      he.env.CI || he.env.BUILD_ARTIFACTSTAGINGDIRECTORY || he.env.GITHUB_WORKSPACE,
      (Gt = it),
      (zn = it))
    const t = he.env.VSCODE_NLS_CONFIG
    if (t)
      try {
        const e = JSON.parse(t)
        ;((Gt = e.userLocale),
          (Wi = e.osLocale),
          (zn = e.resolvedLanguage || it),
          (To = e.languagePack?.translationsConfigFile))
      } catch {}
  } else
    typeof navigator == "object" && !xo
      ? ((Ie = navigator.userAgent),
        (Mn = Ie.indexOf("Windows") >= 0),
        (Nn = Ie.indexOf("Macintosh") >= 0),
        (Ie.indexOf("Macintosh") >= 0 || Ie.indexOf("iPad") >= 0 || Ie.indexOf("iPhone") >= 0) &&
          navigator.maxTouchPoints &&
          navigator.maxTouchPoints > 0,
        (In = Ie.indexOf("Linux") >= 0),
        Ie?.indexOf("Mobi") >= 0,
        (zn = Ui() || it),
        (Gt = navigator.language.toLowerCase()),
        (Wi = Gt))
      : console.error("Unable to resolve platform.")
  const kt = Mn,
    ko = Nn,
    Re = Ie,
    So = typeof Je.postMessage == "function" && !Je.importScripts
  ;(() => {
    if (So) {
      const t = []
      ...
      return (n) => {
        const i = ++e
        ;(t.push({ id: i, callback: n }), Je.postMessage({ vscodeScheduleAsyncWork: i }, "*"))
      }
    }
    return (t) => setTimeout(t)
  })()
  const Ao = !!(Re && Re.indexOf("Chrome") >= 0)
  ;(Re && Re.indexOf("Firefox") >= 0,
    !Ao && Re && Re.indexOf("Safari") >= 0,
    Re && Re.indexOf("Edg/") >= 0,
  ...
  class Co {
    constructor(e, n) {
      ;((this.lastCache = void 0),
        ...
        typeof e == "function"
          ? ((this._fn = e), (this._computeKey = Lo))
  ...
  class Hn {
    constructor(e) {
      ;((this.executor = e), (this._state = Qe.Uninitialized))
    }
    get value() {
      if (this._state === Qe.Uninitialized) {
        this._state = Qe.Running
        try {
          this._value = this.executor()
        } catch (e) {
          this._error = e
        } finally {
          this._state = Qe.Completed
        }
      } else if (this._state === Qe.Running)
  ...
  const Ne = class Ne {
    static getInstance(e) {
      return Ne.cache.get(Array.from(e))
    }
    static getLocales() {
  ...
  ;((Ne.ambiguousCharacterData = new Hn(() =>
    JSON.parse(
    ...
    (Ne.cache = new Co({ getCacheKey: JSON.stringify }, (e) => {
      function n(c) {
        const d = new Map()
    ...
    (Ne._locales = new Hn(() =>
      Object.keys(Ne.ambiguousCharacterData.value).filter((e) => !e.startsWith("_"))
    )))
  let St = Ne
  const vt = class vt {
    static getRawData() {
    ...
    static getData() {
      return (
        this._data || (this._data = new Set([...Object.values(vt.getRawData())].flat())),
        this._data
      )
    }
    static isInvisibleCharacter(e) {
      return vt.getData().has(e)
    }
  ...
  class $o {
    ...
    async sendMessage(e, n, i) {
      ...
      return new Promise((s, a) => {
        ;((this._pendingReplies[r] = { resolve: s, reject: a }),
          this._send(new qo(this._workerId, r, e, n, i)))
      })
    }
    listen(e, n, i) {
      let r = null
      const s = new Ee({
        onWillAddFirstListener: () => {
          ;((r = String(++this._lastSentReq)),
            ...
            this._send(new Oo(this._workerId, r, e, n, i)))
        },
        onDidRemoveLastListener: () => {
          ;(this._pendingEmitters.delete(r), this._send(new jo(this._workerId, r)), (r = null))
        },
      })
      return s.event
    }
          ...
          typeof s == "string" &&
            ...
            (Oi(s)
              ...
              : qi(s)
                ...
                : s.charCodeAt(0) === 36 &&
                  (r[s] = async (...a) => (await n?.(), this.sendMessage(e, s, a)))),
          r[s]
        ),
      }
    ...
    _handleRequestMessage(e) {
      ...
      this._handler.handleMessage(e.channel, e.method, e.args).then(
        (r) => {
          this._send(new Bi(this._workerId, n, r, void 0))
        },
        (r) => {
          ;(r.detail instanceof Error && (r.detail = Sn(r.detail)),
            this._send(new Bi(this._workerId, n, void 0, Sn(r))))
        }
      )
    }
    _handleSubscribeEventMessage(e) {
      const n = e.req,
        i = this._handler.handleEvent(
          ...
          this._send(new Vo(this._workerId, n, r))
        })
  ...
  class Go {
    ...
    _handleMessage(e, n, i) {
      if (e === Pn && n === Bo) return this.initialize(i[0])
      const r = e === Pn ? this.requestHandler : this._localChannels.get(e)
  ...
  let Vi = !1
  function Xo(t) {
    if (Vi) throw new Error("WebWorker already initialized!")
    Vi = !0
    const e = new Go(
  ...
  new Hn(() => new Uint8Array(256))
  function ji(t, e) {
    return ((e << 5) - e + t) | 0
  }
  function Jo(t, e) {
    e = ji(149417, e)
    for (let n = 0, i = t.length; n < i; n++) e = ji(t.charCodeAt(n), e)
    return e
  }
  class $i {
    constructor(e) {
  ...
  function Qo(t, e, n) {
    return new Oe(new $i(t), new $i(e)).ComputeDiff(n).changes
  }
  class rt {
    static Assert(e, n) {
  ...
  class Oe {
    constructor(e, n, i = null) {
      ...
      const [r, s, a] = Oe._getElements(e),
        [l, o, u] = Oe._getElements(n)
    ...
    static _getElements(e) {
      ...
      if (Oe._isStringArray(n)) {
        ...
        for (let r = 0, s = n.length; r < s; r++) i[r] = Jo(n[r], 0)
        return [n, i, !0]
      }
    ...
    ElementsAreStrictEqual(e, n) {
      ...
      const i = Oe._getStrictElement(this._originalSequence, e),
        r = Oe._getStrictElement(this._modifiedSequence, n)
      return i === r
    }
    ...
    ComputeDiffRecursive(e, n, i, r, s) {
      ...
      if (e > n || i > r) {
        ...
        return (
          i <= r
            ? (rt.Assert(e === n + 1, "originalStart should only be one more than originalEnd"),
              (d = [new qe(e, 0, i, r - i + 1)]))
            : e <= n
              ? (rt.Assert(i === r + 1, "modifiedStart should only be one more than modifiedEnd"),
                (d = [new qe(e, n - e + 1, i, 0)]))
              : (rt.Assert(e === n + 1, "originalStart should only be one more than originalEnd"),
                rt.Assert(i === r + 1, "modifiedStart should only be one more than modifiedEnd"),
                (d = [])),
          d
    ...
    WALKTRACE(e, n, i, r, s, a, l, o, u, c, d, m, f, w, p, x, T, y) {
      ...
      if (((A = H.getReverseChanges()), y[0])) {
        let S = f[0] + 1,
          _ = x[0] + 1
        if (A !== null && A.length > 0) {
          const L = A[A.length - 1]
          ;((S = Math.max(S, L.getOriginalEnd())), (_ = Math.max(_, L.getModifiedEnd())))
        }
        I = [new qe(S, m - S + 1, _, p - _ + 1)]
      } else {
        ;((H = new Gi()),
          (P = a),
          (b = l),
      ...
      return this.ConcatenateChanges(A, I)
    }
    ComputeRecursionPoint(e, n, i, r, s, a, l) {
      ...
      for (let g = 1; g <= w / 2 + 1; g++) {
        ...
        for (let _ = c; _ <= d; _ += 2) {
          ;(_ === c || (_ < d && x[_ - 1] < x[_ + 1]) ? (o = x[_ + 1]) : (o = x[_ - 1] + 1),
            (u = o - (_ - y) - I))
          const L = o
          ...
          if (
            ((x[_] = o),
            o + u > v + N && ((v = o), (N = u)),
            !b && Math.abs(_ - A) <= g - 1 && o >= T[_])
          )
            return (
              (s[0] = o),
              (a[0] = u),
              L <= T[_] && g <= 1448
                ? this.WALKTRACE(y, c, d, I, A, m, f, H, x, T, o, n, s, u, r, a, b, l)
                : null
            )
        }
        const S = (v - e + (N - i) - g) / 2
        if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(v, S))
          return (
            (l[0] = !0),
            (s[0] = v),
            (a[0] = N),
            S > 0 && g <= 1448
              ? this.WALKTRACE(y, c, d, I, A, m, f, H, x, T, o, n, s, u, r, a, b, l)
              : (e++, i++, [new qe(e, n - e + 1, i, r - i + 1)])
          )
        ;((m = this.ClipDiagonalBound(A - g, g, A, p)),
          (f = this.ClipDiagonalBound(A + g, g, A, p)))
        for (let _ = m; _ <= f; _ += 2) {
          ;(_ === m || (_ < f && T[_ - 1] >= T[_ + 1]) ? (o = T[_ + 1] - 1) : (o = T[_ - 1]),
            (u = o - (_ - A) - H))
          const L = o
          for (; o > e && u > i && this.ElementsAreEqual(o, u); ) (o--, u--)
          if (((T[_] = o), b && Math.abs(_ - y) <= g && o <= x[_]))
            return (
              (s[0] = o),
              (a[0] = u),
              L >= x[_] && g <= 1448
        ...
        if (g <= 1447) {
          ...
          ;((_[0] = y - c + 1),
            st.Copy2(x, c, _, 1, d - c + 1),
            this.m_forwardHistory.push(_),
            (_ = new Int32Array(f - m + 2)),
            (_[0] = A - m + 1),
            st.Copy2(T, m, _, 1, f - m + 1),
            this.m_reverseHistory.push(_))
        }
      }
      return this.WALKTRACE(y, c, d, I, A, m, f, H, x, T, o, n, s, u, r, a, b, l)
    }
    PrettifyChanges(e) {
    ...
    ConcatenateChanges(e, n) {
      ...
      if (this.ChangesOverlap(e[e.length - 1], n[0], i)) {
        ...
        return (
          st.Copy(e, 0, r, 0, e.length - 1),
          (r[e.length - 1] = i[0]),
          st.Copy(n, 1, r, e.length, n.length - 1),
          r
        )
      } else {
        const r = new Array(e.length + n.length)
        return (st.Copy(e, 0, r, 0, e.length), st.Copy(n, 0, r, e.length, n.length), r)
      }
    }
  ...
  let K = class tt {
      ...
      with(e = this.lineNumber, n = this.column) {
        return e === this.lineNumber && n === this.column ? this : new tt(e, n)
      }
      delta(e = 0, n = 0) {
  ...
  class Wn {
    constructor(e) {
      const n = Xi(e)
      ;((this._defaultValue = n), (this._asciiMap = Wn._createAsciiMap(n)), (this._map = new Map()))
    }
  ...
  function el() {
    if (Lt === null) {
      Lt = new Wn(0)
      const t = ` 	<>'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…|`
      for (let n = 0; n < t.length; n++) Lt.set(t.charCodeAt(n), 1)
      const e = ".,;:"
      for (let n = 0; n < e.length; n++) Lt.set(e.charCodeAt(n), 2)
    }
    return Lt
  }
  class Xt {
        ...
        for (; u < o; ) {
          ...
          if (m === 13) {
            ...
            switch (y) {
              ...
              case 34:
              case 96:
                d === y ? (A = 1) : d === 39 || d === 34 || d === 96 ? (A = 0) : (A = 1)
                break
              case 42:
                A = d === 42 ? 1 : 0
                break
            ...
            A === 1 && (r.push(Xt._createLink(i, l, s, c, u)), (T = !0))
          } else if (m === 12) {
            let A
            ;(y === 91 ? ((w = !0), (A = 0)) : (A = i.get(y)), A === 1 ? (T = !0) : (m = 13))
          } else ((m = n.nextState(m, y)), m === 0 && (T = !0))
          ;(T && ((m = 1), (f = !1), (w = !1), (x = !1), (c = u + 1), (d = y)), u++)
        }
        m === 13 && r.push(Xt._createLink(i, l, s, c, o))
      }
      return r
    }
  }
  ...
  yn.INSTANCE = new yn()
  let Bn = yn
  const Ji = Object.freeze(function (t, e) {
  ...
  ;(function (t) {
    function e(n) {
      return n === t.None || n === t.Cancelled || n instanceof Qt
        ? !0
        : !n || typeof n != "object"
          ? !1
    ...
    ;((t.isCancellationToken = e),
      (t.None = Object.freeze({ isCancellationRequested: !1, onCancellationRequested: Ln.None })),
      (t.Cancelled = Object.freeze({ isCancellationRequested: !0, onCancellationRequested: Ji })))
  })(Jt || (Jt = {}))
  class Qt {
    constructor() {
    ...
    get onCancellationRequested() {
      return this._isCancelled
        ? Ji
        : (this._emitter || (this._emitter = new Ee()), this._emitter.event)
    }
    dispose() {
  ...
  class nl {
    ...
    cancel() {
      this._token ? this._token instanceof Qt && this._token.cancel() : (this._token = Jt.Cancelled)
    }
    dispose(e = !1) {
      ;(e && this.cancel(),
        this._parentListener?.dispose(),
        this._token ? this._token instanceof Qt && this._token.dispose() : (this._token = Jt.None))
    }
  }
  class qn {
    constructor() {
  ...
  ;(function () {
    ...
    for (const r of e) {
      ...
      if ((i[a] || ((i[a] = !0), (rl[l] = a), (sl[l.toLowerCase()] = a)), !n[o])) {
        if (((n[o] = !0), !u))
          throw new Error(`String representation missing for key code ${o} around scan code ${l}`)
        ;(Yt.define(o, u), On.define(o, m || u), Vn.define(o, f || m || u))
      }
      c && (il[c] = o)
    }
  })()
  ...
  ;(function (t) {
    ...
    function s(l) {
      return On.strToKeyCode(l) || Vn.strToKeyCode(l)
    }
  ...
  function fl(t, e) {
    if (t === null || typeof t != "object") throw new Yi(e, "Object", t)
  }
  function ie(t, e) {
    if (typeof t != "string") throw new Yi(e, "string", t)
  }
  const Ve = ll === "win32"
  function $(t) {
    return t === ae || t === de
        ...
        if (!(a === u - 1 || l === 1))
          if (l === 2) {
            if (
              r.length < 2 ||
              s !== 2 ||
              r.charCodeAt(r.length - 1) !== Ye ||
              r.charCodeAt(r.length - 2) !== Ye
            ) {
              if (r.length > 2) {
  ...
  const ue = {
      ...
      normalize(t) {
        ...
        let a = n < e ? Kt(t.slice(n), !r, "\\", $) : ""
        if (
          (a.length === 0 && !r && (a = "."),
          a.length > 0 && $(t.charCodeAt(e - 1)) && (a += "\\"),
          !r && i === void 0 && t.includes(":"))
        ) {
          if (a.length >= 2 && He(a.charCodeAt(0)) && a.charCodeAt(1) === ze) return `.\\${a}`
          let l = t.indexOf(":")
      ...
      isAbsolute(t) {
        ...
        return $(n) || (e > 2 && He(n) && t.charCodeAt(1) === ze && $(t.charCodeAt(2)))
      },
      join(...t) {
      ...
      relative(t, e) {
        ...
        if (n.length !== t.length || i.length !== e.length) {
          ...
          const x = w.length,
            ...
            y = x < T ? x : T
          let A
          for (A = 0; A < y && w[A].toLowerCase() === p[A].toLowerCase(); A++);
          return A === 0
            ? i
            : A === y
              ? T > y
      ...
      toNamespacedPath(t) {
        ...
        const e = ue.resolve(t)
        if (e.length <= 2) return t
        if (e.charCodeAt(0) === de) {
          if (e.charCodeAt(1) === de) {
            const n = e.charCodeAt(2)
            if (n !== ml && n !== Ye) return `\\\\?\\UNC\\${e.slice(2)}`
          }
        } else if (He(e.charCodeAt(0)) && e.charCodeAt(1) === ze && e.charCodeAt(2) === de)
          return `\\\\?\\${e}`
        return e
      },
      dirname(t) {
        ...
        if ($(r)) {
          ...
          He(r) && t.charCodeAt(1) === ze && ((n = e > 2 && $(t.charCodeAt(2)) ? 3 : 2), (i = n))
        let s = -1,
          a = !0
        for (let l = e - 1; l >= i; --l)
          if ($(t.charCodeAt(l))) {
      ...
      basename(t, e) {
        ...
        let n = 0,
          ...
          s
        if (
          (t.length >= 2 && He(t.charCodeAt(0)) && t.charCodeAt(1) === ze && (n = 2),
      ...
      extname(t) {
        ...
        let e = 0,
          ...
          s = !0,
          a = 0
        t.length >= 2 && t.charCodeAt(1) === ze && He(t.charCodeAt(0)) && (e = i = 2)
      ...
      parse(t) {
        ...
        } else if (He(r) && t.charCodeAt(1) === ze) {
    ...
    me = {
      resolve(...t) {
        ...
        for (let i = t.length - 1; i >= 0 && !n; i--) {
          const r = t[i]
          ;(ie(r, `paths[${i}]`),
            r.length !== 0 && ((e = `${r}/${e}`), (n = r.charCodeAt(0) === ae)))
        }
        if (!n) {
          const i = gl()
          ;((e = `${i}/${e}`), (n = i.charCodeAt(0) === ae))
        }
        return ((e = Kt(e, !n, "/", $n)), n ? `/${e}` : e.length > 0 ? e : ".")
      },
      normalize(t) {
      ...
      isAbsolute(t) {
        return (ie(t, "path"), t.length > 0 && t.charCodeAt(0) === ae)
      },
      join(...t) {
        if (t.length === 0) return "."
        const e = []
      ...
      relative(t, e) {
        ...
        if (u === l)
          if (a > l) {
            if (e.charCodeAt(s + u) === ae) return e.slice(s + u + 1)
            if (u === 0) return e.slice(s + u)
          } else r > l && (t.charCodeAt(n + u) === ae ? (o = u) : u === 0 && (o = 0))
        let c = ""
        for (u = n + o + 1; u <= i; ++u)
          (u === i || t.charCodeAt(u) === ae) && (c += c.length === 0 ? ".." : "/..")
  ...
  ;((me.win32 = ue.win32 = ue),
    (me.posix = ue.posix = me),
    Ve ? ue.normalize : me.normalize,
    Ve ? ue.resolve : me.resolve,
    Ve ? ue.relative : me.relative,
    Ve ? ue.dirname : me.dirname,
    Ve ? ue.basename : me.basename,
    Ve ? ue.extname : me.extname,
    Ve ? ue.sep : me.sep)
  const bl = /^\w[\w\d+.-]*$/,
    wl = /^\//,
    _l = /^\/\//
  ...
  let Gn = class kn {
    ...
    static parse(e, n = !1) {
      const i = xl.exec(e)
      return i
        ? new lt(i[2] || ee, en(i[4] || ee), en(i[5] || ee), en(i[7] || ee), en(i[9] || ee), n)
        : new lt(ee, ee, ee, ee, ee)
    }
    static file(e) {
      let n = ee
      if ((kt && (e = e.replace(/\\/g, ke)), e[0] === ke && e[1] === ke)) {
        const i = e.indexOf(ke, 2)
        i === -1
          ? ((n = e.substring(2)), (e = ke))
          : ((n = e.substring(2, i)), (e = e.substring(i) || ke))
      }
      return new lt("file", n, e, ee, ee)
    }
    static from(e, n) {
    ...
    static joinPath(e, ...n) {
      ...
      return (
        kt && e.scheme === "file"
          ? (i = kn.file(ue.join(Xn(e, !0), ...n)).path)
          : (i = me.join(e.path, ...n)),
        e.with({ path: i })
      )
    }
  ...
  class lt extends Gn {
    ...
    toString(e = !1) {
      return e
        ? Jn(this, !0)
        : (this._formatted || (this._formatted = Jn(this, !1)), this._formatted)
    }
    toJSON() {
      const e = { $mid: 1 }
      return (
  ...
  function kl(t) {
    ...
    for (let n = 0; n < t.length; n++) {
      const i = t.charCodeAt(n)
      i === 35 || i === 63
        ? (e === void 0 && (e = t.substr(0, n)), (e += er[i]))
        : e !== void 0 && (e += t[n])
    }
    return e !== void 0 ? e : t
  }
  ...
  function nr(t) {
    try {
      ...
      return t.length > 3 ? t.substr(0, 3) + nr(t.substr(3)) : t
    }
  }
  const ir = /(%[0-9A-Za-z][0-9A-Za-z])+/g
  function en(t) {
    return t.match(ir) ? t.replace(ir, (e) => nr(e)) : t
  }
  class ge extends j {
    constructor(e, n, i, r) {
      ;(super(e, n, i, r),
  ...
  let oh =
    ...
    (ce.Comment = new ce("comment")),
    (ce.Imports = new ce("imports")),
    (ce.Region = new ce("region")),
    ce)
  var fr
  ;(function (t) {
  ...
  ;((yt.CtrlCmd = 2048), (yt.Shift = 1024), (yt.Alt = 512), (yt.WinCtrl = 256))
  let ei = yt
  function Rl() {
    return {
      editor: void 0,
      languages: void 0,
      CancellationTokenSource: nl,
      Emitter: Ee,
      KeyCode: Qn,
      KeyMod: ei,
      Position: K,
  ...
  function Pl(t, e, n, i, r) {
    return Hl(t, e, n, i, r) && Ul(t, e, n, i, r)
  }
  class Wl {
    constructor(e, n) {
    ...
    next(e) {
      ...
      do {
        ...
        if (r === this._prevMatchStartIndex && s === this._prevMatchLength) {
          if (s === 0) {
            Po(e, n, this._searchRegex.lastIndex) > 65535
        ...
        if (
          ...
          !this._wordSeparators || Pl(this._wordSeparators, e, n, r, s))
        )
          return i
      } while (i)
      return null
  ...
  function Bl(t = "") {
    let e = "(-?\\d*\\.\\d\\w*)|([^"
    for (const n of Fl) t.indexOf(n) >= 0 || (e += "\\" + n)
  ...
  const ps = new ho()
  ps.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 })
  function ti(t, e, n, i, r) {
    if (((e = fs(e)), r || (r = Vt.first(ps)), n.length > r.maxLen)) {
      let u = t - r.maxLen / 2
      return (u < 0 ? (u = 0) : (i += u), (n = n.substring(u, t + r.maxLen / 2)), ti(t, e, n, i, r))
    }
    const s = Date.now(),
      a = t - 1 - i
    let l = -1,
  ...
  class Ol {
    static computeUnicodeHighlights(e, n, i) {
      ...
      l === "allNonBasicAscii"
        ? (o = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g"))
        : (o = new RegExp(`${Vl(Array.from(l))}`, "g"))
      const u = new Wl(null, o),
        c = []
      let d = !1,
        m,
        f = 0,
      ...
      e: for (let x = r, T = s; x <= T; x++) {
        ...
        do
          if (((m = u.next(y)), m)) {
            ...
            if (I > 0) {
              const v = y.charCodeAt(I - 1)
              Un(v) && I--
            }
            if (H + 1 < A) {
              const v = y.charCodeAt(H - 1)
              Un(v) && H++
            }
            ...
            if (g !== 0) {
              if ((g === 3 ? f++ : g === 2 ? w++ : g === 1 ? p++ : so(), c.length >= 1e3)) {
                d = !0
                break e
              }
      ...
      switch (i.shouldHighlightNonBasicASCII(e, null)) {
        ...
        case 3: {
          const s = e.codePointAt(0),
            ...
            l = St.getLocales().filter(
              (o) => !St.getInstance(new Set([...n.allowedLocales, o])).isAmbiguous(s)
            )
  ...
  function Vl(t, e) {
    return `[${Eo(t.map((i) => String.fromCodePoint(i)).join(""))}]`
  }
  class gs {
    constructor(e) {
      ;((this.options = e),
    ...
    getCandidateCodePoints() {
      ...
      if (this.options.invisibleCharacters)
        for (const n of At.codePoints) bs(String.fromCodePoint(n)) || e.add(n)
        ...
        for (const a of n) {
          ...
          ;((r = r || o),
            !o &&
              ...
              !At.isInvisibleCharacter(l) &&
              (s = !0))
        }
      return !r && s
        ? 0
        : this.options.invisibleCharacters && !bs(e) && At.isInvisibleCharacter(i)
          ? 2
...
` ||
  ...
  const Tt = class Tt {
    ...
    filter(e) {
      return new Tt((n) => this.iterate((i) => (e(i) ? n(i) : !0)))
    }
    map(e) {
      return new Tt((n) => this.iterate((i) => n(e(i))))
    }
    findLast(e) {
      let n
    ...
    findLastMaxBy(e) {
      let n,
        i = !0
      return (this.iterate((r) => ((i || ni.isGreaterThan(e(r, n))) && ((i = !1), (n = r)), !0)), n)
    }
  }
  Tt.empty = new Tt((e) => {})
  let ws = Tt
  ...
  function ct(t, e, n = 0, i = t.length) {
    let r = n,
      s = i
    for (; r < s; ) {
  ...
  function ii(t, e, n = 0, i = t.length) {
    let r = n,
      s = i
    for (; r < s; ) {
      const a = Math.floor((r + s) / 2)
  ...
  const Tn = class Tn {
    ...
    findLastMonotonous(e) {
      ...
      const n = ct(this._array, e, this._findLastMonotonousLastIdx)
  ...
  const _e = class _e {
    ...
    static joinMany(e) {
      ...
      for (let i = 1; i < e.length; i++) n = n.getUnion(new De(e[i].slice()))
      return n.ranges
    }
    static join(e) {
    ...
    constructor(e, n) {
      if (e > n) throw new le(`startLineNumber ${e} cannot be after endLineNumberExclusive ${n}`)
  ...
  _e.compareByStart = Ct((e) => e.startLineNumber, Et)
  let X = _e
  class De {
    constructor(e = []) {
    ...
    addRange(e) {
      if (e.length === 0) return
      const n = ii(this._normalizedRanges, (r) => r.endLineNumberExclusive >= e.startLineNumber),
        i = ct(this._normalizedRanges, (r) => r.startLineNumber <= e.endLineNumberExclusive) + 1
    ...
    contains(e) {
      const n = ut(this._normalizedRanges, (i) => i.startLineNumber <= e)
      return !!n && n.endLineNumberExclusive > e
    }
    intersects(e) {
      const n = ut(this._normalizedRanges, (i) => i.startLineNumber < e.endLineNumberExclusive)
    ...
    getUnion(e) {
      ...
      return (s !== null && n.push(s), new De(n))
    }
    subtractFrom(e) {
      const n = ii(this._normalizedRanges, (a) => a.endLineNumberExclusive >= e.startLineNumber),
        i = ct(this._normalizedRanges, (a) => a.startLineNumber <= e.endLineNumberExclusive) + 1
      if (n === i) return new De([e])
      const r = []
      ...
      return (s < e.endLineNumberExclusive && r.push(new X(s, e.endLineNumberExclusive)), new De(r))
    }
    toString() {
  ...
  const Le = class Le {
    static betweenPositions(e, n) {
      return e.lineNumber === n.lineNumber
        ? new Le(0, n.column - e.column)
        : new Le(n.lineNumber - e.lineNumber, n.column - 1)
    }
    static fromPosition(e) {
      return new Le(e.lineNumber - 1, e.column - 1)
    }
    static ofRange(e) {
      return Le.betweenPositions(e.getStartPosition(), e.getEndPosition())
    }
    static ofText(e) {
      let n = 0,
        i = 0
...
`
    ...
    add(e) {
      return e.lineCount === 0
        ? new Le(this.lineCount, this.columnCount + e.columnCount)
        : new Le(this.lineCount + e.lineCount, e.columnCount)
    }
    createRange(e) {
  ...
  class Kl {
    ...
    getStringReplacement(e) {
      return new ht.deps.StringReplacement(this.getOffsetRange(e.range), e.text)
    }
    getTextReplacement(e) {
      return new ht.deps.TextReplacement(this.getRange(e.replaceRange), e.newText)
    }
    getTextEdit(e) {
      const n = e.replacements.map((i) => this.getTextReplacement(i))
      return new ht.deps.TextEdit(n)
    }
  }
  const Ni = class Ni {
    static get deps() {
...
` &&
    ...
    getPosition(e) {
      const n = ct(this.lineStartOffsetByLineIdx, (s) => s <= e),
        i = n + 1,
    ...
    get textLength() {
      ...
      return new ht.deps.TextLength(e, this.text.length - this.lineStartOffsetByLineIdx[e])
    }
    getLineLength(e) {
  ...
  class tu {
    ...
    getTransformer() {
      return (this._transformer || (this._transformer = new eu(this.getValue())), this._transformer)
    }
    getLineAt(e) {
  ...
  class nu extends tu {
    constructor(e, n) {
      ;(ao(n >= 1), super(), (this._getLineContent = e), (this._lineCount = n))
    }
    getValueOfRange(e) {
...
` + this._getLineContent(e.endLineNumber).substring(0, e.endColumn - 1)),
    ...
    get length() {
      ...
      return new Rt(this._lineCount - 1, e.length)
    }
  }
  class rn extends nu {
    constructor(e) {
  ...
  class je {
    static joinReplacements(e, n) {
      ...
      return new je(j.fromPositions(i, r), s)
    }
    static fromStringReplacement(e, n) {
      return new je(n.getTransformer().getRange(e.replaceRange), e.newText)
    }
    static delete(e) {
      return new je(e, "")
    }
...
`
        ...
        r = Io(n, i),
        s = Rt.ofText(n.substring(0, r)).addToPosition(this.range.getStartPosition()),
        a = i.substring(r),
...
`
        ...
        r = zo(n, i),
        s = Rt.ofText(n.substring(0, n.length - r)).addToPosition(this.range.getStartPosition()),
  ...
  class ve {
    ...
    toRangeMapping2(e, n) {
      if (
        _s(this.original.endLineNumberExclusive, e) &&
        _s(this.modified.endLineNumberExclusive, n)
      )
        return new ye(
          new j(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1),
          new j(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1)
      ...
      if (!this.original.isEmpty && !this.modified.isEmpty)
        return new ye(
          j.fromPositions(
            ...
            dt(new K(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)
          ),
          j.fromPositions(
            new K(this.modified.startLineNumber, 1),
            dt(new K(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)
          )
        )
      if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
        return new ye(
          j.fromPositions(
            dt(new K(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), e),
            dt(new K(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)
          ),
          j.fromPositions(
            dt(new K(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n),
            dt(new K(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)
          )
        )
      throw new le()
  ...
  class ye {
    ...
    toTextEdit(e) {
      ...
      return new je(this.originalRange, n)
    }
  }
  ...
  class su {
    computeDiff(e, n, i) {
      ...
      for (const o of s.changes) {
        let u
        o.originalEndLineNumber === 0
          ? (u = new X(o.originalStartLineNumber + 1, o.originalStartLineNumber + 1))
          : (u = new X(o.originalStartLineNumber, o.originalEndLineNumber + 1))
        let c
        o.modifiedEndLineNumber === 0
          ? (c = new X(o.modifiedStartLineNumber + 1, o.modifiedStartLineNumber + 1))
          : (c = new X(o.modifiedStartLineNumber, o.modifiedEndLineNumber + 1))
        let d = new Ue(
          u,
          c,
          o.charChanges?.map(
        ...
        ;(l &&
          (l.modified.endLineNumberExclusive === d.modified.startLineNumber ||
            l.original.endLineNumberExclusive === d.original.startLineNumber) &&
          ((d = new Ue(
      ...
      return (
        Ot(() =>
          zi(
            a,
            (o, u) =>
              u.original.startLineNumber - o.original.endLineNumberExclusive ===
                u.modified.startLineNumber - o.modified.endLineNumberExclusive &&
              o.original.endLineNumberExclusive < u.original.startLineNumber &&
              o.modified.endLineNumberExclusive < u.modified.startLineNumber
          )
        ),
        new tn(a, [], s.quitEarly)
      )
    }
  }
  function ys(t, e, n, i) {
    return new Oe(t, e, n).ComputeDiff(i)
  }
  let Ts = class {
    constructor(e) {
      const n = [],
        i = []
      for (let r = 0, s = e.length; r < s; r++) ((n[r] = ri(e[r], 1)), (i[r] = si(e[r], 1)))
    ...
    static createFromDiffResult(e, n, i, r, s, a, l) {
      ...
      if (
        ...
        if (f.getElements().length > 0 && w.getElements().length > 0) {
          let p = ys(f, w, s, !0).changes
          ;(l && (p = ou(p)), (m = []))
          for (let x = 0, T = p.length; x < T; x++) m.push(mt.createFromDiffChange(p[x], f, w))
        }
      }
      return new Dt(o, u, c, d, m)
    }
  }
  class lu {
    constructor(e, n, i) {
      ;((this.shouldComputeCharChanges = i.shouldComputeCharChanges),
        ...
        (this.original = new Ts(e)),
        (this.modified = new Ts(n)),
        (this.continueLineDiff = xs(i.maxComputationTime)),
    ...
    computeDiff() {
      ...
      const e = ys(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff),
        n = e.changes,
        i = e.quitEarly
    ...
    _pushTrimWhitespaceCharChange(e, n, i, r, s, a, l) {
      ...
      let o
      ;(this.shouldComputeCharChanges && (o = [new mt(n, i, n, r, s, a, s, l)]),
        e.push(new Dt(n, n, s, s, o)))
    }
    _mergeTrimWhitespaceCharChange(e, n, i, r, s, a, l) {
      ...
      return u.originalEndLineNumber === 0 || u.modifiedEndLineNumber === 0
        ...
        : u.originalEndLineNumber === n && u.modifiedEndLineNumber === s
          ? (this.shouldComputeCharChanges &&
              u.charChanges &&
              u.charChanges.push(new mt(n, i, n, r, s, a, s, l)),
            !0)
  ...
  class Pe {
    static trivial(e, n) {
      return new Pe([new ne(G.ofLength(e.length), G.ofLength(n.length))], !1)
    }
    static trivialTimedOut(e, n) {
      return new Pe([new ne(G.ofLength(e.length), G.ofLength(n.length))], !0)
    }
    constructor(e, n) {
    ...
    static invert(e, n) {
      ...
      return (
        Xl(e, (r, s) => {
          i.push(
            ne.fromOffsetPairs(
              r ? r.getEndExclusives() : We.zero,
              s
                ? s.getStarts()
                : new We(n, (r ? r.seq2Range.endExclusive - r.seq1Range.endExclusive : 0) + n)
            )
          )
        }),
        i
  ...
  const Ke = class Ke {
    ...
    delta(e) {
      return e === 0 ? this : new Ke(this.offset1 + e, this.offset2 + e)
    }
    equals(e) {
...
`)
  ...
  let sn = Ft
  class cu {
    compute(e, n, i = Mt.instance, r) {
      if (e.length === 0 || n.length === 0) return Pe.trivial(e, n)
      const s = new ai(e.length, n.length),
        a = new ai(e.length, n.length),
        l = new ai(e.length, n.length)
      for (let w = 0; w < e.length; w++)
        for (let p = 0; p < n.length; p++) {
          if (!i.isValid()) return Pe.trivialTimedOut(e, n)
          ...
          e.getElement(w) === n.getElement(p)
            ? (w === 0 || p === 0 ? (y = 0) : (y = s.get(w - 1, p - 1)),
              ...
              (y += r ? r(w, p) : 1))
            : (y = -1)
          const A = Math.max(x, T, y)
          if (A === y) {
            const I = w > 0 && p > 0 ? l.get(w - 1, p - 1) : 0
            ;(l.set(w, p, I + 1), a.set(w, p, 3))
          } else
            A === x ? (l.set(w, p, 0), a.set(w, p, 1)) : A === T && (l.set(w, p, 0), a.set(w, p, 2))
          s.set(w, p, A)
        }
      const o = []
      let u = e.length,
      ...
      return (d(-1, -1), o.reverse(), new Pe(o, !1))
    }
  }
  class ks {
    compute(e, n, i = Mt.instance) {
      if (e.length === 0 || n.length === 0) return Pe.trivial(e, n)
      const r = e,
        s = n
      function a(p, x) {
      ...
      o.set(0, a(0, 0))
      const u = new du()
      u.set(0, o.get(0) === 0 ? null : new Ss(null, 0, 0, o.get(0)))
      let c = 0
      e: for (;;) {
        if ((l++, !i.isValid())) return Pe.trivialTimedOut(r, s)
        const p = -Math.min(l, s.length + (l % 2)),
          x = Math.min(l, r.length + (l % 2))
        for (c = p; c <= x; c += 2) {
          const T = c === x ? -1 : o.get(c + 1),
            y = c === p ? -1 : o.get(c - 1) + 1,
            A = Math.min(Math.max(T, y), r.length),
            I = A - c
          if (A > r.length || I > s.length) continue
          const H = a(A, I)
          o.set(c, H)
          const P = A === T ? u.get(c + 1) : u.get(c - 1)
          if (
            (u.set(c, H !== A ? new Ss(P, A, I, H - A) : P),
  ...
  class an {
    ...
    getBoundaryScore(e) {
      const n = Cs(e > 0 ? this.elements[e - 1] : -1),
        i = Cs(e < this.elements.length ? this.elements[e] : -1)
      if (n === 7 && i === 8) return 0
      if (n === 8) return 150
      let r = 0
      return (n !== i && ((r += 10), n === 0 && i === 1 && (r += 1)), (r += Ls(n)), (r += Ls(i)), r)
    }
    translateOffset(e, n = "right") {
      const i = ct(this.firstElementOffsetByLineIdx, (s) => s <= e),
    ...
    findWordContaining(e) {
      if (e < 0 || e >= this.elements.length || !ft(this.elements[e])) return
      let n = e
      for (; n > 0 && ft(this.elements[n - 1]); ) n--
      let i = e
      for (; i < this.elements.length && ft(this.elements[i]); ) i++
      return new G(n, i)
    }
    findSubWordContaining(e) {
      if (e < 0 || e >= this.elements.length || !ft(this.elements[e])) return
      let n = e
      for (; n > 0 && ft(this.elements[n - 1]) && !As(this.elements[n]); ) n--
      let i = e
      for (; i < this.elements.length && ft(this.elements[i]) && !As(this.elements[i]); ) i++
      return new G(n, i)
    }
    countLinesIn(e) {
      return (
    ...
    extendToFullLines(e) {
      const n = ut(this.firstElementOffsetByLineIdx, (r) => r <= e.start) ?? 0,
        i = Zl(this.firstElementOffsetByLineIdx, (r) => e.endExclusive <= r) ?? this.elements.length
      return new G(n, i)
    }
  }
  function ft(t) {
  ...
  const mu = { 0: 0, 1: 0, 2: 0, 3: 10, 4: 2, 5: 30, 6: 3, 7: 10, 8: 10 }
  function Ls(t) {
    return mu[t]
  }
  function Cs(t) {
  ...
  function fu(t, e, n, i, r, s) {
    let { moves: a, excludedChanges: l } = gu(t, e, n, s)
    if (!s.isValid()) return []
...
`).length >= 15 && pu(d, (f) => f.length >= 2) >= 2
  ...
  function gu(t, e, n, i) {
    const r = [],
      s = t
        ...
        .map((o) => new sn(o.original, e, o)),
      a = new Set(
        t
          .filter((o) => o.original.isEmpty && o.modified.length >= 3)
          .map((o) => new sn(o.modified, n, o))
      ),
      l = new Set()
    for (const o of s) {
      let u = -1,
  ...
  function bu(t, e, n, i, r, s) {
    ...
    const o = []
    t.sort(Ct((m) => m.modified.startLineNumber, Et))
    for (const m of t) {
      let f = []
      for (let w = m.modified.startLineNumber; w < m.modified.endLineNumberExclusive - 2; w++) {
        ...
        ;(l.forEach(p, ({ range: y }) => {
          ...
          const A = { modifiedLineRange: x, originalLineRange: y }
          ;(o.push(A), T.push(A))
        }),
          (f = T))
      }
    ...
    o.sort(Yl(Ct((m) => m.modifiedLineRange.length, Et)))
    const u = new De(),
      c = new De()
    for (const m of o) {
      ...
      for (const T of x.ranges) {
        ...
        const y = T,
          A = T.delta(-f)
        ;(a.push(new ve(A, y)), u.addRange(y), c.addRange(A))
      }
    }
    a.sort(Ct((m) => m.original.startLineNumber, Et))
    const d = new nn(t)
    for (let m = 0; m < a.length; m++) {
      const f = a[m],
        w = d.findLastMonotonous((P) => P.original.startLineNumber <= f.original.startLineNumber),
        p = ut(t, (P) => P.modified.startLineNumber <= f.modified.startLineNumber),
        x = Math.max(
        ...
        y = ut(t, (P) => P.modified.startLineNumber < f.modified.endLineNumberExclusive),
        A = Math.max(
  ...
  function Es(t, e, n) {
    ...
    const r = new ks().compute(
      new an([t], new j(1, 1, 1, t.length), !1),
      new an([e], new j(1, 1, 1, e.length), !1),
      n
    )
    let s = 0
    ...
    function l(c) {
      let d = 0
      for (let m = 0; m < t.length; m++) oi(c.charCodeAt(m)) || d++
      return d
    }
  ...
  function wu(t) {
    ...
    t.sort(Ct((n) => n.original.startLineNumber, Et))
    const e = [t[0]]
    ...
    return (
      (e = e.filter((i) => {
        const r =
          ...
          s = ut(t, (l) => l.modified.startLineNumber < i.modified.endLineNumberExclusive)
        return r !== s
      })),
      e
    )
  ...
  function Rs(t, e, n) {
    let i = n
    return ((i = Ds(t, e, i)), (i = Ds(t, e, i)), (i = vu(t, e, i)), i)
  }
  function Ds(t, e, n) {
  ...
  function vu(t, e, n) {
    ...
    for (let i = 0; i < n.length; i++) {
      ...
      s.seq1Range.isEmpty
        ? (n[i] = Ms(s, t, e, l, o))
        : s.seq2Range.isEmpty && (n[i] = Ms(s.swap(), e, t, o, l).swap())
    }
    return n
  }
      ...
      for (let o = 1; o < i.length; o++) {
        let d = function (f, w) {
          ...
          const y = t.countLinesIn(f.seq1Range),
            ...
            v = w.seq2Range.length,
            N = 130
          function S(_) {
            return Math.min(_, N)
          }
          return (
            Math.pow(Math.pow(S(y * 40 + A), 1.5) + Math.pow(S(I * 40 + H), 1.5), 1.5) +
              Math.pow(Math.pow(S(P * 40 + b), 1.5) + Math.pow(S(g * 40 + v), 1.5), 1.5) >
            (N ** 1.5) ** 1.5 * 1.3
          )
        }
        const u = i[o],
    ...
    return (
      Jl(i, (l, o, u) => {
        ...
        const p = ne.fromOffsetPairs(
            l ? l.getEndExclusives() : We.zero,
            u ? u.getStarts() : We.max
          ),
          x = c.intersect(p)
  ...
  class Is {
    ...
    getBoundaryScore(e) {
      const n = e === 0 ? 0 : zs(this.lines[e - 1]),
        i = e === this.lines.length ? 0 : zs(this.lines[e])
      return 1e3 - (n + i)
    }
    getText(e) {
...
`)
  ...
  class Su {
    constructor() {
      ;((this.dynamicProgrammingDiffing = new cu()), (this.myersDiffingAlgorithm = new ks()))
    }
    computeDiff(e, n, i) {
      if (e.length <= 1 && $l(e, n, (b, g) => b === g)) return new tn([], [], !1)
      if ((e.length === 1 && e[0].length === 0) || (n.length === 1 && n[0].length === 0))
        return new tn(
          [
            new Ue(new X(1, e.length + 1), new X(1, n.length + 1), [
              new ye(
      ...
      const r = i.maxComputationTimeMs === 0 ? Mt.instance : new uu(i.maxComputationTimeMs),
          ...
          if (s)
            for (let g = 0; g < b; g++) {
              const v = T + g,
                N = y + g
              if (e[v] !== n[N]) {
                const S = this.refineDiff(e, n, new ne(new G(v, v + 1), new G(N, N + 1)), r, s, i)
                for (const _ of S.mappings) p.push(_)
                S.hitTimeout && (w = !0)
              }
            }
        }
      let T = 0,
        y = 0
      for (const b of f) {
        Ot(() => b.seq1Range.start - T === b.seq2Range.start - y)
        const g = b.seq1Range.start - T
        ;(x(g), (T = b.seq1Range.endExclusive), (y = b.seq2Range.endExclusive))
        const v = this.refineDiff(e, n, b, r, s, i)
        v.hitTimeout && (w = !0)
        for (const N of v.mappings) p.push(N)
      }
      x(e.length - T)
      const A = new rn(e),
        I = new rn(n),
      ...
      return (
        ...
        Ot(() => {
          function b(v, N) {
            if (v.lineNumber < 1 || v.lineNumber > N.length) return !1
            const S = N[v.lineNumber - 1]
            return !(v.column < 1 || v.column > S.length + 1)
          }
          function g(v, N) {
            return !(
              v.startLineNumber < 1 ||
              v.startLineNumber > N.length + 1 ||
              v.endLineNumberExclusive < 1 ||
              v.endLineNumberExclusive > N.length + 1
            )
          }
          for (const v of H) {
            if (!v.innerChanges) return !1
            for (const N of v.innerChanges)
              if (
                ...
                return !1
            if (!g(v.modified, n) || !g(v.original, e)) return !1
          }
          return !0
        }),
        new tn(H, P, w)
    ...
    computeMoves(e, n, i, r, s, a, l, o) {
      return fu(e, n, i, r, s, a).map((d) => {
        const m = this.refineDiff(
          ...
          f = vs(m.mappings, new rn(n), new rn(i), !0)
        return new jl(d, f)
      })
    }
    refineDiff(e, n, i, r, s, a) {
      const o = Au(i).toRangeMapping2(e, n),
        u = new an(e, o.originalRange, s),
        c = new an(n, o.modifiedRange, s),
        d =
      ...
      return (
        (m = Rs(u, c, m)),
        (m = Ns(u, c, m, (w, p) => w.findWordContaining(p))),
        a.extendToSubwords && (m = Ns(u, c, m, (w, p) => w.findSubWordContaining(p), !0)),
        (m = yu(u, c, m)),
        (m = ku(u, c, m)),
        {
          mappings: m.map(
  ...
  const Hs = { getLegacy: () => new su(), getDefault: () => new Su() }
  function $e(t, e) {
  ...
  class C {
    constructor(e, n, i, r = 1) {
      ;((this._rgbaBrand = void 0),
        ...
        (this.a = $e(Math.max(Math.min(1, r), 0), 3)))
    }
    static equals(e, n) {
  ...
  class Te {
    constructor(e, n, i, r) {
      ;((this._hslaBrand = void 0),
        ...
        (this.s = $e(Math.max(Math.min(1, n), 0), 3)),
        (this.l = $e(Math.max(Math.min(1, i), 0), 3)),
        (this.a = $e(Math.max(Math.min(1, r), 0), 3)))
    }
    static equals(e, n) {
  ...
  class pt {
    constructor(e, n, i, r) {
      ;((this._hsvaBrand = void 0),
        (this.h = Math.max(Math.min(360, e), 0) | 0),
        (this.s = $e(Math.max(Math.min(1, n), 0), 3)),
        (this.v = $e(Math.max(Math.min(1, i), 0), 3)),
        (this.a = $e(Math.max(Math.min(1, r), 0), 3)))
    }
    static equals(e, n) {
        ...
        l === 0
          ...
          : s === n
            ...
            : s === i
              ? (u = (r - n) / l + 2)
              : (u = (n - i) / l + 4),
        new pt(Math.round(u * 60), o, s, e.a)
      )
    }
    static toRGBA(e) {
    ...
    ((Q = class {
      ...
      constructor(e) {
        if (e)
          ...
          else if (e instanceof pt) ((this._hsva = e), (this.rgba = pt.toRGBA(e)))
      ...
      ;(function (n) {
        ...
        function d(p) {
          ...
          if (p.startsWith("rgba(")) {
            ...
            if (!x) throw new Error("Invalid color format " + p)
            const T = parseInt(x.groups?.r ?? "0"),
              y = parseInt(x.groups?.g ?? "0"),
              A = parseInt(x.groups?.b ?? "0"),
              I = parseFloat(x.groups?.a ?? "0")
            return new t(new C(T, y, A, I))
          }
          if (p.startsWith("rgb(")) {
            const x = p.match(/rgb\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+)\)/)
            if (!x) throw new Error("Invalid color format " + p)
            const T = parseInt(x.groups?.r ?? "0"),
              y = parseInt(x.groups?.g ?? "0"),
              A = parseInt(x.groups?.b ?? "0")
            return new t(new C(T, y, A))
          }
          return m(p)
        }
        n.parse = d
        ...
        function f(p) {
          ...
          if (x === 7) {
            const T = 16 * w(p.charCodeAt(1)) + w(p.charCodeAt(2)),
              ...
              A = 16 * w(p.charCodeAt(5)) + w(p.charCodeAt(6))
            return new t(new C(T, y, A, 1))
          }
          if (x === 9) {
            const T = 16 * w(p.charCodeAt(1)) + w(p.charCodeAt(2)),
              y = 16 * w(p.charCodeAt(3)) + w(p.charCodeAt(4)),
            ...
            return new t(new C(T, y, A, I / 255))
          }
          if (x === 4) {
            const T = w(p.charCodeAt(1)),
              y = w(p.charCodeAt(2)),
              A = w(p.charCodeAt(3))
            return new t(new C(16 * T + T, 16 * y + y, 16 * A + A))
          }
          if (x === 5) {
            const T = w(p.charCodeAt(1)),
              y = w(p.charCodeAt(2)),
              A = w(p.charCodeAt(3)),
              I = w(p.charCodeAt(4))
            return new t(new C(16 * T + T, 16 * y + y, 16 * A + A, (16 * I + I) / 255))
          }
          return null
        }
        n.parseHex = f
  ...
  function Lu(t, e) {
    if (!t) return
    const n = on.Format.CSS.parseHex(e)
    if (n) return { range: t, color: li(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a) }
  }
  function Ps(t, e, n) {
    if (!t || e.length !== 1) return
    const r = e[0].values(),
      s = Us(r)
    return { range: t, color: li(s[0], s[1], s[2], n ? s[3] : 1) }
  }
  function Ws(t, e, n) {
    if (!t || e.length !== 1) return
    const r = e[0].values(),
      s = Us(r),
      a = new on(new Te(s[0], s[1] / 100, s[2] / 100, n ? s[3] : 1))
    return { range: t, color: li(a.rgba.r, a.rgba.g, a.rgba.b, a.rgba.a) }
  }
  function It(t, e) {
    ...
    for (let r = 1; r <= i; r++) {
      ...
      if (a) {
        ...
        if (l.endColumn > l.startColumn) {
          const o = { range: l, ...zu(s.substring(a[0].length)), shouldBeInComments: !1 }
  ...
  function Iu(t, e) {
    ...
    const r = zl(e.markSectionHeaderRegex),
      s = new RegExp(e.markSectionHeaderRegex, `gdm${r ? "s" : ""}`)
    if (Ro(s)) return n
    for (let a = 1; a <= i; a += Fs - Du) {
      const l = Math.min(a + Fs - 1, i),
        o = []
...
`) + 1,
  ...
  function zu(t) {
    ...
    return ((t = t.replace(Ru, "")), { text: t, hasSeparatorLine: e })
  }
  class Hu {
    get isRejected() {
  ...
  class Uu {
    ...
    _ensureNoFinalValue() {
      if (this._finalValue)
        throw new le("ProducerConsumer: cannot produce after final value has been set")
    }
  ...
  class Bu {
    ...
    $acceptNewModel(e) {
      this._models[e.url] = new qu(Gn.parse(e.url), e.lines, e.EOL, e.versionId)
    }
  ...
  class qu extends Fu {
    ...
    getWordAtPosition(e, n) {
      const i = ti(e.column, fs(n), this._lines[e.lineNumber - 1], 0)
  ...
  const et = class et {
    constructor(e = null) {
      ;((this._foreignModule = e),
        ...
        (this._workerTextModelSyncServer = new Bu()))
    }
    dispose() {}
    async $ping() {
      return "pong"
    ...
    async $computeUnicodeHighlights(e, n, i) {
      ...
      return r
        ? Ol.computeUnicodeHighlights(r, n, i)
        : {
            ranges: [],
            hasMore: !1,
    ...
    async $computeDiff(e, n, i, r) {
      const s = this._getModel(e),
        a = this._getModel(n)
      return !s || !a ? null : et.computeDiff(s, a, i, r)
    }
    ...
    async $computeMoreMinimalEdits(e, n, i) {
      ...
      for (let { range: o, text: u, eol: c } of n) {
        ...
        if (Math.max(u.length, d.length) > et._diffLimit) {
    ...
    async $navigateValueSet(e, n, i, r, s) {
      ...
      return Bn.INSTANCE.navigateValueSet(n, o, u, c, i)
    }
    $fmr(e, n) {
  ...
  ;((et._diffLimit = 1e5), (et._suggestionsLimit = 1e4))
  let ui = et
  typeof importScripts == "function" && (globalThis.monaco = Rl())
  const Bt = class Bt {
    static getChannel(e) {
      return e.getChannel(Bt.CHANNEL_NAME)
    }
    static setChannel(e, n) {
      e.setChannel(Bt.CHANNEL_NAME, n)
    }
  }
  Bt.CHANNEL_NAME = "editorWorkerHost"
  let ci = Bt
  function Ou(t) {
    let e
    const n = Xo((i) => {
      const r = ci.getChannel(i),
        a = {
          host: new Proxy(
            {},
            {
  ...
  var ju = /{([^}]+)}/g
  function $u(t, e) {
    return Object.keys(e).length === 0 ? t : t.replace(ju, (n, i) => e[i] ?? n)
  }
  var Os
  ;(function (t) {
    function e(n) {
  ...
  ;(function (t) {
    function e(i, r) {
      return (
        i === Number.MAX_VALUE && (i = ln.MAX_VALUE),
        r === Number.MAX_VALUE && (r = ln.MAX_VALUE),
        { line: i, character: r }
      )
    }
    t.create = e
    function n(i) {
      let r = i
      return E.objectLiteral(r) && E.uinteger(r.line) && E.uinteger(r.character)
    }
    t.is = n
  })(se || (se = {}))
  var J
  ;(function (t) {
    function e(i, r, s, a) {
      if (E.uinteger(i) && E.uinteger(r) && E.uinteger(s) && E.uinteger(a))
    ...
    function n(i) {
      let r = i
      return E.objectLiteral(r) && se.is(r.start) && se.is(r.end)
    }
    t.is = n
  })(J || (J = {}))
  var un
  ;(function (t) {
    ...
    function n(i) {
      let r = i
      return E.objectLiteral(r) && J.is(r.range) && (E.string(r.uri) || E.undefined(r.uri))
    }
    t.is = n
  })(un || (un = {}))
  var js
  ;(function (t) {
    ...
    function n(i) {
      ...
      return (
        E.objectLiteral(r) &&
        J.is(r.targetRange) &&
        E.string(r.targetUri) &&
        J.is(r.targetSelectionRange) &&
        (J.is(r.originSelectionRange) || E.undefined(r.originSelectionRange))
      )
    }
    t.is = n
  })(js || (js = {}))
  ...
  ;(function (t) {
    ...
    function n(i) {
      ...
      return (
        E.objectLiteral(r) &&
        E.numberRange(r.red, 0, 1) &&
        E.numberRange(r.green, 0, 1) &&
        E.numberRange(r.blue, 0, 1) &&
        E.numberRange(r.alpha, 0, 1)
      )
    }
    t.is = n
  })(di || (di = {}))
  ...
  ;(function (t) {
    ...
    function n(i) {
      const r = i
      return E.objectLiteral(r) && J.is(r.range) && di.is(r.color)
    }
    t.is = n
  })($s || ($s = {}))
  var Gs
  ;(function (t) {
    ...
    function n(i) {
      ...
      return (
        E.objectLiteral(r) &&
        E.string(r.label) &&
        (E.undefined(r.textEdit) || oe.is(r)) &&
        (E.undefined(r.additionalTextEdits) || E.typedArray(r.additionalTextEdits, oe.is))
      )
    }
    t.is = n
  })(Gs || (Gs = {}))
  ...
  ;(function (t) {
    function e(i, r, s, a, l, o) {
      ...
      return (
        E.defined(s) && (u.startCharacter = s),
        E.defined(a) && (u.endCharacter = a),
        E.defined(l) && (u.kind = l),
        E.defined(o) && (u.collapsedText = o),
        u
      )
    }
    t.create = e
    function n(i) {
      ...
      return (
        E.objectLiteral(r) &&
        E.uinteger(r.startLine) &&
        E.uinteger(r.startLine) &&
        (E.undefined(r.startCharacter) || E.uinteger(r.startCharacter)) &&
        (E.undefined(r.endCharacter) || E.uinteger(r.endCharacter)) &&
        (E.undefined(r.kind) || E.string(r.kind))
      )
    }
    t.is = n
  })(Xs || (Xs = {}))
  ...
  ;(function (t) {
    ...
    function n(i) {
      let r = i
      return E.defined(r) && un.is(r.location) && E.string(r.message)
    }
    t.is = n
  })(mi || (mi = {}))
  var Js
  ...
  ;(function (t) {
    function e(n) {
      const i = n
      return E.objectLiteral(i) && E.string(i.href)
    }
    t.is = e
  })(Ys || (Ys = {}))
  var hn
  ;(function (t) {
    function e(i, r, s, a, l, o) {
      ...
      return (
        E.defined(s) && (u.severity = s),
        E.defined(a) && (u.code = a),
        E.defined(l) && (u.source = l),
        E.defined(o) && (u.relatedInformation = o),
        u
      )
    }
    t.create = e
    function n(i) {
      ...
      return (
        ...
        (E.undefined(s.codeDescription) ||
          E.string((r = s.codeDescription) === null || r === void 0 ? void 0 : r.href)) &&
        (E.string(s.source) || E.undefined(s.source)) &&
        (E.undefined(s.relatedInformation) || E.typedArray(s.relatedInformation, mi.is))
      )
    }
    t.is = n
  })(hn || (hn = {}))
  ...
  ;(function (t) {
    ...
    function n(i) {
      let r = i
      return E.defined(r) && E.string(r.title) && E.string(r.command)
    }
    t.is = n
  })(gt || (gt = {}))
  var oe
  ;(function (t) {
    ...
    function r(s) {
      const a = s
      return E.objectLiteral(a) && E.string(a.newText) && J.is(a.range)
    }
    t.is = r
  })(oe || (oe = {}))
  var fi
  ;(function (t) {
    ...
    function n(i) {
      ...
      return (
        E.objectLiteral(r) &&
        E.string(r.label) &&
        (E.boolean(r.needsConfirmation) || r.needsConfirmation === void 0) &&
  ...
  ;(function (t) {
    ...
    function r(s) {
      const a = s
      return oe.is(a) && (fi.is(a.annotationId) || bt.is(a.annotationId))
    }
    t.is = r
  })(Zs || (Zs = {}))
  var pi
  ;(function (t) {
    ...
    function n(i) {
      let r = i
      return E.defined(r) && vi.is(r.textDocument) && Array.isArray(r.edits)
    }
    t.is = n
  })(pi || (pi = {}))
  var gi
  ;(function (t) {
    ...
    function n(i) {
      ...
      return (
        ...
        E.string(r.uri) &&
        (r.options === void 0 ||
          ((r.options.overwrite === void 0 || E.boolean(r.options.overwrite)) &&
            (r.options.ignoreIfExists === void 0 || E.boolean(r.options.ignoreIfExists)))) &&
        (r.annotationId === void 0 || bt.is(r.annotationId))
      )
    }
    t.is = n
  })(gi || (gi = {}))
  ...
  ;(function (t) {
    ...
    function n(i) {
      ...
      return (
        ...
        E.string(r.uri) &&
        (r.options === void 0 ||
          ((r.options.recursive === void 0 || E.boolean(r.options.recursive)) &&
            (r.options.ignoreIfNotExists === void 0 || E.boolean(r.options.ignoreIfNotExists)))) &&
        (r.annotationId === void 0 || bt.is(r.annotationId))
      )
    }
    t.is = n
      ...
      return (
        ...
        (i.documentChanges === void 0 ||
          i.documentChanges.every((r) =>
            E.string(r.kind) ? gi.is(r) || bi.is(r) || wi.is(r) : pi.is(r)
          ))
      )
    }
    t.is = e
  ...
  ;(function (t) {
    ...
    function n(i) {
      let r = i
      return E.defined(r) && E.string(r.uri)
    }
    t.is = n
  })(Ks || (Ks = {}))
  var ea
  ;(function (t) {
    ...
    function n(i) {
      let r = i
      return E.defined(r) && E.string(r.uri) && E.integer(r.version)
    }
    t.is = n
  })(ea || (ea = {}))
  var vi
  ;(function (t) {
    ...
    function n(i) {
      let r = i
      return E.defined(r) && E.string(r.uri) && (r.version === null || E.integer(r.version))
    }
    t.is = n
  })(vi || (vi = {}))
  var ta
  ...
  ;(function (t) {
    function e(n) {
      const i = n
      return E.objectLiteral(n) && Fe.is(i.kind) && E.string(i.value)
    }
    t.is = e
  })(zt || (zt = {}))
  var fe
  ...
  ;(function (t) {
    ...
    function n(i) {
      const r = i
      return r && E.string(r.newText) && J.is(r.insert) && J.is(r.replace)
    }
    t.is = n
  })(ia || (ia = {}))
  var ra
  ...
  ;(function (t) {
    function e(n) {
      ...
      return (
        i &&
        (E.string(i.detail) || i.detail === void 0) &&
  ...
  ;(function (t) {
    ...
    function n(i) {
      const r = i
      return E.string(r) || (E.objectLiteral(r) && E.string(r.language) && E.string(r.value))
    }
    t.is = n
  })(dn || (dn = {}))
  var la
  ;(function (t) {
    function e(n) {
      ...
      return (
        !!i &&
        E.objectLiteral(i) &&
        (zt.is(i.contents) || dn.is(i.contents) || E.typedArray(i.contents, dn.is)) &&
  ...
  ;(function (t) {
    function e(n, i, ...r) {
      let s = { label: n }
      return (
        E.defined(i) && (s.documentation = i),
        E.defined(r) ? (s.parameters = r) : (s.parameters = []),
        s
      )
    }
    t.create = e
  ...
  ;(function (t) {
    ...
    function n(i) {
      ...
      return (
        ...
        (r.detail === void 0 || E.string(r.detail)) &&
        (r.deprecated === void 0 || E.boolean(r.deprecated)) &&
  ...
  ;(function (t) {
    ...
    function n(i) {
      ...
      return (
        E.defined(r) &&
        E.typedArray(r.diagnostics, hn.is) &&
        (r.only === void 0 || E.typedArray(r.only, E.string)) &&
        (r.triggerKind === void 0 || r.triggerKind === fn.Invoked || r.triggerKind === fn.Automatic)
      )
    }
    t.is = n
  })(pa || (pa = {}))
  ...
  ;(function (t) {
    function e(i, r, s) {
      let a = { title: i },
        l = !0
      return (
        typeof r == "string" ? ((l = !1), (a.kind = r)) : gt.is(r) ? (a.command = r) : (a.edit = r),
        l && s !== void 0 && (a.kind = s),
        a
      )
    }
    ...
    function n(i) {
      ...
      return (
        r &&
        E.string(r.title) &&
        (r.diagnostics === void 0 || E.typedArray(r.diagnostics, hn.is)) &&
        (r.kind === void 0 || E.string(r.kind)) &&
        (r.edit !== void 0 || r.command !== void 0) &&
        (r.command === void 0 || gt.is(r.command)) &&
        (r.isPreferred === void 0 || E.boolean(r.isPreferred)) &&
        (r.edit === void 0 || _i.is(r.edit))
      )
    }
    t.is = n
  })(ga || (ga = {}))
  ...
  ;(function (t) {
    function e(i, r) {
      let s = { range: i }
      return (E.defined(r) && (s.data = r), s)
    }
    t.create = e
    function n(i) {
      let r = i
      return E.defined(r) && J.is(r.range) && (E.undefined(r.command) || gt.is(r.command))
    }
    t.is = n
  })(ba || (ba = {}))
  var wa
  ;(function (t) {
    ...
    function n(i) {
      let r = i
      return E.defined(r) && E.uinteger(r.tabSize) && E.boolean(r.insertSpaces)
    }
    t.is = n
  })(wa || (wa = {}))
  var _a
  ;(function (t) {
    ...
    function n(i) {
      let r = i
      return E.defined(r) && J.is(r.range) && (E.undefined(r.target) || E.string(r.target))
    }
    t.is = n
  })(_a || (_a = {}))
  var pn
  ;(function (t) {
    ...
    function n(i) {
      let r = i
      return E.objectLiteral(r) && J.is(r.range) && (r.parent === void 0 || t.is(r.parent))
    }
    t.is = n
  })(pn || (pn = {}))
  var va
  ...
  ;(function (t) {
    ...
    function n(i) {
      const r = i
      return r != null && J.is(r.range) && E.string(r.text)
    }
    t.is = n
  })(xa || (xa = {}))
  var ka
  ;(function (t) {
    ...
    function n(i) {
      ...
      return (
        r != null &&
        J.is(r.range) &&
        E.boolean(r.caseSensitiveLookup) &&
        (E.string(r.variableName) || r.variableName === void 0)
      )
    }
    t.is = n
  })(ka || (ka = {}))
  ...
  ;(function (t) {
    ...
    function n(i) {
      const r = i
      return r != null && J.is(r.range) && (E.string(r.expression) || r.expression === void 0)
    }
    t.is = n
  })(Sa || (Sa = {}))
  var Aa
  ;(function (t) {
    ...
    function n(i) {
      const r = i
      return E.defined(r) && J.is(i.stoppedLocation)
    }
    t.is = n
  })(Aa || (Aa = {}))
  var ki
  ...
  ;(function (t) {
    ...
    function n(i) {
      ...
      return (
        E.objectLiteral(r) &&
        (r.tooltip === void 0 || E.string(r.tooltip) || zt.is(r.tooltip)) &&
        (r.location === void 0 || un.is(r.location)) &&
        (r.command === void 0 || gt.is(r.command))
      )
    }
    t.is = n
  ...
  ;(function (t) {
    ...
    function n(i) {
      ...
      return (
        (E.objectLiteral(r) &&
          se.is(r.position) &&
          (E.string(r.label) || E.typedArray(r.label, Si.is)) &&
          (r.kind === void 0 || ki.is(r.kind)) &&
          r.textEdits === void 0) ||
        (E.typedArray(r.textEdits, oe.is) &&
          (r.tooltip === void 0 || E.string(r.tooltip) || zt.is(r.tooltip)) &&
          (r.paddingLeft === void 0 || E.boolean(r.paddingLeft)) &&
          (r.paddingRight === void 0 || E.boolean(r.paddingRight)))
      )
    }
    t.is = n
  })(La || (La = {}))
  ...
  ;(function (t) {
    function e(n) {
      const i = n
      return E.objectLiteral(i) && hi.is(i.uri) && E.string(i.name)
    }
    t.is = e
  })(Ia || (Ia = {}))
  var za
...
` &&
  ...
  class Ht {
    ...
    update(e, n) {
      for (let i of e)
        ...
        } else if (Ht.isFull(i)) ((this._content = i.text), (this._lineOffsets = void 0))
        else throw new Error("Unknown change event received")
      this._version = n
    }
    getLineOffsets() {
      return (
        this._lineOffsets === void 0 && (this._lineOffsets = Ha(this._content, !0)),
        this._lineOffsets
      )
    }
    positionAt(e) {
  ...
  ;(function (t) {
    function e(r, s, a, l) {
      return new Ht(r, s, a, l)
    }
    t.create = e
    function n(r, s, a) {
      if (r instanceof Ht) return (r.update(s, a), r)
  ...
  ;(function (t) {
    t.LATEST = {
      textDocument: {
        completion: { completionItem: { documentationFormat: [Fe.Markdown, Fe.PlainText] } },
        hover: { contentFormat: [Fe.Markdown, Fe.PlainText] },
      },
    }
  })(Pa || (Pa = {}))
  var Ci
  ...
  class Ju {
    ...
    skipWhitespace() {
      return (
        this.advanceWhileChar((n) => n === nc || n === ic || n === Ku || n === tc || n === ec) > 0
      )
    }
    advanceWhileChar(e) {
  ...
  const Wa = 33,
    ...
    nc = 32,
    ic = 9,
    rc = { "text/x-handlebars-template": !0, "text/html": !0 }
  function be(t, e = 0, n = V.WithinContent, i = !1) {
    ...
    function x() {
      ...
      return I !== z.EOS && y === r.pos() && !(i && (I === z.StartTagClose || I === z.EndTagClose))
        ? (console.warn(
            "Scanner.scan has not advanced at offset " + y + ", state before: " + A + " after: " + s
          ),
          r.advance(1),
          p(y, z.Unknown))
        : I
    ...
    function T() {
      ...
      switch (s) {
        case V.WithinComment:
          return r.advanceIfChars([wt, wt, Me])
            ? ((s = V.WithinContent), p(y, z.EndCommentTag))
            : (r.advanceUntilChars([wt, wt, Me]), p(y, z.Comment))
        case V.WithinDoctype:
          return r.advanceIfChar(Me)
            ? ((s = V.WithinContent), p(y, z.EndDoctypeTag))
            : (r.advanceUntilChar(Me), p(y, z.Doctype))
        case V.WithinContent:
          if (r.advanceIfChar(gn)) {
            if (!r.eos() && r.peekChar() === Wa) {
              if (r.advanceIfChars([Wa, wt, wt]))
            ...
            return r.advanceIfChar(Ei)
              ? ((s = V.AfterOpeningEndTag), p(y, z.EndTagOpen))
              : ((s = V.AfterOpeningStartTag), p(y, z.StartTagOpen))
          }
          return (r.advanceUntilChar(gn), p(y, z.Content))
        case V.AfterOpeningEndTag:
          return f().length > 0
            ? ((s = V.WithinEndTag), p(y, z.EndTag))
            : r.skipWhitespace()
              ? p(y, z.Whitespace, Se("Tag name must directly follow the open bracket."))
              : ((s = V.WithinEndTag),
                r.advanceUntilChar(Me),
                y < r.pos() ? p(y, z.Unknown, Se("End tag name expected.")) : T())
        case V.WithinEndTag:
          if (r.skipWhitespace()) return p(y, z.Whitespace)
          if (r.advanceIfChar(Me)) return ((s = V.WithinContent), p(y, z.EndTagClose))
          if (i && r.peekChar() === gn)
            return ((s = V.WithinContent), p(y, z.EndTagClose, Se("Closing bracket missing.")))
          A = Se("Closing bracket expected.")
          break
          ...
          return (
            ...
            c.length > 0
              ...
              : r.skipWhitespace()
                ...
                : ((s = V.WithinTag),
                  r.advanceUntilChar(Me),
                  y < r.pos() ? p(y, z.Unknown, Se("Start tag name expected.")) : T())
          )
        case V.WithinTag:
              ...
              : r.advanceIfChars([Ei, Me])
                ...
                : r.advanceIfChar(Me)
                  ? (c === "script"
                    ...
                    p(y, z.StartTagClose))
                  : i && r.peekChar() === gn
                    ? ((s = V.WithinContent), p(y, z.StartTagClose, Se("Closing bracket missing.")))
                    : (r.advance(1), p(y, z.Unknown, Se("Unexpected character in tag.")))
      ...
      return (r.advance(1), (s = V.WithinContent), p(y, z.Unknown, A))
    }
    return {
      scan: x,
      getTokenType: () => l,
  ...
  class Ba {
    ...
    findNodeBefore(e) {
      const n = Fa(this.children, (i) => e <= i.start) - 1
      if (n >= 0) {
  ...
  class ac {
    ...
    parse(e, n) {
      ...
      for (; u !== z.EOS; ) {
        switch (u) {
          case z.StartTagOpen:
            const c = new Ba(i.getTokenOffset(), e.length, [], s)
...
`,
  ...
  function Pt(t, e) {
    ...
    return (lc <= n && n <= uc) || (cc <= n && n <= hc) || (dc <= n && n <= mc)
  }
  function bn(t) {
    return typeof t < "u"
  }
...
`))),
  ...
  class pc {
    ...
    async computeCompletions(e, n) {
      ...
      for (const r of this.atributeCompletions) {
        const s = bc(e.getText(r.range))
        if (wc(s))
          if (s === "." || s === "..") i.isIncomplete = !0
          else {
            const a = _c(r.value, s, r.range),
    ...
    async providePathSuggestions(e, n, i, r) {
      ...
      if (a)
        try {
          ...
          for (const [u, c] of o) u.charCodeAt(0) !== gc && l.push(vc(u, c === Ci.Directory, n))
          return l
        } catch {}
      return []
    }
  ...
  const gc = 46
  function bc(t) {
    return Ge(t, "'") || Ge(t, '"') ? t.slice(1, -1) : t
  }
  function wc(t) {
    return !(Ge(t, "http") || Ge(t, "https") || Ge(t, "//"))
  }
  function _c(t, e, n) {
    let i
    ...
    if (r === -1) i = yc(n, 1, -1)
      ...
      const s = e.slice(r + 1),
        a = Wt(n.end, -1 - s.length),
        l = s.indexOf(" ")
      let o
      ;(l !== -1 ? (o = Wt(a, l)) : (o = Wt(n.end, -1)), (i = J.create(a, o)))
    }
    return i
  }
  function vc(t, e, n) {
  ...
  class Tc {
    ...
    async doComplete2(e, n, i, r, s) {
      ...
      const a = new pc(this.dataManager, this.lsOptions.fileSystemProvider.readDirectory),
    ...
    _doComplete(e, n, i, r) {
      ...
      let w = "",
        p
      function x(k, R = d) {
        return (k > d && (k = d), { start: e.positionAt(k), end: e.positionAt(R) })
      }
      function T(k, R) {
        const M = x(k, R)
        return (
          l.forEach((W) => {
            W.provideTags().forEach((F) => {
              s.items.push({
                label: F.name,
                kind: fe.Property,
                documentation: Ze(F, void 0, u),
                textEdit: oe.replace(M, F.name),
                insertTextFormat: Ae.PlainText,
              })
            })
          }),
          s
...
\r`.indexOf(M) >= 0
      ...
      function A(k, R, M = d) {
        const W = x(k, M),
          F = Va(c, M, V.WithinEndTag, z.EndTagClose) ? "" : ">"
        let U = m
        for (R && (U = U.parent); U; ) {
          const O = U.tag
          if (O && (!U.closed || (U.endTagStart && U.endTagStart > d))) {
            const Y = {
                ...
                kind: fe.Property,
                filterText: "/" + O,
                textEdit: oe.replace(W, "/" + O + F),
                insertTextFormat: Ae.PlainText,
              },
              Z = y(U.start),
              xe = y(k - 1)
            if (Z !== null && xe !== null && Z !== xe) {
              const Ce = Z + "</" + O + F
              ;((Y.textEdit = oe.replace(x(k - 1 - xe.length), Ce)), (Y.filterText = xe + "</" + O))
            }
            return (s.items.push(Y), s)
          }
          U = U.parent
        }
        return (
          R ||
            l.forEach((O) => {
              O.provideTags().forEach((Y) => {
                s.items.push({
                  label: "/" + Y.name,
                  kind: fe.Property,
                  documentation: Ze(Y, void 0, u),
                  filterText: "/" + Y.name + F,
                  textEdit: oe.replace(W, "/" + Y.name + F),
                  insertTextFormat: Ae.PlainText,
                })
              })
            }),
      ...
      const I = (k, R) => {
        ...
        if (!this.dataManager.isVoidElement(R, o)) {
          const M = e.positionAt(k)
          s.items.push({
            label: "</" + R + ">",
            kind: fe.Property,
            filterText: "</" + R + ">",
            textEdit: oe.insert(M, "$0</" + R + ">"),
      ...
      function H(k, R) {
        return (T(k, R), A(k, !0, R), s)
      }
      function P() {
        const k = Object.create(null)
        return (
          m.attributeNames.forEach((R) => {
            k[R] = !0
          }),
          k
        )
      ...
      function b(k, R = d) {
        let M = d
        for (; M < R && c[M] !== "<"; ) M++
        const W = c.substring(k, R),
          F = x(k, M)
        let U = ""
        if (!Va(c, R, V.AfterAttributeName, z.DelimiterAssign)) {
          const Y = r?.attributeDefaultValue ?? "doublequotes"
          Y === "empty" ? (U = "=$1") : Y === "singlequotes" ? (U = "='$1'") : (U = '="$1"')
        }
        const O = P()
        return (
          (O[W] = !1),
          l.forEach((Y) => {
            Y.provideAttributes(w).forEach((Z) => {
              if (O[Z.name]) return
              O[Z.name] = !0
              let xe = Z.name,
                Ce
              ;(Z.valueSet !== "v" &&
                U.length &&
                ((xe = xe + U),
                (Z.valueSet || Z.name === "style") &&
                  (Ce = { title: "Suggest", command: "editor.action.triggerSuggest" })),
                s.items.push({
                  label: Z.name,
                  kind: Z.valueSet === "handler" ? fe.Function : fe.Value,
                  documentation: Ze(Z, void 0, u),
                  textEdit: oe.replace(F, xe),
                  insertTextFormat: Ae.Snippet,
                  command: Ce,
                }))
            })
      ...
      function v(k, R = d) {
        ...
        if (d > k && d <= R && xc(c[k])) {
          ...
          const Y = kc(c, d, U),
            Z = Sc(c, d, O)
          ;((M = x(Y, Z)), (F = d >= U && d <= O ? c.substring(U, d) : ""), (W = !1))
        } else ((M = x(k, R)), (F = c.substring(k, d)), (W = !0))
        if (a.length > 0) {
          const U = w.toLowerCase(),
            O = p.toLowerCase(),
            Y = x(k, R)
          for (const Z of a)
            Z.onHtmlAttributeValue &&
              Z.onHtmlAttributeValue({
                document: e,
                position: n,
                tag: U,
        ...
        return (
          l.forEach((U) => {
            U.provideValues(w, p).forEach((O) => {
              const Y = W ? '"' + O.name + '"' : O.name
              s.items.push({
                label: O.name,
                filterText: Y,
                kind: fe.Unit,
                documentation: Ze(O, void 0, u),
                textEdit: oe.replace(M, Y),
                insertTextFormat: Ae.PlainText,
              })
            })
          }),
      ...
      function _() {
        ...
        for (; k >= 0 && Pt(c, k); ) (k--, R--)
        if (k >= 0 && c[k] === "&") {
          const M = J.create(se.create(n.line, R - 1), n)
          for (const W in Ut)
            if (oc(W, ";")) {
              const F = "&" + W
              s.items.push({
                label: F,
                kind: fe.Keyword,
                documentation: Se("Character entity representing '{0}'", Ut[W]),
                textEdit: oe.replace(M, F),
                insertTextFormat: Ae.PlainText,
              })
            }
        }
      ...
      function L(k, R) {
        ...
        s.items.push({
          ...
          textEdit: oe.replace(M, "!DOCTYPE html>"),
          insertTextFormat: Ae.PlainText,
        })
      }
      let D = f.scan()
      for (; D !== z.EOS && f.getTokenOffset() <= d; ) {
        switch (D) {
          ...
          case z.AttributeValue:
            if (f.getTokenOffset() <= d && d <= f.getTokenEnd())
              return v(f.getTokenOffset(), f.getTokenEnd())
            break
          case z.Whitespace:
            if (d <= f.getTokenEnd())
              switch (f.getScannerState()) {
                ...
                case V.BeforeAttributeValue:
                  return v(f.getTokenEnd())
                case V.AfterOpeningEndTag:
                  return A(f.getTokenOffset() - 1, !1)
                case V.WithinContent:
                  return S()
              }
            break
          ...
          case z.EndTag:
            if (d <= f.getTokenEnd()) {
              ...
              for (; k >= 0; ) {
                const R = c.charAt(k)
                if (R === "/") return A(k, !1, f.getTokenEnd())
                if (!wn(R)) break
                k--
              }
            }
    ...
    doQuoteComplete(e, n, i, r) {
      ...
      if (s <= 0) return null
      const a = r?.attributeDefaultValue ?? "doublequotes"
      ...
      if (!bn(this.supportsMarkdown)) {
        ...
        const e =
          this.lsOptions.clientCapabilities.textDocument?.completion?.completionItem
            ?.documentationFormat
        this.supportsMarkdown = Array.isArray(e) && e.indexOf(Fe.Markdown) !== -1
      }
    ...
    doHover(e, n, i, r) {
      ...
      function d(b, g, v) {
        for (const N of c) {
          let S = null
          if (
            (N.provideTags().forEach((_) => {
              if (_.name.toLowerCase() === b.toLowerCase()) {
                let L = Ze(_, r, a)
                ;(L || (L = { kind: a ? "markdown" : "plaintext", value: "" }),
                  (S = { contents: L, range: g }))
              }
            }),
            S)
          )
      ...
      function m(b, g, v) {
        for (const N of c) {
          let S = null
          if (
            (N.provideAttributes(b).forEach((_) => {
              if (g === _.name && _.description) {
                const L = Ze(_, r, a)
                L ? (S = { contents: L, range: v }) : (S = null)
              }
            }),
            S)
          )
      ...
      function f(b, g, v, N) {
        for (const S of c) {
          let _ = null
          if (
            (S.provideValues(b, g).forEach((L) => {
              if (v === L.name && L.description) {
                const D = Ze(L, r, a)
                D ? (_ = { contents: D, range: N }) : (_ = null)
              }
            }),
            _)
          )
            return ((_.contents = s(_.contents)), _)
        }
        return null
      }
      function w(b, g) {
        ...
        for (const N in Ut) {
          ...
          const _ = "&" + N
          if (v === _) {
            let L = Ut[N].charCodeAt(0).toString(16).toUpperCase(),
              D = "U+"
            if (L.length < 4) {
              const R = 4 - L.length
              let M = 0
            ...
            D += L
            const k = Se("Character entity representing '{0}', unicode equivalent '{1}'", Ut[N], D)
      ...
      function p(b, g) {
        const v = be(e.getText(), g)
        let N = v.scan()
        for (; N !== z.EOS && (v.getTokenEnd() < l || (v.getTokenEnd() === l && N !== b)); )
          N = v.scan()
        return N === b && l <= v.getTokenEnd()
          ? { start: e.positionAt(v.getTokenOffset()), end: e.positionAt(v.getTokenEnd()) }
          : null
      }
      function x() {
        let b = l - 1,
      ...
      const A = p(z.AttributeName, o.start)
      if (A) {
        const b = o.tag,
          g = e.getText(A)
        return m(b, g, A)
      ...
      if (I) return w(u, I)
      function H(b, g) {
        const v = be(e.getText(), b)
        let N = v.scan(),
          S
        for (; N !== z.EOS && v.getTokenEnd() <= g; )
          ((N = v.scan()), N === z.AttributeName && (S = v.getTokenText()))
        return S
      }
      ...
      if (P) {
        const b = o.tag,
          g = Lc(e.getText(P)),
          v = H(o.start, e.offsetAt(P.start))
        if (v) return f(b, v, g, P)
      }
      return null
    }
    convertContents(e) {
...
You passed in: '` +
        ...
        function (r, s, a) {
          ...
          ;((y.prototype.eatString = function (A) {
            var I = ""
            for (this._ch = this._input.next(); this._ch; ) {
              if (((I += this._ch), this._ch === "\\")) I += this._input.next()
              else if (
                A.indexOf(this._ch) !== -1 ||
                this._ch ===
                  `
`
              )
            ...
            (y.prototype.eatWhitespace = function (A) {
...
` &&
            ...
            (y.prototype.foundNestedPseudoClass = function () {
              for (var A = 0, I = 1, H = this._input.peek(I); H; ) {
                if (H === "{") return !0
                if (H === "(") A += 1
                else if (H === ")") {
                  if (A === 0) return !1
            ...
            (y.prototype.print_string = function (A) {
              ;(this._output.set_indent(this._indentLevel),
                (this._output.non_breaking_space = !0),
                this._output.add_token(A))
            }),
            (y.prototype.preserveSingleSpace = function (A) {
              A && (this._output.space_before_token = !0)
            }),
            ...
            (y.prototype.beautify = function () {
              ...
              var A = this._source_text,
                I = this._options.eol
              ;(I === "auto" &&
                ((I = `
`),
                A && m.test(A || "") && (I = A.match(m)[0])),
                (A = A.replace(
                  f,
                  `
`
              ...
              ;((this._output = new o(this._options, H)),
                ...
                (this._ch = null))
              for (
                var P = 0, b = !1, g = !1, v = !1, N = !1, S = !1, _ = this._ch, L = !1, D, k, R;
                ...
                if (this._ch === "/" && this._input.peek() === "*") {
                    ...
                    ;(U.match(/[ :]$/) &&
                      ...
                      P === 0 && U.indexOf(":") !== -1
                        ...
                        : U in this.NESTED_AT_RULE
                          ? ((this._nestedLevel += 1), U in this.CONDITIONAL_GROUP_RULE && (v = !0))
                          : P === 0 && !g && (N = !0))
                  }
                else if (this._ch === "#" && this._input.peek() === "{")
                  ...
                  (g && ((g = !1), this.outdent()),
                    (N = !1),
                    v
                      ? ((v = !1), (b = this._indentLevel >= this._nestedLevel))
                  ...
                  if (this._input.lookBack("url"))
                    ...
                    var Z = !1
                    ;(this._input.lookBack("with") && (Z = !0),
                      this.preserveSingleSpace(k || Z),
                      this.print_string(this._ch),
                      g && R === "$" && this._options.selector_separator_newline
...
` &&
              ...
              var Ce = this._output.get_code(I)
              return Ce
            }),
        ...
        function (r, s, a) {
          ...
          ;((f.prototype.current_line_has_match = function (b) {
            ...
            (f.prototype.print_preserved_newlines = function (b) {
              ...
              for (var v = 0; v < g; v++) this.print_newline(v > 0)
              return g !== 0
            }),
          ...
          var w = function (b) {
              for (var g = null, v = b.next; v.type !== c.EOF && b.closed !== v; ) {
                if (v.type === c.ATTRIBUTE && v.text === "type") {
                  v.next &&
                    v.next.type === c.EQUALS &&
                    v.next.next &&
                    v.next.next.type === c.VALUE &&
                    (g = v.next.next.text)
                  break
                }
                v = v.next
            ...
            p = function (b, g) {
              var v = null,
                N = null
              return g.closed
                ? (b === "script" ? (v = "text/javascript") : b === "style" && (v = "text/css"),
                  (v = w(g) || v),
                  v.search("text/css") > -1
                    ? (N = "css")
                    : v.search(
                      ...
                      ? (N = "javascript")
                      : v.search(/(text|application|dojo)\/(x-)?(html)/) > -1
                        ? (N = "html")
                        : v.search(/test\/null/) > -1 && (N = "null"),
                  N)
                : null
            }
          function x(b, g) {
...
`
            ...
            var v = b.match(/^[\t ]*/)[0],
              N = { text: "", type: "" },
              S = new I(),
              _ = new f(this._options, v),
              L = new u(b, this._options).tokenize()
            this._tag_stack = new y(_)
            for (var D = null, k = L.next(); k.type !== c.EOF; )
              (k.type === c.TAG_OPEN || k.type === c.COMMENT
                ? ((D = this._handle_tag_open(_, k, S, N, L)), (S = D))
                : k.type === c.ATTRIBUTE ||
                    k.type === c.EQUALS ||
                    k.type === c.VALUE ||
                    (k.type === c.TEXT && !S.tag_complete)
                  ? (D = this._handle_inside_tag(_, k, S, N))
                  : k.type === c.TAG_CLOSE
                    ? (D = this._handle_tag_close(_, k, S))
                    : k.type === c.TEXT
                      ? (D = this._handle_text(_, k, S))
                      : k.type === c.CONTROL_FLOW_OPEN
                        ? (D = this._handle_control_flow_open(_, k))
                        : k.type === c.CONTROL_FLOW_CLOSE
                          ? (D = this._handle_control_flow_close(_, k))
                          : _.add_raw_token(k),
                (N = D),
                (k = L.next()))
            var R = _._output.get_code(g)
            return R
          }),
            (A.prototype._handle_control_flow_open = function (b, g) {
              var v = { text: g.text, type: g.type }
              return (
            ...
            (A.prototype._handle_control_flow_close = function (b, g) {
              var v = { text: g.text, type: g.type }
              return (
                b.deindent(),
                g.newlines
            ...
            (A.prototype._handle_tag_close = function (b, g, v) {
              ...
              return (
                ...
                v.is_unformatted
                  ...
                  : (v.tag_start_char === "<" &&
                    ...
                    b.print_token(g)),
                v.indent_content &&
                  !(v.is_unformatted || v.is_content_unformatted) &&
                  (b.indent(), (v.indent_content = !1)),
                !v.is_inline_element &&
                  !(v.is_unformatted || v.is_content_unformatted) &&
                  b.set_wrap_point(),
                N
            ...
            (A.prototype._handle_inside_tag = function (b, g, v, N) {
              var S = v.has_wrapped_attrs,
                _ = { text: g.text, type: g.type }
              return (
                b.set_space_before_token(g.newlines || g.whitespace_before !== "", !0),
                v.is_unformatted
                  ? b.add_raw_token(g)
                  : v.tag_start_char === "{" && g.type === c.TEXT
                    ? b.print_preserved_newlines(g)
                    ...
                    : (g.type === c.ATTRIBUTE
                      ...
                      g.type === c.ATTRIBUTE &&
                        ...
                        this._is_wrap_attributes_force &&
                          v.attr_count >= this._options.wrap_attributes_min_attrs &&
                          (N.type !== c.TAG_OPEN ||
                            this._is_wrap_attributes_force_expand_multiline) &&
                          (b.print_newline(!1), (S = !0))),
                      b.print_token(g),
                      (S = S || b.previous_token_wrapped()),
                      (v.has_wrapped_attrs = S)),
                _
              )
            }),
            (A.prototype._handle_text = function (b, g, v) {
              var N = { text: g.text, type: "TK_CONTENT" }
              return (
                v.custom_beautifier_name
                  ? this._print_custom_beatifier_text(b, g, v)
                  : v.is_unformatted || v.is_content_unformatted
                    ? b.add_raw_token(g)
            ...
            (A.prototype._print_custom_beatifier_text = function (b, g, v) {
              var N = this
              if (g.text !== "") {
                var S = g.text,
                  _,
                  ...
                  D = "",
                  k = ""
                ;(v.custom_beautifier_name === "javascript" &&
                typeof this._js_beautify == "function"
                  ? (_ = this._js_beautify)
                  : v.custom_beautifier_name === "css" && typeof this._css_beautify == "function"
                    ? (_ = this._css_beautify)
                    : v.custom_beautifier_name === "html" &&
                      (_ = function (O, Y) {
                        var Z = new A(O, Y, N._js_beautify, N._css_beautify)
                        return Z.beautify()
                      }),
                  this._options.indent_scripts === "keep"
                    ? (L = 0)
                    : this._options.indent_scripts === "separate" && (L = -b.indent_level))
                var R = b.get_full_indent(L)
                if (
                  ((S = S.replace(/\n[ \t]*$/, "")),
                  v.custom_beautifier_name !== "html" &&
                    S[0] === "<" &&
...
` +
            ...
            (A.prototype._handle_tag_open = function (b, g, v, N, S) {
              var _ = this._get_tag_open_token(g)
              if (
                ((v.is_unformatted || v.is_content_unformatted) &&
                !v.is_empty_element &&
                g.type === c.TAG_OPEN &&
                !_.is_start_tag
                  ? (b.add_raw_token(g), (_.start_tag_token = this._tag_stack.try_pop(_.tag_name)))
                  : (b.traverse_whitespace(g),
                    this._set_tag_position(b, g, _, v, N),
                    _.is_inline_element || b.set_wrap_point(),
                    b.print_token(g)),
                _.is_start_tag && this._is_wrap_attributes_force)
              ) {
                var L = 0,
                  D
                do ((D = S.peek(L)), D.type === c.ATTRIBUTE && (_.attr_count += 1), (L += 1))
              ...
              return (
                (this._is_wrap_attributes_force_aligned ||
                  this._is_wrap_attributes_aligned_multiple ||
                  this._is_wrap_attributes_preserve_aligned) &&
                  (_.alignment_size = g.text.length + 1),
                !_.tag_complete && !_.is_unformatted && (b.alignment_size = _.alignment_size),
                _
              )
            }))
          var I = function (b, g) {
            if (
              ...
              ;((this.tag_start_char = g.text[0]),
                (this.text = g.text),
                this.tag_start_char === "<"
                  ? ((v = g.text.match(/^<([^\s>]*)/)), (this.tag_check = v ? v[1] : ""))
                  : ((v = g.text.match(/^{{~?(?:[\^]|#\*?)?([^\s}]+)/)),
                    (this.tag_check = v ? v[1] : ""),
          ...
          ;((A.prototype._get_tag_open_token = function (b) {
            ...
            (A.prototype._set_tag_position = function (b, g, v, N, S) {
              if (
                (v.is_empty_element ||
                  (v.is_end_tag
                    ? (v.start_tag_token = this._tag_stack.try_pop(v.tag_name))
                    : (this._do_optional_end_element(v) &&
                        (v.is_inline_element || b.print_newline(!1)),
                      this._tag_stack.record_tag(v),
                      (v.tag_name === "script" || v.tag_name === "style") &&
                        !(v.is_unformatted || v.is_content_unformatted) &&
                        (v.custom_beautifier_name = p(v.tag_check, g)))),
                x(v.tag_check, this._options.extra_liners) &&
                ...
                ;(v.tag_name === "!--" &&
                  ...
                  v.text.indexOf(`
`) === -1) ||
                  (v.is_inline_element || v.is_unformatted || b.print_newline(!1),
                  this._calcluate_parent_multiline(b, v))
              } else if (v.is_end_tag) {
                var L = !1
                ;((L = v.start_tag_token && v.start_tag_token.multiline_content),
                  (L =
                    L ||
                    (!v.is_inline_element &&
                      !(N.is_inline_element || N.is_unformatted) &&
                      !(S.type === c.TAG_CLOSE && v.start_tag_token === N) &&
                      S.type !== "TK_CONTENT")),
                  (v.is_content_unformatted || v.is_unformatted) && (L = !1),
                  L && b.print_newline(!1))
              } else
                ((v.indent_content = !v.custom_beautifier_name),
                  v.tag_start_char === "<" &&
                    (v.tag_name === "html"
                      ? (v.indent_content = this._options.indent_inner_html)
                      : v.tag_name === "head"
                        ? (v.indent_content = this._options.indent_head_inner_html)
                        : v.tag_name === "body" &&
                          (v.indent_content = this._options.indent_body_inner_html)),
                  !(v.is_inline_element || v.is_unformatted) &&
                    (S.type !== "TK_CONTENT" || v.is_content_unformatted) &&
                    b.print_newline(!1),
                  this._calcluate_parent_multiline(b, v))
            }),
            (A.prototype._calcluate_parent_multiline = function (b, g) {
              g.parent &&
          ...
          ;((A.prototype._do_optional_end_element = function (b) {
            var g = null
          ...
          var l = a(9).Tokenizer,
            ...
            w = function (p, x) {
              ...
              if (
                ...
                this.__patterns.unformatted_content_delimiter = y.matching(A).until_after(A)
              }
            }
          ;((w.prototype = new l()),
            ...
            (w.prototype._read_control_flows = function (p, x) {
              ...
              if (p === "@") {
                ...
                for (var A = T.endsWith("(") ? 1 : 0, I = 0; !(T.endsWith("{") && A === I); ) {
            ...
            (w.prototype._read_attribute = function (p, x, T) {
              ...
              if (T && T.text[0] === "<")
                if (p === "=") y = this._create_token(m.EQUALS, this._input.next())
                  ...
                  ((A = this.__patterns.attribute.read()),
                    A &&
                      (x.type === m.EQUALS
                        ? (y = this._create_token(m.VALUE, A))
                        : (y = this._create_token(m.ATTRIBUTE, A))))
              return y
            }),
            ...
            (w.prototype._read_raw_content = function (p, x, T) {
              ...
              if (T && T.text[0] === "{") y = this.__patterns.handlebars_raw_close.read()
                ...
                var A = x.opened.text.substr(1).toLowerCase()
                if (A === "script" || A === "style") {
                  var I = this._read_comment_or_cdata(p)
                  if (I) return ((I.type = m.TEXT), I)
                  y = this._input.readUntil(new RegExp("</" + A + "[\\n\\r\\t ]*?>", "ig"))
                } else
                  this._is_content_unformatted(A) &&
                    (y = this._input.readUntil(new RegExp("</" + A + "[\\n\\r\\t ]*?>", "ig")))
              }
  ...
  function Dc(t, e, n) {
    ...
    if (e) {
      let u = t.offsetAt(e.start),
        c = u
      for (; c > 0 && Xa(i, c - 1); ) c--
      c === 0 || Ga(i, c - 1) ? (u = c) : c < u && (u = c + 1)
      let d = t.offsetAt(e.end),
        m = d
      for (; m < i.length && Xa(i, m); ) m++
      ;((m === i.length || Ga(i, m)) && (d = m), (e = J.create(t.positionAt(u), t.positionAt(d))))
    ...
    const l = {
      ...
      unformatted: Ri(n, "unformatted", void 0),
      content_unformatted: Ri(n, "contentUnformatted", void 0),
      ...
      extra_liners: Ri(n, "extraLiners", void 0),
...
`,
    ...
    let o = Rc(Mc(i), l)
    if (s > 0) {
      const u = n.insertSpaces ? qa(" ", a * s) : qa("	", s)
      ;((o = o
        .split(
          `
`
...
`.indexOf(t.charAt(e)) !== -1
  ...
  ;(() => {
        ...
        470: (r) => {
          ...
          var l = {
            ...
            relative: function (o, u) {
              ...
              var A = ""
              for (T = c + x + 1; T <= d; ++T)
                (T !== d && o.charCodeAt(T) !== 47) || (A.length === 0 ? (A += "..") : (A += "/.."))
              return A.length > 0
                ? A + u.slice(f + x)
    ...
    ;((() => {
      ...
      class m {
        ...
        with(_) {
          if (!_) return this
          let { scheme: L, authority: D, path: k, query: R, fragment: M } = _
          return (
            L === void 0 ? (L = this.scheme) : L === null && (L = u),
            D === void 0 ? (D = this.authority) : D === null && (D = u),
            k === void 0 ? (k = this.path) : k === null && (k = u),
            R === void 0 ? (R = this.query) : R === null && (R = u),
        ...
        static parse(_, L = !1) {
          const D = d.exec(_)
          return D
            ? new w(D[2] || u, P(D[4] || u), P(D[5] || u), P(D[7] || u), P(D[9] || u), L)
            : new w(u, u, u, u, u)
        }
        static file(_) {
          let L = u
          if ((r && (_ = _.replace(/\\/g, c)), _[0] === c && _[1] === c)) {
            const D = _.indexOf(c, 2)
            D === -1
              ? ((L = _.substring(2)), (_ = c))
              : ((L = _.substring(2, D)), (_ = _.substring(D) || c))
          }
          return new w("file", L, _, u, u)
        }
        static from(_) {
          const L = new w(_.scheme, _.authority, _.path, _.query, _.fragment)
          return (o(L, !0), L)
        }
        toString(_ = !1) {
          return A(this, _)
        ...
        static revive(_) {
          if (_) {
            ...
            {
              const L = new w(_)
              return ((L._formatted = _.external), (L._fsPath = _._sep === f ? _.fsPath : null), L)
            }
          }
          return _
        }
      ...
      class w extends m {
        ...
        toString(_ = !1) {
          return _
            ? A(this, !0)
            : (this._formatted || (this._formatted = A(this, !1)), this._formatted)
        }
        toJSON() {
          const _ = { $mid: 1 }
          return (
            this._fsPath && ((_.fsPath = this._fsPath), (_._sep = f)),
      ...
      function x(S, _, L) {
        ...
        for (let R = 0; R < S.length; R++) {
          ...
          if (
            ...
            (k !== -1 && ((D += encodeURIComponent(S.substring(k, R))), (k = -1)),
              D !== void 0 && (D += S.charAt(R)))
          else {
            D === void 0 && (D = S.substr(0, R))
            const W = p[M]
            W !== void 0
              ? (k !== -1 && ((D += encodeURIComponent(S.substring(k, R))), (k = -1)), (D += W))
              : k === -1 && (k = R)
          }
        }
      ...
      function A(S, _) {
        const L = _ ? T : x
        let D = "",
          { scheme: k, authority: R, path: M, query: W, fragment: F } = S
        if ((k && ((D += k), (D += ":")), (R || k === "file") && ((D += c), (D += c)), R)) {
          let U = R.indexOf("@")
          if (U !== -1) {
            const O = R.substr(0, U)
            ;((R = R.substr(U + 1)),
              (U = O.lastIndexOf(":")),
              U === -1
                ? (D += L(O, !1, !1))
                : ((D += L(O.substr(0, U), !1, !1)), (D += ":"), (D += L(O.substr(U + 1), !1, !0))),
              (D += "@"))
          }
          ;((R = R.toLowerCase()),
            (U = R.lastIndexOf(":")),
            U === -1 ? (D += L(R, !1, !0)) : ((D += L(R.substr(0, U), !1, !0)), (D += R.substr(U))))
        }
        if (M) {
      ...
      function P(S) {
        return S.match(H) ? S.replace(H, (_) => I(_)) : S
      }
      var b = n(470)
      const g = b.posix || b,
        v = "/"
      var N
      ;(function (S) {
        ;((S.joinPath = function (_, ...L) {
          return _.with({ path: g.join(_.path, ...L) })
        }),
          (S.resolvePath = function (_, ...L) {
            let D = _.path,
              k = !1
            D[0] !== v && ((D = v + D), (k = !0))
            let R = g.resolve(D, ...L)
            return (k && R[0] === v && !_.authority && (R = R.substring(1)), _.with({ path: R }))
          }),
          (S.dirname = function (_) {
            if (_.path.length === 0 || _.path === v) return _
            let L = g.dirname(_.path)
            return (L.length === 1 && L.charCodeAt(0) === 46 && (L = ""), _.with({ path: L }))
          }),
          (S.basename = function (_) {
            return g.basename(_.path)
          }),
          (S.extname = function (_) {
            return g.extname(_.path)
          }))
      })(N || (N = {}))
    })(),
      (Ja = i))
  })()
  const { URI: zc, Utils: lh } = Ja
  function Di(t) {
    const e = t[0],
      n = t[t.length - 1]
  ...
  function Uc(t, e, n, i) {
    ...
    return /^\#/i.test(e)
      ? t + e
      : /^\/\//i.test(e)
        ? (Ge(t, "https://") ? "https" : "http") + ":" + e.replace(/^\s*/g, "")
        : n
  ...
  function Pc(t, e, n, i, r, s) {
    const a = Di(n)
    if (!Hc(a, t.languageId)) return
    a.length < n.length && (i++, r--)
    const l = Uc(t.uri, a, e, s)
    if (!l) return
    const o = Fc(l, t)
  ...
  function Fc(t, e) {
    try {
      ...
      return (
        ...
        n.scheme === "file" &&
        n.fragment &&
        !(t.startsWith(e.uri) && t.charCodeAt(e.uri.length) === Wc)
        ...
        switch (s) {
          ...
          case z.AttributeValue:
            if (l && a && this.dataManager.isPathAttribute(l, a)) {
              ...
              if (!o) {
                const m = Pc(e, n, d, r.getTokenOffset(), r.getTokenEnd(), u)
                m && i.push(m)
              }
              ;(o && typeof u > "u" && ((u = Di(d)), u && n && (u = n.resolveReference(u, e.uri))),
                (o = !1),
                (a = void 0))
            } else if (a === "id") {
              const d = Di(r.getTokenText())
  ...
  function qc(t, e, n) {
    ...
    if (!r.tag) return []
    const s = [],
      a = Za(z.StartTag, t, r.start),
      l = typeof r.endTagStart == "number" && Za(z.EndTag, t, r.endTagStart)
    return (
      ((a && Ya(a, e)) || (l && Ya(l, e))) &&
        (a && s.push({ kind: mn.Read, range: a }), l && s.push({ kind: mn.Read, range: l })),
      s
    )
  }
  function Qa(t, e) {
  ...
  function Ya(t, e) {
    return Qa(t.start, e) && Qa(e, t.end)
  }
  function Za(t, e, n) {
  ...
  function Oc(t, e) {
    ...
    return n
    function r(s, a) {
      const l = Ti.create(s.name, s.kind, s.range, t.uri, a?.name)
  ...
  function eo(t, e, n) {
    const i = Vc(e),
      ...
      s = xi.create(i, void 0, yi.Field, r, r)
    ;(n.push(s),
      e.children.forEach((a) => {
        ;(s.children ?? (s.children = []), eo(t, a, s.children))
      }))
  }
  function Vc(t) {
    let e = t.tag
  ...
  function jc(t, e, n, i) {
    const r = t.offsetAt(e),
      s = i.findNodeAt(r)
    if (!s.tag || !$c(s, r, s.tag)) return null
    const a = [],
            ...
            if (w)
              if (w[1]) l.push({ startLine: m, tagName: "" })
                ...
                if (p >= 0) {
                  ...
                  const T = m
                  ;((m = x.startLine),
                    T > m && u !== m && c({ startLine: m, endLine: T, kind: cn.Region }))
                }
              }
            else {
              const p = e.positionAt(r.getTokenOffset() + r.getTokenLength()).line
              m < p && c({ startLine: m, endLine: p, kind: cn.Comment })
            }
            break
          }
        }
  ...
  class Jc {
    ...
    getSelectionRange(e, n, i) {
      ...
      for (let l = r.length - 1; l >= 0; l--) {
        const o = r[l]
        ;((!s || o[0] !== s[0] || o[1] !== s[1]) &&
          (a = pn.create(J.create(n.positionAt(r[l][0]), n.positionAt(r[l][1])), a)),
          (s = o))
      }
      return (a || (a = pn.create(J.create(e, e))), a)
    }
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`,
  ...
  class Yc {
    ...
    setDataProviders(e, n) {
      ;((this.dataProviders = []),
        e && this.dataProviders.push(new Oa("html5", Qc)),
    ...
    isVoidElement(e, n) {
      return !!e && sc(n, e.toLowerCase(), (i, r) => i.localeCompare(r)) >= 0
    }
    getVoidElements(e) {
  ...
  function eh(t = Kc) {
    ...
    return {
      ...
      format: Dc,
      findDocumentHighlights: qc,
      findDocumentLinks: l.findDocumentLinks.bind(l),
      findDocumentSymbols: Oc,
      findDocumentSymbols2: Ka,
      ...
      doRename: jc,
      findMatchingTagPosition: Gc,
      findOnTypeRenameRanges: to,
      findLinkedEditingRanges: to,
    }
  }
  function th(t, e) {
    return new Oa(t, e)
  ...
  class nh {
    constructor(e, n) {
      ...
      const i = this._languageSettings.data,
        r = i?.useDefaultDataProvider,
        s = []
      if (i?.dataProviders) for (const a in i.dataProviders) s.push(th(a, i.dataProviders[a]))
      this._languageService = eh({ useDefaultDataProvider: r, customDataProviders: s })
    }
    ...
    _getTextDocument(e) {
      ...
      for (let i of n)
        if (i.uri.toString() === e) return Ai.create(e, this._languageId, i.version, i.getValue())
      return null
    }
  }
  self.onmessage = () => {

...
` +
  ...
  const Je = class Je {
    constructor(e) {
      ;((this.element = e), (this.next = Je.Undefined), (this.prev = Je.Undefined))
    }
  }
  ...
  ;(function (t) {
          ...
          onWillAddFirstListener() {
            J = _((R1) => {
              ;(qt++,
                ...
                (gt = () => {
                  const C1 = Z
                  ;((Z = void 0), (Te = void 0), (!R || qt > 1) && Ut.fire(C1), (qt = 0))
                }),
                typeof k == "number"
    ...
    t.debounce = m
    function p(_, S = 0, k) {
      return t.debounce(_, (R, F) => (R ? (R.push(F), R) : [F]), S, void 0, !0, void 0, k)
    }
    t.accumulate = p
...
`)
    ...
    constructor(e) {
      ;((this._size = 0),
        ...
        (this._leakageMon = this._options?.leakWarningThreshold
          ? new Gt(e?.onListenerError ?? bt, this._options?.leakWarningThreshold ?? Js)
          : void 0),
        (this._perfMon = this._options?._profName ? new zt(this._options._profName) : void 0),
        ...
        (this._event ??= (e, n, r) => {
          if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
            ...
            const u = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1],
              c = new Zs(`${o}. HINT: Stack shows most frequent listener (${u[1]}-times)`, u[0])
          ...
          ;(this._leakageMon &&
            ...
            this._listeners
              ? this._listeners instanceof Ot
                ? ((this._deliveryQueue ??= new ei()), (this._listeners = [this._listeners, s]))
          ...
          return (r instanceof tt ? r.add(l) : Array.isArray(r) && r.push(l), l)
        }),
        this._event
      )
    }
  ...
  typeof Ce.vscode < "u" && typeof Ce.vscode.process < "u"
    ...
    : typeof process < "u" && typeof process?.versions?.node == "string" && (ee = process)
  const ii = typeof ee?.versions?.electron == "string" && ee?.type === "renderer"
  if (typeof ee == "object") {
    ;((Xt = ee.platform === "win32"),
      (Qt = ee.platform === "darwin"),
      (Jt = ee.platform === "linux"),
      Jt && ee.env.SNAP && ee.env.SNAP_REVISION,
      ee.env.CI || ee.env.BUILD_ARTIFACTSTAGINGDIRECTORY || ee.env.GITHUB_WORKSPACE,
      (_t = Ve),
      (Yt = Ve))
    ...
    typeof navigator == "object" && !ii
      ? ((be = navigator.userAgent),
        ...
        (be.indexOf("Macintosh") >= 0 || be.indexOf("iPad") >= 0 || be.indexOf("iPhone") >= 0) &&
  ...
  ;((ge.ambiguousCharacterData = new Zt(() =>
    ...
    (ge._locales = new Zt(() =>
      Object.keys(ge.ambiguousCharacterData.value).filter((e) => !e.startsWith("_"))
    )))
  let rt = ge
  const Ze = class Ze {
    static getRawData() {
    ...
    static getData() {
      return (
        this._data || (this._data = new Set([...Object.values(Ze.getRawData())].flat())),
        this._data
      )
    }
  ...
  class Ci {
    ...
    listen(e, n, r) {
      ...
      const i = new fe({
        ...
        onDidRemoveLastListener: () => {
          ;(this._pendingEmitters.delete(s), this._send(new Ri(this._workerId, s)), (s = null))
        },
      })
      return i.event
    }
          ...
          typeof i == "string" &&
            ...
            (Bn(i)
              ...
              : In(i)
                ...
                : i.charCodeAt(0) === 36 &&
                  (s[i] = async (...l) => (await n?.(), this.sendMessage(e, i, l)))),
          s[i]
        ),
      }
  ...
  class ve {
    ...
    ComputeDiffRecursive(e, n, r, s, i) {
      ...
      if (e > n || r > s) {
        ...
        return (
          r <= s
            ? (Ie.Assert(e === n + 1, "originalStart should only be one more than originalEnd"),
              (f = [new Le(e, 0, r, s - r + 1)]))
            : e <= n
              ? (Ie.Assert(r === s + 1, "modifiedStart should only be one more than modifiedEnd"),
    ...
    WALKTRACE(e, n, r, s, i, l, o, u, c, h, f, m, p, b, d, x, N, v) {
      ...
      do {
        ...
        ;(V === q || (V < w && c[V - 1] < c[V + 1])
          ...
          : ((f = c[V - 1] + 1),
            ...
            (y = V - 1 - e)),
          D >= 0 && ((c = this.m_forwardHistory[D]), (e = c[0]), (q = 1), (w = c.length - 1)))
      } while (--D >= -1)
      if (((L = T.getReverseChanges()), v[0])) {
        ...
        if (L !== null && L.length > 0) {
          ...
          ;((V = Math.max(V, S.getOriginalEnd())), (_ = Math.max(_, S.getModifiedEnd())))
        }
        ...
        do {
          ...
          ;(V === q || (V < w && h[V - 1] >= h[V + 1])
            ...
            : ((f = h[V - 1]),
              ...
              (y = V - 1 - i)),
            D >= 0 && ((h = this.m_reverseHistory[D]), (i = h[0]), (q = 1), (w = h.length - 1)))
        } while (--D >= -1)
        E = T.getChanges()
      }
    ...
    ComputeRecursionPoint(e, n, r, s, i, l, o) {
      ...
      for (let y = 1; y <= b / 2 + 1; y++) {
        ...
        for (let _ = h; _ <= f; _ += 2) {
          ;(_ === h || (_ < f && x[_ - 1] < x[_ + 1]) ? (u = x[_ + 1]) : (u = x[_ - 1] + 1),
            (c = u - (_ - v) - E))
          const S = u
          ...
          if (
            ...
            return (
              ...
              (l[0] = c),
              S <= N[_] && y <= 1448
                ? this.WALKTRACE(v, h, f, E, L, m, p, T, x, N, u, n, i, c, s, l, w, o)
                : null
            )
        }
        const V = (A - e + (D - r) - y) / 2
        ...
        for (let _ = m; _ <= p; _ += 2) {
          ;(_ === m || (_ < p && N[_ - 1] >= N[_ + 1]) ? (u = N[_ + 1] - 1) : (u = N[_ - 1]),
            (c = u - (_ - L) - T))
          const S = u
      ...
      return this.WALKTRACE(v, h, f, E, L, m, p, T, x, N, u, n, i, c, s, l, w, o)
    }
    PrettifyChanges(e) {
    ...
    ConcatenateChanges(e, n) {
      ...
      if (this.ChangesOverlap(e[e.length - 1], n[0], r)) {
        ...
        return (Be.Copy(e, 0, s, 0, e.length), Be.Copy(n, 0, s, e.length, n.length), s)
      }
    }
      ...
      for (let i = 1, l = e.getLineCount(); i <= l; i++) {
        ...
        for (; c < u; ) {
          ...
          if (m === 13) {
            ...
            let L
            ;(v === 91 ? ((b = !0), (L = 0)) : (L = r.get(v)), L === 1 ? (N = !0) : (m = 13))
          } else ((m = n.nextState(m, v)), m === 0 && (N = !0))
          ;(N && ((m = 1), (p = !1), (b = !1), (x = !1), (h = c + 1), (f = v)), c++)
        }
  ...
  ;(function () {
    ...
    for (const s of e) {
      ...
      if ((r[l] || ((r[l] = !0), (Ui[o] = l), ($i[o.toLowerCase()] = l)), !n[u])) {
        if (((n[u] = !0), !c))
  ...
  const K = {
      resolve(...t) {
        ...
        for (let s = t.length - 1; s >= -1; s--) {
          ...
          if (l === 1) I(h) && ((o = 1), (c = !0))
            ...
            we(h) &&
              i.charCodeAt(1) === pe &&
              ((u = i.slice(0, 2)), (o = 2), l > 2 && I(i.charCodeAt(2)) && ((c = !0), (o = 3)))
          if (u.length > 0)
            if (e.length > 0) {
      ...
      normalize(t) {
        ...
        if (I(i))
          ...
          we(i) &&
            t.charCodeAt(1) === pe &&
            ((r = t.slice(0, 2)), (n = 2), e > 2 && I(t.charCodeAt(2)) && ((s = !0), (n = 3)))
      ...
      isAbsolute(t) {
        ...
        return I(n) || (e > 2 && we(n) && t.charCodeAt(1) === pe && I(t.charCodeAt(2)))
      },
      join(...t) {
        ...
        if (typeof n == "string" && I(n.charCodeAt(0))) {
          ++s
          const i = n.length
          i > 1 && I(n.charCodeAt(1)) && (++s, i > 2 && (I(n.charCodeAt(2)) ? ++s : (r = !1)))
        }
        if (r) {
      ...
      relative(t, e) {
        ...
        if (n.length !== t.length || r.length !== e.length) {
          const b = n.split("\\"),
            d = r.split("\\")
          ;(b[b.length - 1] === "" && b.pop(), d[d.length - 1] === "" && d.pop())
          const x = b.length,
            N = d.length,
            v = x < N ? x : N
          let L
      ...
      dirname(t) {
        ...
        if (I(s)) {
          ...
          we(s) && t.charCodeAt(1) === pe && ((n = e > 2 && I(t.charCodeAt(2)) ? 3 : 2), (r = n))
        let i = -1,
          l = !0
        for (let o = e - 1; o >= r; --o)
          if (I(t.charCodeAt(o))) {
      ...
      parse(t) {
        ...
        let r = 0,
          s = t.charCodeAt(0)
        if (n === 1) return I(s) ? ((e.root = e.dir = t), e) : ((e.base = e.name = t), e)
        if (I(s)) {
    ...
    ne = {
      resolve(...t) {
        ...
        for (let r = t.length - 1; r >= 0 && !n; r--) {
          const s = t[r]
          ;(X(s, `paths[${r}]`), s.length !== 0 && ((e = `${s}/${e}`), (n = s.charCodeAt(0) === Q)))
        }
        if (!n) {
          const r = Zi()
      ...
      relative(t, e) {
        ...
        if (c === o)
          ...
          } else s > o && (t.charCodeAt(n + c) === Q ? (u = c) : c === 0 && (u = 0))
        let h = ""
        for (c = n + u + 1; c <= r; ++c)
          (c === r || t.charCodeAt(c) === Q) && (h += h.length === 0 ? ".." : "/..")
  ...
  class Me {
    ...
    static parse(e, n = !1) {
      const r = ia.exec(e)
      return r
        ? new $e(r[2] || G, Ct(r[4] || G), Ct(r[5] || G), Ct(r[7] || G), Ct(r[9] || G), n)
        : new $e(G, G, G, G, G)
    }
    static file(e) {
      let n = G
  ...
  function hn(t, e) {
    ...
    if ((s && ((r += s), (r += ":")), (i || s === "file") && ((r += ce), (r += ce)), i)) {
      let c = i.indexOf("@")
      if (c !== -1) {
      ...
      e: for (let x = s, N = i; x <= N; x++) {
        ...
        do
          if (((m = c.next(v)), m)) {
            ...
            if (y !== 0) {
              if ((y === 3 ? p++ : y === 2 ? b++ : y === 1 ? d++ : Hs(), h.length >= 1e3)) {
                f = !0
                break e
              }
      ...
      switch (r.shouldHighlightNonBasicASCII(e, null)) {
        ...
        case 3: {
          const i = e.codePointAt(0),
            ...
            o = rt
              .getLocales()
              .filter((u) => !rt.getInstance(new Set([...n.allowedLocales, u])).isAmbiguous(i))
  ...
  class fs {
    ...
    shouldHighlightNonBasicASCII(e, n) {
      ...
      return !s && i
        ? 0
        : this.options.invisibleCharacters && !ms(e) && st.isInvisibleCharacter(r)
          ? 2
...
` ||
  ...
  class B {
    ...
    join(e) {
      return new B(Math.min(this.start, e.start), Math.max(this.endExclusive, e.endExclusive))
    }
    intersect(e) {
  ...
  const ie = class ie {
    ...
    constructor(e, n) {
      if (e > n) throw new Y(`startLineNumber ${e} cannot be after endLineNumberExclusive ${n}`)
  ...
  class de {
    ...
    addRange(e) {
      ...
      const n = xn(this._normalizedRanges, (s) => s.endLineNumberExclusive >= e.startLineNumber),
        r = We(this._normalizedRanges, (s) => s.startLineNumber <= e.endLineNumberExclusive) + 1
    ...
    intersects(e) {
      const n = He(this._normalizedRanges, (r) => r.startLineNumber < e.endLineNumberExclusive)
    ...
    subtractFrom(e) {
      const n = xn(this._normalizedRanges, (l) => l.endLineNumberExclusive >= e.startLineNumber),
        r = We(this._normalizedRanges, (l) => l.startLineNumber <= e.endLineNumberExclusive) + 1
      ...
      return (i < e.endLineNumberExclusive && s.push(new $(i, e.endLineNumberExclusive)), new de(s))
    }
    toString() {
...
`
  ...
  class Da {
    getOffsetRange(e) {
      return new B(this.getOffset(e.getStartPosition()), this.getOffset(e.getEndPosition()))
    }
    getRange(e) {
      return C.fromPositions(this.getPosition(e.start), this.getPosition(e.endExclusive))
    }
    getStringReplacement(e) {
      return new ze.deps.StringReplacement(this.getOffsetRange(e.range), e.text)
    }
    getTextReplacement(e) {
      return new ze.deps.TextReplacement(this.getRange(e.replaceRange), e.newText)
    }
    getTextEdit(e) {
...
` &&
    ...
    get textLength() {
      ...
      return new ze.deps.TextLength(e, this.text.length - this.lineStartOffsetByLineIdx[e])
    }
    getLineLength(e) {
  ...
  class Ia {
    ...
    getTransformer() {
      return (this._transformer || (this._transformer = new Va(this.getValue())), this._transformer)
    }
    getLineAt(e) {
...
`
        ...
        s = bi(n, r),
        i = ot.ofText(n.substring(0, s)).addToPosition(this.range.getStartPosition()),
        l = r.substring(s),
...
`
        ...
        s = pi(n, r),
        i = ot.ofText(n.substring(0, n.length - s)).addToPosition(this.range.getStartPosition()),
      ...
      if (!this.original.isEmpty && !this.modified.isEmpty)
        return new le(
          C.fromPositions(
            ...
            Ge(new H(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)
          ),
          C.fromPositions(
            new H(this.modified.startLineNumber, 1),
            Ge(new H(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)
          )
        )
      if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
        return new le(
          C.fromPositions(
            Ge(new H(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), e),
            Ge(new H(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)
          ),
          C.fromPositions(
            Ge(new H(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n),
            Ge(new H(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)
          )
        )
      throw new Y()
    ...
    computeDiff(e, n, r) {
      ...
      for (const u of i.changes) {
        ...
        u.originalEndLineNumber === 0
          ? (c = new $(u.originalStartLineNumber + 1, u.originalStartLineNumber + 1))
          : (c = new $(u.originalStartLineNumber, u.originalEndLineNumber + 1))
        let h
        u.modifiedEndLineNumber === 0
          ? (h = new $(u.modifiedStartLineNumber + 1, u.modifiedStartLineNumber + 1))
    ...
    static createFromDiffResult(e, n, r, s, i, l, o) {
      ...
      if (
        ...
        const p = r.createCharSequence(e, n.originalStart, n.originalStart + n.originalLength - 1),
          b = s.createCharSequence(e, n.modifiedStart, n.modifiedStart + n.modifiedLength - 1)
        if (p.getElements().length > 0 && b.getElements().length > 0) {
          let d = ps(p, b, i, !0).changes
          ;(o && (d = Wa(d)), (m = []))
          for (let x = 0, N = d.length; x < N; x++) m.push(je.createFromDiffChange(d[x], p, b))
        }
      }
          ...
          if (m !== p) {
            {
              ...
              ;(b > 1 || d > 1) && this._pushTrimWhitespaceCharChange(s, i + 1, 1, b, l + 1, 1, d)
            }
            {
              let b = _n(m, 1),
                d = _n(p, 1)
              ...
              ;(b < x || d < N) && this._pushTrimWhitespaceCharChange(s, i + 1, b, x, l + 1, d, N)
            }
          }
          ;(i++, l++)
        }
...
`)
        ...
        for (let d = 0; d < n.length; d++) {
          ...
          e.getElement(b) === n.getElement(d)
            ? (b === 0 || d === 0 ? (v = 0) : (v = i.get(b - 1, d - 1)),
              b > 0 && d > 0 && l.get(b - 1, d - 1) === 3 && (v += o.get(b - 1, d - 1)),
              (v += s ? s(b, d) : 1))
            : (v = -1)
          ...
          if (L === v) {
            ...
            L === x ? (o.set(b, d, 0), l.set(b, d, 1)) : L === N && (o.set(b, d, 0), l.set(b, d, 2))
          i.set(b, d, L)
        }
      const u = []
      let c = e.length,
        h = n.length
      function f(b, d) {
        ;((b + 1 !== c || d + 1 !== h) && u.push(new O(new B(b + 1, c), new B(d + 1, h))),
          (c = b),
          (h = d))
      }
      let m = e.length - 1,
  ...
  class ys {
    compute(e, n, r = ct.instance) {
      ...
      const s = e,
        i = n
      function l(d, x) {
        for (; d < s.length && x < i.length && s.getElement(d) === i.getElement(x); ) (d++, x++)
        return d
      }
      let o = 0
      const u = new Oa()
      ...
      for (;;) {
        const d = f ? f.x + f.length : 0,
          x = f ? f.y + f.length : 0
        if (((d !== p || x !== b) && m.push(new O(new B(d, p), new B(x, b))), !f)) break
  ...
  class Ft {
    ...
    findSubWordContaining(e) {
      ...
      let r = e
      for (; r < this.elements.length && Oe(this.elements[r]) && !Ls(this.elements[r]); ) r++
      return new B(n, r)
    }
    countLinesIn(e) {
      return (
    ...
    extendToFullLines(e) {
      const n = He(this.firstElementOffsetByLineIdx, (s) => s <= e.start) ?? 0,
        r = Ta(this.firstElementOffsetByLineIdx, (s) => e.endExclusive <= s) ?? this.elements.length
      return new B(n, r)
    }
  }
  function Oe(t) {
...
`).length >= 15 && Ya(f, (p) => p.length >= 2) >= 2
  ...
  function Ka(t, e, n, r, s, i) {
        ...
        ;(o.forEach(d, ({ range: v }) => {
          for (const E of p)
            if (
              ...
              E.modifiedLineRange.endLineNumberExclusive + 1 === x.endLineNumberExclusive
            ) {
    ...
    for (let m = 0; m < l.length; m++) {
      const p = l[m],
        b = f.findLastMonotonous((q) => q.original.startLineNumber <= p.original.startLineNumber),
        d = He(t, (q) => q.modified.startLineNumber <= p.modified.startLineNumber),
        x = Math.max(
        ...
        v = He(t, (q) => q.modified.startLineNumber < p.modified.endLineNumberExclusive),
        L = Math.max(
      ...
      ;(T > 0 &&
        (h.addRange(
          new $(p.original.endLineNumberExclusive, p.original.endLineNumberExclusive + T)
        ),
        c.addRange(
          new $(p.modified.endLineNumberExclusive, p.modified.endLineNumberExclusive + T)
        )),
        (E > 0 || T > 0) &&
          (l[m] = new ae(
            new $(p.original.startLineNumber - E, p.original.endLineNumberExclusive + T),
            new $(p.modified.startLineNumber - E, p.modified.endLineNumberExclusive + T)
          )))
    }
    return l
  }
    ...
    return (
      (e = e.filter((r) => {
        const s =
          ...
          i = He(t, (o) => o.modified.startLineNumber < r.modified.endLineNumberExclusive)
        return s !== i
      })),
      e
    )
  ...
  function n1(t, e, n) {
    ...
    for (let r = 0; r < n.length; r++) {
      const s = r > 0 ? n[r - 1] : void 0,
        ...
        o = new B(s ? s.seq1Range.endExclusive + 1 : 0, l ? l.seq1Range.start - 1 : t.length),
        u = new B(s ? s.seq2Range.endExclusive + 1 : 0, l ? l.seq2Range.start - 1 : e.length)
      i.seq1Range.isEmpty
        ? (n[r] = Cs(i, t, e, o, u))
  ...
  function Cs(t, e, n, r, s) {
    ...
    for (let h = -l; h <= o; h++) {
      const f = t.seq2Range.start + h,
        ...
        b = e.getBoundaryScore(p) + n.getBoundaryScore(f) + n.getBoundaryScore(m)
      b > c && ((c = b), (u = h))
    }
    return t.delta(u)
  }
  ...
  function Es(t, e, n, r, s = !1) {
    ...
    function u(h, f) {
      ...
      for (; i.length > 0; ) {
        const v = i[0]
        if (!(v.seq1Range.intersects(b.seq1Range) || v.seq2Range.intersects(b.seq2Range))) break
    ...
    do {
      ...
      for (let u = 1; u < r.length; u++) {
        let f = function (p, b) {
          ...
          return (
            Math.pow(Math.pow(V(v * 40 + L), 1.5) + Math.pow(V(E * 40 + T), 1.5), 1.5) +
              Math.pow(Math.pow(V(q * 40 + w), 1.5) + Math.pow(V(y * 40 + A), 1.5), 1.5) >
            (D ** 1.5) ** 1.5 * 1.3
          )
        }
        const c = r[u],
...
`)
  ...
  class l1 {
    ...
    computeDiff(e, n, r) {
      if (e.length <= 1 && Ca(e, n, (w, y) => w === y)) return new Et([], [], !1)
      ...
      const s = r.maxComputationTimeMs === 0 ? ct.instance : new Ga(r.maxComputationTimeMs),
        ...
        m =
          h.length + f.length < 1700
            ? this.dynamicProgrammingDiffing.compute(h, f, s, (w, y) =>
                e[w] === n[y] ? (n[y].length === 0 ? 0.1 : 1 + Math.log(1 + n[y].length)) : 0.99
              )
          ...
          if (i)
            for (let y = 0; y < w; y++) {
              const A = N + y,
                D = v + y
              if (e[A] !== n[D]) {
                const V = this.refineDiff(e, n, new O(new B(A, A + 1), new B(D, D + 1)), s, i, r)
    ...
    refineDiff(e, n, r, s, i, l) {
      ...
      return (
        ...
        l.extendToSubwords && (m = Es(c, h, m, (b, d) => b.findSubWordContaining(d), !0)),
        (m = r1(c, h, m)),
        (m = a1(c, h, m)),
        {
          mappings: m.map(
            (b) => new le(c.translateRange(b.seq1Range), h.translateRange(b.seq2Range))
          ),
  ...
  const z = class z {
    ...
    constructor(e) {
      if (e)
        ...
        else if (e instanceof Xe) ((this._hsva = e), (this.rgba = Xe.toRGBA(e)))
    ...
    opposite() {
      return new z(new g(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a))
    }
    mix(e, n = 0.5) {
    ...
    ;(function (e) {
      ;(function (n) {
        ...
        function f(d) {
          ...
          if (d.startsWith("rgb(")) {
            const x = d.match(/rgb\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+)\)/)
            if (!x) throw new Error("Invalid color format " + d)
            const N = parseInt(x.groups?.r ?? "0"),
              v = parseInt(x.groups?.g ?? "0"),
              L = parseInt(x.groups?.b ?? "0")
        ...
        function p(d) {
          ...
          if (x === 5) {
            const N = b(d.charCodeAt(1)),
              ...
              L = b(d.charCodeAt(3)),
              E = b(d.charCodeAt(4))
            return new t(new g(16 * N + N, 16 * v + v, 16 * L + L, (16 * E + E) / 255))
          }
          return null
        }
        n.parseHex = p
  ...
  function h1(t) {
    return !t || typeof t.getValue != "function" || typeof t.positionAt != "function" ? [] : c1(t)
  }
  const f1 = /^-+|-+$/g,
    Vs = 100,
    m1 = 5
    ...
    for (let s = 1; s <= r; s++) {
      ...
      if (l) {
        ...
        if (o.endColumn > o.startColumn) {
          const u = { range: o, ...p1(i.substring(l[0].length)), shouldBeInComments: !1 }
...
`) + 1,
          ...
          T = { startLineNumber: p, startColumn: v, endLineNumber: x, endColumn: E },
          q = (h.groups ?? {}).label ?? "",
          w = ((h.groups ?? {}).separator ?? "") !== "",
          y = { range: T, text: q, hasSeparatorLine: w, shouldBeInComments: !0 }
        ;((y.text || y.hasSeparatorLine) &&
          (n.length === 0 || n[n.length - 1].range.endLineNumber < y.range.startLineNumber) &&
          n.push(y),
  ...
  class v1 {
    ...
    $acceptNewModel(e) {
      this._models[e.url] = new N1(Me.parse(e.url), e.lines, e.EOL, e.versionId)
    }

...
` +
  ...
  const Hn = "Canceled"
  function Uo(t) {
    return t instanceof si ? !0 : t instanceof Error && t.name === Hn && t.message === Hn
  }
  ...
  ;(function (t) {
          ...
          onWillAddFirstListener() {
            X = w((V1) => {
              ;(Un++,
                ...
                (on = () => {
                  const D1 = z
                  ;((z = void 0), (Ae = void 0), (!I || Un > 1) && qn.fire(D1), (Un = 0))
                }),
                typeof C == "number"
    ...
    t.debounce = m
    function g(w, k = 0, C) {
      return t.debounce(w, (I, F) => (I ? (I.push(F), I) : [F]), k, void 0, !0, void 0, C)
    }
    t.accumulate = g
...
`)
    ...
    constructor(e) {
      ;((this._size = 0),
        ...
        (this._leakageMon = this._options?.leakWarningThreshold
          ? new Jn(e?.onListenerError ?? ln, this._options?.leakWarningThreshold ?? Qo)
          : void 0),
        (this._perfMon = this._options?._profName ? new Gn(this._options._profName) : void 0),
        ...
        (this._event ??= (e, n, r) => {
          if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
            ...
            const u = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1],
              l = new Yo(`${o}. HINT: Stack shows most frequent listener (${u[1]}-times)`, u[0])
          ...
          ;(this._leakageMon &&
            ...
            ((i.stack = Xn.create()), (s = this._leakageMon.check(i.stack, this._size + 1))),
            this._listeners
              ? this._listeners instanceof Qn
                ? ((this._deliveryQueue ??= new el()), (this._listeners = [this._listeners, i]))
          ...
          return (r instanceof Ot ? r.add(a) : Array.isArray(r) && r.push(a), a)
        }),
        this._event
      )
    }
  ...
  typeof tt.vscode < "u" && typeof tt.vscode.process < "u"
    ...
    : typeof process < "u" && typeof process?.versions?.node == "string" && (me = process)
  const sl = typeof me?.versions?.electron == "string" && me?.type === "renderer"
  if (typeof me == "object") {
    ;((Zn = me.platform === "win32"),
      (Yn = me.platform === "darwin"),
      (Kn = me.platform === "linux"),
      Kn && me.env.SNAP && me.env.SNAP_REVISION,
      me.env.CI || me.env.BUILD_ARTIFACTSTAGINGDIRECTORY || me.env.GITHUB_WORKSPACE,
      (mn = ht),
      (er = ht))
    ...
    typeof navigator == "object" && !sl
      ? (($e = navigator.userAgent),
        ...
        ($e.indexOf("Macintosh") >= 0 || $e.indexOf("iPad") >= 0 || $e.indexOf("iPhone") >= 0) &&
  ...
  ;(() => {
    if (ol) {
      ...
      return (n) => {
        const r = ++e
        ;(t.push({ id: r, callback: n }), tt.postMessage({ vscodeScheduleAsyncWork: r }, "*"))
      }
    }
  ...
  ;((Oe.ambiguousCharacterData = new tr(() =>
    ...
    (Oe._locales = new tr(() =>
      Object.keys(Oe.ambiguousCharacterData.value).filter((e) => !e.startsWith("_"))
    )))
  let Bt = Oe
  const Ft = class Ft {
    static getRawData() {
    ...
    static getData() {
      return (
        this._data || (this._data = new Set([...Object.values(Ft.getRawData())].flat())),
        this._data
      )
    }
  ...
  class Rl {
    ...
    listen(e, n, r) {
      ...
      const s = new Pe({
        ...
        onDidRemoveLastListener: () => {
          ;(this._pendingEmitters.delete(i), this._send(new kl(this._workerId, i)), (i = null))
        },
      })
      return s.event
    }
          ...
          typeof s == "string" &&
            ...
            (di(s)
              ...
              : mi(s)
                ...
                : s.charCodeAt(0) === 36 &&
                  (i[s] = async (...a) => (await n?.(), this.sendMessage(e, s, a)))),
          i[s]
        ),
      }
  ...
  class Ge {
    ...
    ComputeDiffRecursive(e, n, r, i, s) {
      ...
      if (e > n || r > i) {
        ...
        return (
          r <= i
            ? (mt.Assert(e === n + 1, "originalStart should only be one more than originalEnd"),
              (f = [new ze(e, 0, r, i - r + 1)]))
            : e <= n
              ? (mt.Assert(r === i + 1, "modifiedStart should only be one more than modifiedEnd"),
    ...
    WALKTRACE(e, n, r, i, s, a, o, u, l, h, f, m, g, d, p, y, x, v) {
      ...
      do {
        ...
        ;(T === E || (T < L && l[T - 1] < l[T + 1])
          ...
          : ((f = l[T - 1] + 1),
            ...
            (S = T - 1 - e)),
          D >= 0 && ((l = this.m_forwardHistory[D]), (e = l[0]), (E = 1), (L = l.length - 1)))
      } while (--D >= -1)
      if (((b = N.getReverseChanges()), v[0])) {
        ...
        if (b !== null && b.length > 0) {
          ...
          ;((T = Math.max(T, k.getOriginalEnd())), (w = Math.max(w, k.getModifiedEnd())))
        }
        ...
        ;((N = new yi()),
          ...
          (S = g[0] - y[0] - u),
          (P = 1073741824),
          (D = x ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2))
        do {
          const T = S + s
          ;(T === E || (T < L && h[T - 1] >= h[T + 1])
            ? ((f = h[T + 1] - 1),
            ...
            : ((f = h[T - 1]),
              ...
              (S = T - 1 - s)),
            D >= 0 && ((h = this.m_reverseHistory[D]), (s = h[0]), (E = 1), (L = h.length - 1)))
        } while (--D >= -1)
        _ = N.getChanges()
      }
    ...
    ComputeRecursionPoint(e, n, r, i, s, a, o) {
      ...
      for (let S = 1; S <= d / 2 + 1; S++) {
        ...
        for (let w = h; w <= f; w += 2) {
          ;(w === h || (w < f && y[w - 1] < y[w + 1]) ? (u = y[w + 1]) : (u = y[w - 1] + 1),
            (l = u - (w - v) - _))
          const k = u
          ...
          if (
            ...
            return (
              ...
              (a[0] = l),
              k <= x[w] && S <= 1448
                ? this.WALKTRACE(v, h, f, _, b, m, g, N, y, x, u, n, s, l, i, a, L, o)
                : null
            )
        }
        const T = (P - e + (D - r) - S) / 2
        if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(P, T))
          return (
            (o[0] = !0),
            (s[0] = P),
            (a[0] = D),
        ...
        for (let w = m; w <= g; w += 2) {
          ;(w === m || (w < g && x[w - 1] >= x[w + 1]) ? (u = x[w + 1] - 1) : (u = x[w - 1]),
            (l = u - (w - b) - N))
          const k = u
      ...
      return this.WALKTRACE(v, h, f, _, b, m, g, N, y, x, u, n, s, l, i, a, L, o)
    }
    PrettifyChanges(e) {
    ...
    ConcatenateChanges(e, n) {
      ...
      if (this.ChangesOverlap(e[e.length - 1], n[0], r)) {
        ...
        return (dt.Copy(e, 0, i, 0, e.length), dt.Copy(n, 0, i, e.length, n.length), i)
      }
    }
  ...
  class ir {
    constructor(e) {
      const n = wi(e)
      ;((this._defaultValue = n), (this._asciiMap = ir._createAsciiMap(n)), (this._map = new Map()))
    }
        ...
        for (; l < u; ) {
          ...
          if (m === 13) {
            ...
            switch (v) {
              ...
              case 34:
              case 96:
                f === v ? (b = 1) : f === 39 || f === 34 || f === 96 ? (b = 0) : (b = 1)
                break
              case 42:
                b = f === 42 ? 1 : 0
                break
            ...
            let b
            ;(v === 91 ? ((d = !0), (b = 0)) : (b = r.get(v)), b === 1 ? (x = !0) : (m = 13))
          } else ((m = n.nextState(m, v)), m === 0 && (x = !0))
          ;(x && ((m = 1), (g = !1), (d = !1), (y = !1), (h = l + 1), (f = v)), l++)
        }
  ...
  ;(function (t) {
    ...
    ;((t.isCancellationToken = e),
      (t.None = Object.freeze({ isCancellationRequested: !1, onCancellationRequested: zn.None })),
      (t.Cancelled = Object.freeze({ isCancellationRequested: !0, onCancellationRequested: xi })))
  })(gn || (gn = {}))
  class pn {
    constructor() {
  ...
  class Ol {
    ...
    cancel() {
      this._token ? this._token instanceof pn && this._token.cancel() : (this._token = gn.Cancelled)
    }
    dispose(e = !1) {
      ;(e && this.cancel(),
        this._parentListener?.dispose(),
        this._token ? this._token instanceof pn && this._token.dispose() : (this._token = gn.None))
    }
  }
  class or {
    constructor() {
  ...
  ;(function () {
    ...
    for (const i of e) {
      ...
      if ((r[a] || ((r[a] = !0), (Bl[o] = a), (Ul[o.toLowerCase()] = a)), !n[u])) {
        if (((n[u] = !0), !l))
  ...
  const fe = {
      resolve(...t) {
        ...
        for (let i = t.length - 1; i >= -1; i--) {
          ...
          if (a === 1) U(h) && ((o = 1), (l = !0))
            ...
            Ue(h) &&
              s.charCodeAt(1) === Be &&
              ((u = s.slice(0, 2)), (o = 2), a > 2 && U(s.charCodeAt(2)) && ((l = !0), (o = 3)))
          if (u.length > 0)
            if (e.length > 0) {
      ...
      normalize(t) {
        ...
        if (U(s))
          ...
          Ue(s) &&
            t.charCodeAt(1) === Be &&
            ((r = t.slice(0, 2)), (n = 2), e > 2 && U(t.charCodeAt(2)) && ((i = !0), (n = 3)))
        ...
        if (
          ...
          if (a.length >= 2 && Ue(a.charCodeAt(0)) && a.charCodeAt(1) === Be) return `.\\${a}`
          let o = t.indexOf(":")
      ...
      isAbsolute(t) {
        ...
        return U(n) || (e > 2 && Ue(n) && t.charCodeAt(1) === Be && U(t.charCodeAt(2)))
      },
      join(...t) {
      ...
      toNamespacedPath(t) {
        ...
        } else if (Ue(e.charCodeAt(0)) && e.charCodeAt(1) === Be && e.charCodeAt(2) === de)
          return `\\\\?\\${e}`
        return e
      },
      dirname(t) {
        ...
        if (U(i)) {
          ...
          Ue(i) && t.charCodeAt(1) === Be && ((n = e > 2 && U(t.charCodeAt(2)) ? 3 : 2), (r = n))
        let s = -1,
          a = !0
        for (let o = e - 1; o >= r; --o)
          if (U(t.charCodeAt(o))) {
      ...
      basename(t, e) {
        ...
        let n = 0,
          ...
          s
        if (
          (t.length >= 2 && Ue(t.charCodeAt(0)) && t.charCodeAt(1) === Be && (n = 2),
      ...
      extname(t) {
        ...
        let e = 0,
          ...
          s = !0,
          a = 0
        t.length >= 2 && t.charCodeAt(1) === Be && Ue(t.charCodeAt(0)) && (e = r = 2)
      ...
      parse(t) {
        ...
        let r = 0,
          i = t.charCodeAt(0)
        if (n === 1) return U(i) ? ((e.root = e.dir = t), e) : ((e.base = e.name = t), e)
        if (U(i)) {
    ...
    ge = {
      resolve(...t) {
        ...
        for (let r = t.length - 1; r >= 0 && !n; r--) {
          const i = t[r]
          ;(te(i, `paths[${r}]`),
            i.length !== 0 && ((e = `${i}/${e}`), (n = i.charCodeAt(0) === ae)))
        }
        if (!n) {
          const r = Yl()
      ...
      relative(t, e) {
        ...
        if (l === o)
          ...
          } else i > o && (t.charCodeAt(n + l) === ae ? (u = l) : l === 0 && (u = 0))
        let h = ""
        for (l = n + u + 1; l <= r; ++l)
          (l === r || t.charCodeAt(l) === ae) && (h += h.length === 0 ? ".." : "/..")
  ...
  let hr = class jn {
    ...
    static parse(e, n = !1) {
      const r = su.exec(e)
      return r
        ? new bt(r[2] || Z, xn(r[4] || Z), xn(r[5] || Z), xn(r[7] || Z), xn(r[9] || Z), n)
        : new bt(Z, Z, Z, Z, Z)
    }
    static file(e) {
      let n = Z
  ...
  class bt extends hr {
    ...
    toString(e = !1) {
      return e
        ? dr(this, !0)
        : (this._formatted || (this._formatted = dr(this, !1)), this._formatted)
    }
    toJSON() {
      const e = { $mid: 1 }
      return (
  ...
  function xr(t, e, n, r, i) {
    if (((e = $s(e)), i || (i = cn.first(Bs)), n.length > i.maxLen)) {
      let l = t - i.maxLen / 2
      return (l < 0 ? (l = 0) : (r += l), (n = n.substring(l, t + i.maxLen / 2)), xr(t, e, n, r, i))
    }
    const s = Date.now(),
      a = t - 1 - r
    let o = -1,
      ...
      e: for (let y = i, x = s; y <= x; y++) {
        ...
        do
          if (((m = l.next(v)), m)) {
            ...
            if (S !== 0) {
              if ((S === 3 ? g++ : S === 2 ? d++ : S === 1 ? p++ : qo(), h.length >= 1e3)) {
                f = !0
                break e
              }
        ...
        case 3: {
          const s = e.codePointAt(0),
            ...
            o = Bt.getLocales().filter(
              (u) => !Bt.getInstance(new Set([...n.allowedLocales, u])).isAmbiguous(s)
            )
  ...
  class Us {
    ...
    shouldHighlightNonBasicASCII(e, n) {
      ...
      return !i && s
        ? 0
        : this.options.invisibleCharacters && !qs(e) && Ut.isInvisibleCharacter(r)
          ? 2
...
` ||
  ...
  const Dt = class Dt {
    ...
    findLastMaxBy(e) {
      let n,
        r = !0
      return (this.iterate((i) => ((r || vr.isGreaterThan(e(i, n))) && ((r = !1), (n = i)), !0)), n)
    }
  }
  Dt.empty = new Dt((e) => {})
  let js = Dt
  ...
  const ve = class ve {
    ...
    toInclusiveRange() {
      return this.isEmpty
        ? null
        : new B(this.startLineNumber, 1, this.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER)
    }
    toExclusiveRange() {
  ...
  class Ie {
    ...
    addRange(e) {
      if (e.length === 0) return
      const n = Lr(this._normalizedRanges, (i) => i.endLineNumberExclusive >= e.startLineNumber),
        r = wt(this._normalizedRanges, (i) => i.startLineNumber <= e.endLineNumberExclusive) + 1
    ...
    subtractFrom(e) {
      const n = Lr(this._normalizedRanges, (a) => a.endLineNumberExclusive >= e.startLineNumber),
        r = wt(this._normalizedRanges, (a) => a.startLineNumber <= e.endLineNumberExclusive) + 1
      ...
      return (s < e.endLineNumberExclusive && i.push(new H(s, e.endLineNumberExclusive)), new Ie(i))
    }
    toString() {
...
`
    ...
    createRange(e) {
      return this.lineCount === 0
        ? new B(e.lineNumber, e.column, e.lineNumber, e.column + this.columnCount)
        : new B(e.lineNumber, e.column, e.lineNumber + this.lineCount, this.columnCount + 1)
    }
    toRange() {
  ...
  class Fu {
    ...
    getStringReplacement(e) {
      return new xt.deps.StringReplacement(this.getOffsetRange(e.range), e.text)
    }
    getTextReplacement(e) {
      return new xt.deps.TextReplacement(this.getRange(e.replaceRange), e.newText)
    }
    getTextEdit(e) {
...
` &&
    ...
    get textLength() {
      ...
      return new xt.deps.TextLength(e, this.text.length - this.lineStartOffsetByLineIdx[e])
    }
    getLineLength(e) {
  ...
  class Du {
    ...
    getTransformer() {
      return (this._transformer || (this._transformer = new Vu(this.getValue())), this._transformer)
    }
    getLineAt(e) {
    ...
    static joinReplacements(e, n) {
      ...
      for (let a = 0; a < e.length; a++) {
        ...
        if (((s += o.text), a < e.length - 1)) {
          const u = e[a + 1],
            l = B.fromPositions(o.range.getEndPosition(), u.range.getStartPosition()),
...
`
        ...
        i = pl(n, r),
        s = Ht.ofText(n.substring(0, i)).addToPosition(this.range.getStartPosition()),
        a = r.substring(i),
...
`
        ...
        i = bl(n, r),
        s = Ht.ofText(n.substring(0, n.length - i)).addToPosition(this.range.getStartPosition()),
  ...
  class Le {
    ...
    toRangeMapping() {
      ...
      if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
        ...
        return new Ne(
          new B(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1),
          new B(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1)
        )
      } else
        return new Ne(
          new B(
      ...
      if (!this.original.isEmpty && !this.modified.isEmpty)
        return new Ne(
          B.fromPositions(
            ...
            vt(new Q(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)
          ),
          B.fromPositions(
            new Q(this.modified.startLineNumber, 1),
            vt(new Q(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)
          )
        )
      if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
        return new Ne(
          B.fromPositions(
            vt(new Q(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), e),
            vt(new Q(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)
          ),
          B.fromPositions(
            vt(new Q(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n),
            vt(new Q(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)
          )
        )
      throw new le()
    ...
    computeDiff(e, n, r) {
      ...
      for (const u of s.changes) {
        ...
        u.originalEndLineNumber === 0
          ? (l = new H(u.originalStartLineNumber + 1, u.originalStartLineNumber + 1))
          : (l = new H(u.originalStartLineNumber, u.originalEndLineNumber + 1))
        let h
        u.modifiedEndLineNumber === 0
          ? (h = new H(u.modifiedStartLineNumber + 1, u.modifiedStartLineNumber + 1))
        ...
        ;(o &&
          ...
          ((f = new qe(
            ...
            o.innerChanges && f.innerChanges ? o.innerChanges.concat(f.innerChanges) : void 0
          )),
          a.pop()),
          a.push(f),
          (o = f))
  ...
  let Gs = class {
    constructor(e) {
      const n = [],
        r = []
      for (let i = 0, s = e.length; i < s; i++) ((n[i] = Nr(e[i], 1)), (r[i] = _r(e[i], 1)))
    ...
    static createFromDiffResult(e, n, r, i, s, a, o) {
      ...
      if (
        ...
        if (g.getElements().length > 0 && d.getElements().length > 0) {
          ...
          ;(o && (p = ju(p)), (m = []))
          for (let y = 0, x = p.length; y < x; y++) m.push(Lt.createFromDiffChange(p[y], g, d))
        }
      }
  ...
  class Wu {
    ...
    computeDiff() {
      ...
      const e = zs(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff),
        n = e.changes,
        r = e.quitEarly
        ...
        for (; s < h && a < f; ) {
          ...
          if (m !== g) {
            ...
            }
            {
              ...
              ;(d < y || p < x) && this._pushTrimWhitespaceCharChange(i, s + 1, d, y, a + 1, p, x)
            }
          }
          ;(s++, a++)
        }
        ...
        Mu(e, (i, s) => {
          r.push(
            K.fromOffsetPairs(
              ...
              s
                ? s.getStarts()
                : new We(n, (i ? i.seq2Range.endExclusive - i.seq1Range.endExclusive : 0) + n)
            )
          )
        }),
        r
...
`)
        ...
        for (let p = 0; p < n.length; p++) {
          ...
          e.getElement(d) === n.getElement(p)
            ? (d === 0 || p === 0 ? (v = 0) : (v = s.get(d - 1, p - 1)),
              d > 0 && p > 0 && a.get(d - 1, p - 1) === 3 && (v += o.get(d - 1, p - 1)),
              (v += i ? i(d, p) : 1))
            : (v = -1)
          ...
          if (b === v) {
            ...
            b === y ? (o.set(d, p, 0), a.set(d, p, 1)) : b === x && (o.set(d, p, 0), a.set(d, p, 2))
          s.set(d, p, b)
        }
      const u = []
      let l = e.length,
  ...
  class Sn {
    ...
    getBoundaryScore(e) {
      ...
      if (n === 8) return 150
      let i = 0
      return (n !== r && ((i += 10), n === 0 && r === 1 && (i += 1)), (i += Ys(n)), (i += Ys(r)), i)
    }
    ...
    findSubWordContaining(e) {
      ...
      let r = e
      for (; r < this.elements.length && Nt(this.elements[r]) && !Zs(this.elements[r]); ) r++
      return new j(n, r)
    }
    countLinesIn(e) {
      return (
    ...
    extendToFullLines(e) {
      const n = yt(this.firstElementOffsetByLineIdx, (i) => i <= e.start) ?? 0,
        r = Iu(this.firstElementOffsetByLineIdx, (i) => e.endExclusive <= i) ?? this.elements.length
      return new j(n, r)
    }
  }
  function Nt(t) {
...
`).length >= 15 && Zu(f, (g) => g.length >= 2) >= 2
  ...
  function Ku(t, e, n, r, i, s) {
    ...
    for (const m of t) {
      ...
      for (let d = m.modified.startLineNumber; d < m.modified.endLineNumberExclusive - 2; d++) {
        ...
        ;(o.forEach(p, ({ range: v }) => {
          for (const _ of g)
            if (
              _.originalLineRange.endLineNumberExclusive + 1 === v.endLineNumberExclusive &&
    ...
    for (let m = 0; m < a.length; m++) {
      const g = a[m],
        d = f.findLastMonotonous((E) => E.original.startLineNumber <= g.original.startLineNumber),
        p = yt(t, (E) => E.modified.startLineNumber <= g.modified.startLineNumber),
        y = Math.max(
        ...
        v = yt(t, (E) => E.modified.startLineNumber < g.modified.endLineNumberExclusive),
        b = Math.max(
      ...
      ;(N > 0 &&
        (h.addRange(
          new H(g.original.endLineNumberExclusive, g.original.endLineNumberExclusive + N)
        ),
        l.addRange(
          new H(g.modified.endLineNumberExclusive, g.modified.endLineNumberExclusive + N)
        )),
        (_ > 0 || N > 0) &&
          (a[m] = new Le(
            new H(g.original.startLineNumber - _, g.original.endLineNumberExclusive + N),
            new H(g.modified.startLineNumber - _, g.modified.endLineNumberExclusive + N)
          )))
    }
    return a
  }
    ...
    return (
      (e = e.filter((r) => {
        const i =
          ...
          s = yt(t, (o) => o.modified.startLineNumber < r.modified.endLineNumberExclusive)
        return i !== s
      })),
      e
    )
  ...
  function ac(t, e, n) {
    ...
    do {
      ...
      for (let u = 1; u < r.length; u++) {
        let f = function (g, d) {
          ...
          return (
            Math.pow(Math.pow(T(v * 40 + b), 1.5) + Math.pow(T(_ * 40 + N), 1.5), 1.5) +
              Math.pow(Math.pow(T(E * 40 + L), 1.5) + Math.pow(T(S * 40 + P), 1.5), 1.5) >
            (D ** 1.5) ** 1.5 * 1.3
          )
        }
        const l = r[u],
    ...
    return (
      Tu(r, (o, u, l) => {
        ...
        function f(x) {
          return (
            x.length > 0 && x.trim().length <= 3 && u.seq1Range.length + u.seq2Range.length > 100
          )
        }
        ...
        const p = K.fromOffsetPairs(o ? o.getEndExclusives() : We.zero, l ? l.getStarts() : We.max),
          y = h.intersect(p)
...
`)
  ...
  class oc {
    constructor() {
      ;((this.dynamicProgrammingDiffing = new zu()), (this.myersDiffingAlgorithm = new Xs()))
    }
    computeDiff(e, n, r) {
      if (e.length <= 1 && Ru(e, n, (L, S) => L === S)) return new vn([], [], !1)
      ...
      const i = r.maxComputationTimeMs === 0 ? Gt.instance : new Hu(r.maxComputationTimeMs),
        ...
        m =
          h.length + f.length < 1700
            ? this.dynamicProgrammingDiffing.compute(h, f, i, (L, S) =>
                e[L] === n[S] ? (n[S].length === 0 ? 0.1 : 1 + Math.log(1 + n[S].length)) : 0.99
              )
          ...
          if (s)
            for (let S = 0; S < L; S++) {
              const P = x + S,
                D = v + S
              if (e[P] !== n[D]) {
                const T = this.refineDiff(e, n, new K(new j(P, P + 1), new j(D, D + 1)), i, s, r)
    ...
    refineDiff(e, n, r, i, s, a) {
      ...
      return (
        ...
        a.extendToSubwords && (m = ia(l, h, m, (d, p) => d.findSubWordContaining(p), !0)),
        (m = rc(l, h, m)),
        (m = ac(l, h, m)),
        {
          mappings: m.map(
  ...
  class _e {
    ...
    static toRGBA(e) {
      ...
      return new A(Math.round(a * 255), Math.round(o * 255), Math.round(u * 255), s)
    }
  }
  class _t {
    constructor(e, n, r, i) {
  ...
  let An =
    ((J = class {
      ...
      opposite() {
        return new J(new A(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a))
      }
      mix(e, n = 0.5) {
        ...
        function g(p) {
          ...
          if (y === 5) {
            const x = d(p.charCodeAt(1)),
              ...
              b = d(p.charCodeAt(3)),
              _ = d(p.charCodeAt(4))
            return new t(new A(16 * x + x, 16 * v + v, 16 * b + b, (16 * _ + _) / 255))
          }
          return null
        }
        n.parseHex = g
  ...
  function uc(t, e) {
    ...
    if (n) return { range: t, color: kr(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a) }
  }
  function ua(t, e, n) {
  ...
  function fc(t) {
    return !t || typeof t.getValue != "function" || typeof t.positionAt != "function" ? [] : cc(t)
  }
  const hc = /^-+|-+$/g,
    fa = 100,
    mc = 5
    ...
    for (let i = 1; i <= r; i++) {
      ...
      if (a) {
        ...
        if (o.endColumn > o.startColumn) {
          const u = { range: o, ...bc(s.substring(a[0].length)), shouldBeInComments: !1 }
...
`) + 1,
          ...
          N = { startLineNumber: g, startColumn: v, endLineNumber: y, endColumn: _ },
          E = (h.groups ?? {}).label ?? "",
          L = ((h.groups ?? {}).separator ?? "") !== "",
          S = { range: N, text: E, hasSeparatorLine: L, shouldBeInComments: !0 }
        ;((S.text || S.hasSeparatorLine) &&
          (n.length === 0 || n[n.length - 1].range.endLineNumber < S.range.startLineNumber) &&
          n.push(S),
  ...
  class Nc {
    ...
    $acceptNewModel(e) {
      this._models[e.url] = new _c(hr.parse(e.url), e.lines, e.EOL, e.versionId)
    }
  ...
  class _c extends Lc {
    ...
    getWordAtPosition(e, n) {
      ...
      return r ? new B(e.lineNumber, r.startColumn, e.lineNumber, r.endColumn) : null
    }
    words(e) {
      const n = this._lines,
  ...
  const ut = class ut {
    ...
    async $computeMoreMinimalEdits(e, n, r) {
      ...
      n = n.slice(0).sort((u, l) => {
        if (u.range && l.range) return B.compareRangesUsingStarts(u.range, l.range)
        const h = u.range ? 0 : 1,
          f = l.range ? 0 : 1
        return h - f
      })
      ...
      e: for (const u of e) {
        ...
        if (l) {
          for (const h of l.words(a))
            if (!(h === n || !isNaN(Number(h))) && (o.add(h), o.size > ut._suggestionsLimit))
              break e
        }
      }
        ...
        case 47:
          ...
          if (t.charCodeAt(r + 1) === 42) {
            ...
            for (; r < N; ) {
              ...
              ;(r++, Qt(L) && (L === 13 && t.charCodeAt(r) === 10 && r++, o++, (l = r)))
            }
            return (E || (r++, (f = 1)), (i = t.substring(_, r)), (a = 13))
          }
          return ((i += String.fromCharCode(b)), r++, (a = 16))
        case 45:
          if (((i += String.fromCharCode(b)), r++, r === n || !St(t.charCodeAt(r)))) return (a = 16)
        case 48:
        case 49:
        case 50:
        case 51:
...
`,
  ...
  function Rc(t, e, n) {
    ...
    let h = 0,
      f = 0,
      m
    n.insertSpaces ? (m = Se[n.tabSize || 4] ?? kt(Se[1], n.tabSize || 4)) : (m = "	")
    const g = m === "	" ? "	" : " "
    let d = Mr(i, !1),
      p = !1
    function y() {
      ...
      return !l || N > ga[g][u].length ? u + kt(m, r + f) : N <= 0 ? u : ga[g][u][N]
    }
    function x() {
      let N = d.scan()
      for (h = 0; N === 15 || N === 14; )
        (N === 14 && n.keepLines ? (h += 1) : N === 14 && (h = 1), (N = d.scan()))
    ...
    for (; _ !== 17; ) {
      ...
      if (E === 2)
        ...
        switch (_) {
          case 3:
          case 1:
            ;(f++, (n.keepLines && h > 0) || !n.keepLines ? (L = y()) : (L = Se[1]))
            break
          case 5:
      ...
      E === 17 && (n.keepLines && h > 0 ? (L = y()) : (L = n.insertFinalNewline ? u : ""))
...
`.indexOf(t.charAt(e)) !== -1
  ...
  function Cc(t, e, n = kn.DEFAULT) {
    ...
    function S() {
      return r.getToken() !== 10
        ? (N(3, [], [2, 5]), !1)
        : (E(!1),
          r.getToken() === 6 ? (p(":"), _(), T() || N(4, [], [2, 5])) : N(5, [], [2, 5]),
          i.pop(),
          !0)
    }
    function P() {
    ...
    function D() {
      ...
      for (; r.getToken() !== 4 && r.getToken() !== 17; ) {
        ...
        ;(w ? (i.push(0), (w = !1)) : i[i.length - 1]++, T() || N(4, [], [4, 5]), (k = !0))
      }
  ...
  ;(function (t) {
    ...
    function n(r) {
      let i = r
      return R.objectLiteral(i) && W.is(i.range) && (R.string(i.uri) || R.undefined(i.uri))
    }
    t.is = n
  })(Et || (Et = {}))
  var Aa
  ...
  ;(function (t) {
    ...
    function n(r) {
      ...
      return (
        ...
        (R.undefined(i.additionalTextEdits) || R.typedArray(i.additionalTextEdits, Ve.is))
      )
    }
    t.is = n
  })(Ra || (Ra = {}))
  ...
  ;(function (t) {
    ...
    function n(r) {
      ...
      return (
        ...
        (R.undefined(s.relatedInformation) || R.typedArray(s.relatedInformation, Fr.is))
      )
    }
    t.is = n
  })(He || (He = {}))
  ...
  ;(function (t) {
    function e(n) {
      ...
      return (
        !!r &&
        R.objectLiteral(r) &&
        (Kt.is(r.contents) || Mn.is(r.contents) || R.typedArray(r.contents, Mn.is)) &&
  ...
  ;(function (t) {
    ...
    function n(r) {
      ...
      return (
        ...
        (i.triggerKind === void 0 || i.triggerKind === Tn.Invoked || i.triggerKind === Tn.Automatic)
      )
    }
    t.is = n
  })(Za || (Za = {}))
  ...
  ;(function (t) {
    function e(r, i, s) {
      let a = { title: r },
        o = !0
      return (
        typeof i == "string" ? ((o = !1), (a.kind = i)) : Mt.is(i) ? (a.command = i) : (a.edit = i),
        o && s !== void 0 && (a.kind = s),
        a
      )
    }
  ...
  ;(function (t) {
    ...
    function n(r) {
      let i = r
      return R.defined(i) && W.is(i.range) && (R.undefined(i.command) || Mt.is(i.command))
    }
    t.is = n
  })(Ka || (Ka = {}))
  var eo
  ...
  ;(function (t) {
    ...
    function n(r) {
      let i = r
      return R.defined(i) && W.is(i.range) && (R.undefined(i.target) || R.string(i.target))
    }
    t.is = n
  })(to || (to = {}))
  var Pn
  ;(function (t) {
    ...
    function n(r) {
      let i = r
      return R.objectLiteral(i) && W.is(i.range) && (i.parent === void 0 || t.is(i.parent))
    }
    t.is = n
  })(Pn || (Pn = {}))
  var no
  ...
  ;(function (t) {
    ...
    function n(r) {
      const i = r
      return i != null && W.is(i.range) && (R.string(i.expression) || i.expression === void 0)
    }
    t.is = n
  })(oo || (oo = {}))
  var lo
...
` &&
  ...
  class en {
    ...
    update(e, n) {
      for (let r of e)
        ...
        } else if (en.isFull(r)) ((this._content = r.text), (this._lineOffsets = void 0))
        else throw new Error("Unknown change event received")
      this._version = n
    }
    getLineOffsets() {
      return (
        this._lineOffsets === void 0 && (this._lineOffsets = wo(this._content, !0)),
        this._lineOffsets
      )
    }
    positionAt(e) {
  ...
  const Wc = {
    "color-hex": {
      errorMessage: M("Invalid color format. Use #RGB, #RGBA, #RRGGBB or #RRGGBBAA."),
  ...
  class Xr {
    ...
    include(e) {
      return (this.focusOffset === -1 || _o(e, this.focusOffset)) && e !== this.exclude
    }
    newSub() {
        ...
        (Array.isArray(e.type)
          ? e.type.some(f) ||
            n.problems.push({
              ...
              message:
                e.errorMessage || M("Incorrect type. Expected one of {0}.", e.type.join(", ")),
            })
          : e.type &&
            (f(e.type) ||
              n.problems.push({
                location: { offset: s.offset, length: s.length },
                message: e.errorMessage || M('Incorrect type. Expected "{0}".', e.type),
              })),
      ...
      if (m) {
        ...
        ;(oe(s, m, v, b, i),
          v.hasProblems() ||
            n.problems.push({
              location: { offset: s.offset, length: s.length },
              message: e.errorMessage || M("Matches a schema that is not allowed."),
            }))
        ...
        for (const E of v) {
          ...
          if ((oe(s, L, S, P, i), S.hasProblems() || _.push(L), !N))
            ...
            (N.matchingSchemas.merge(P),
              ...
              (N.validationResult.propertiesValueMatches += S.propertiesValueMatches),
              N.validationResult.mergeProcessedProperties(S))
          else {
            const D = S.compare(N.validationResult)
            D > 0
              ? (N = { schema: L, validationResult: S, matchingSchemas: P })
              : D === 0 && (N.matchingSchemas.merge(P), N.validationResult.mergeEnumValues(S))
          }
        }
        return (
          _.length > 1 &&
      ...
      if (Re(e.const)) {
        ...
        ;(Rt(v, e.const)
          ...
          : (n.problems.push({
              location: { offset: s.offset, length: s.length },
              code: G.EnumValueMismatch,
              message: e.errorMessage || M("Value must be {0}.", JSON.stringify(e.const)),
            }),
            (n.enumValueMatch = !1)),
    ...
    function u(f) {
      if (
        (ue(e.minLength) &&
          ...
          n.problems.push({
            location: { offset: f.offset, length: f.length },
            message: M("String is shorter than the minimum length of {0}.", e.minLength),
          }),
        ue(e.maxLength) &&
          Na(f.value) > e.maxLength &&
          n.problems.push({
            location: { offset: f.offset, length: f.length },
            message: M("String is longer than the maximum length of {0}.", e.maxLength),
          }),
        La(e.pattern) &&
          ...
          case "uri-reference":
            {
              ...
              if (!f.value) g = M("URI expected.")
                ...
                d
                  ? !d[2] && e.format === "uri" && (g = M("URI with a scheme is expected."))
                  : (g = M("URI is expected."))
              }
              g &&
                n.problems.push({
                  location: { offset: f.offset, length: f.length },
                  message:
                    e.patternErrorMessage || e.errorMessage || M("String is not a URI: {0}", g),
                })
            }
            break
          case "color-hex":
    ...
    function l(f) {
      ...
      if (m !== void 0) {
        ...
        for (; d < x; d++) {
          const v = m[d],
            ...
            _ = new ce(),
            N = f.items[d]
          ;(N && (oe(N, b, _, r, i), n.mergePropertyMatch(_)), n.processedProperties.add(String(d)))
        }
      }
      ...
      if (p) {
        ...
        for (let v = 0; v < f.items.length; v++) {
          ...
          ;(oe(b, p, _, tn.instance, i),
            _.hasProblems() ||
              (x++, i.schemaDraft >= Me.v2020_12 && n.processedProperties.add(String(v))))
        }
        ;(x === 0 &&
          !ue(e.minContains) &&
          n.problems.push({
            location: { offset: f.offset, length: f.length },
            message: e.errorMessage || M("Array does not contain required item."),
          }),
          ue(e.minContains) &&
            x < e.minContains &&
            n.problems.push({
        ...
        for (let x = 0; x < f.items.length; x++) {
          if (!n.processedProperties.has(String(x)))
            if (y === !1)
              ...
              const v = new ce()
              ;(oe(f.items[x], e.unevaluatedItems, v, r, i), n.mergePropertyMatch(v))
            }
      ...
      if (
        (ue(e.minItems) &&
          ...
          n.problems.push({
            location: { offset: f.offset, length: f.length },
            message: M("Array has too few items. Expected {0} or more.", e.minItems),
          }),
        ue(e.maxItems) &&
          f.items.length > e.maxItems &&
          n.problems.push({
            location: { offset: f.offset, length: f.length },
            message: M("Array has too many items. Expected {0} or fewer.", e.maxItems),
          }),
        e.uniqueItems === !0)
      ) {
        let v = function () {
    ...
    function h(f) {
        ...
        for (const b of e.required)
          if (!m[b]) {
            const _ = f.parent && f.parent.type === "property" && f.parent.keyNode,
              N = _ ? { offset: _.offset, length: _.length } : { offset: f.offset, length: 1 }
            n.problems.push({ location: N, message: M('Missing property "{0}".', b) })
          }
      }
      const d = (b) => {
                ...
                if (L) {
                  ...
                  if (Fe(S))
                    if (S) (n.propertiesMatches++, n.propertiesValueMatches++)
                      ...
                      const P = L.parent
                      n.problems.push({
                        location: { offset: P.keyNode.offset, length: P.keyNode.length },
                        message: e.errorMessage || M("Property {0} is not allowed.", E),
                      })
                    }
                  else {
                    const P = new ce()
          ...
          if (!n.processedProperties.has(_)) {
            ...
            if (N) {
              if (y === !1) {
                ...
                n.problems.push({
                  location: { offset: E.keyNode.offset, length: E.keyNode.length },
                  message: e.errorMessage || M("Property {0} is not allowed.", _),
                })
              } else if (y !== !0) {
                const E = new ce()
      ...
      if (
        (ue(e.maxProperties) &&
          ...
          n.problems.push({
            location: { offset: f.offset, length: f.length },
            message: M("Object has more properties than limit of {0}.", e.maxProperties),
          }),
        ue(e.minProperties) &&
      ...
      if (e.dependencies) for (const b in e.dependencies) m[b] && v(b, e.dependencies[b])
        ...
        if (Array.isArray(_))
          for (const N of _)
            m[N]
              ...
              : n.problems.push({
                  location: { offset: f.offset, length: f.length },
                  message: M("Object is missing property {0} required by property {1}.", N, b),
                })
        else {
          const N = xe(_)
          if (N) {
  ...
  function Yc(t, e) {
    ...
    function h() {
      switch (s.getTokenError()) {
        case 4:
          return (l(M("Invalid unicode sequence in string."), G.InvalidUnicode), !0)
        case 5:
          return (l(M("Invalid escape character in string."), G.InvalidEscapeCharacter), !0)
        case 3:
          return (l(M("Unexpected end of number."), G.UnexpectedEndOfNumber), !0)
        case 1:
          return (l(M("Unexpected end of comment."), G.UnexpectedEndOfComment), !0)
        case 2:
          return (l(M("Unexpected end of string."), G.UnexpectedEndOfString), !0)
        case 6:
          return (
            l(
              M("Invalid characters in string. Control characters must be escaped."),
              G.InvalidCharacter
            ),
            !0
          )
    ...
    function f(E, L) {
      return ((E.length = s.getTokenOffset() + s.getTokenLength() - E.offset), L && o(), E)
    }
    function m(E) {
      ...
      for (; s.getToken() !== 4 && s.getToken() !== 17; ) {
        ...
        const P = b(L)
        ;(P ? L.items.push(P) : l(M("Value expected"), G.ValueExpected, void 0, [], [4, 5]),
          (S = !0))
      }
      return s.getToken() !== 4
        ? l(M("Expected comma or closing bracket"), G.CommaOrCloseBacketExpected, L)
        : f(L, !0)
    }
    ...
    function d(E, L) {
      ...
      if (!P)
        if (s.getToken() === 16) {
          l(M("Property keys must be doublequoted"), G.PropertyKeysMustBeDoublequoted)
      ...
      if (s.getToken() === 6) ((S.colonOffset = s.getTokenOffset()), o())
        ...
        s.getToken() === 10 &&
          t.positionAt(P.offset + P.length).line < t.positionAt(s.getTokenOffset()).line)
      )
    ...
    function p(E) {
      ...
      return s.getToken() !== 2
        ? l(M("Expected comma or closing brace"), G.CommaOrCloseBraceExpected, L)
        : f(L, !0)
    }
    function y(E) {
            ...
            if (r.type === "array" && g.schema.items) {
              ...
              if (g.schema.uniqueItems) {
                ...
                ;(r.children.forEach((y) => {
                  y.type !== "array" && y.type !== "object" && p.add(this.getLabelForValue(ot(y)))
                }),
                  (d = {
                    ...a,
                    add(y) {
...
` + d
    ...
    getInsertTextForSnippetValue(e, n) {
      return (
        Zr(e, "", (i) => (typeof i == "string" && i[0] === "^" ? i.substr(1) : JSON.stringify(i))) +
        n
      )
    }
      ...
      if (n) {
        ...
        if (
          (n.enum &&
            ...
            (u += n.enum.length)),
          Re(n.const) && (o || (o = this.getInsertTextForGuessedValue(n.const, "")), u++),
          Re(n.default) && (o || (o = this.getInsertTextForGuessedValue(n.default, "")), u++),
...
\r\v":{[,]}`.indexOf(i.charAt(r)) === -1;
    ...
    fromMarkup(e) {
      if (e && this.doesSupportMarkdown()) return { kind: st.Markdown, value: e }
    }
    doesSupportMarkdown() {
        ...
        if (h && s) {
          ...
          f.every((x) => {
            if (
              ...
              x.schema &&
              ((m = m || x.schema.title),
              (g = g || x.schema.markdownDescription || Yr(x.schema.description)),
              x.schema.enum)
            ) {
              const v = x.schema.enum.indexOf(ot(s))
              ;(x.schema.markdownEnumDescriptions
                ? (d = x.schema.markdownEnumDescriptions[v])
                : x.schema.enumDescriptions && (d = Yr(x.schema.enumDescriptions[v])),
                d && ((p = x.schema.enum[v]), typeof p != "string" && (p = JSON.stringify(p))))
            }
            return !0
          })
          let y = ""
            ...
            const d = (p, y) => {
              if (n.root && g) {
                ...
                if (v && v.keyNode.value === "$schema") {
                  ...
                  const b = W.create(e.positionAt(x.offset), e.positionAt(x.offset + 1))
                  o(He.create(b, p, g, y))
                }
              }
            }
          ...
          if (g.type === "object") {
            for (const d of g.properties)
              if (d.keyNode.value === "key" && d.valueNode) {
                ...
                if (
                  (m.push({ name: Mo(d.valueNode), kind: De.Function, location: p }), s--, s <= 0)
                )
        ...
        470: (i) => {
          ...
          var o = {
            ...
            relative: function (u, l) {
              ...
              for (var d = l.length - g, p = m < d ? m : d, y = -1, x = 0; x <= p; ++x) {
                if (x === p) {
                  if (d > p) {
                    if (l.charCodeAt(g + x) === 47) return l.slice(g + x + 1)
                    if (x === 0) return l.slice(g + x)
                  } else m > p && (u.charCodeAt(h + x) === 47 ? (y = x) : x === 0 && (y = 0))
                  break
                }
              ...
              var b = ""
              for (x = h + y + 1; x <= f; ++x)
                (x !== f && u.charCodeAt(x) !== 47) || (b.length === 0 ? (b += "..") : (b += "/.."))
              return b.length > 0
                ? b + l.slice(g + y)
            ...
            parse: function (u) {
              ...
              var h,
                ...
                m = f === 47
              m ? ((l.root = "/"), (h = 1)) : (h = 0)
              for (var g = -1, d = 0, p = -1, y = !0, x = u.length - 1, v = 0; x >= h; --x)
                if ((f = u.charCodeAt(x)) !== 47)
                  (p === -1 && ((y = !1), (p = x + 1)),
                    f === 46 ? (g === -1 ? (g = x) : v !== 1 && (v = 1)) : g !== -1 && (v = -1))
                else if (!y) {
                  d = x + 1
                  break
                }
              return (
                g === -1 || p === -1 || v === 0 || (v === 1 && g === p - 1 && g === d + 1)
    ...
    ;((() => {
      ...
      class m {
        ...
        static parse(w, k = !1) {
          const C = f.exec(w)
          return C
            ? new d(C[2] || l, E(C[4] || l), E(C[5] || l), E(C[7] || l), E(C[9] || l), k)
            : new d(l, l, l, l, l)
        }
        static file(w) {
          let k = l
        ...
        static revive(w) {
          if (w) {
            ...
            {
              const k = new d(w)
              return ((k._formatted = w.external), (k._fsPath = w._sep === g ? w.fsPath : null), k)
            }
          }
          return w
        }
      ...
      function y(T, w, k) {
        ...
        for (let F = 0; F < T.length; F++) {
          ...
          if (
            ...
            const q = p[V]
            q !== void 0
              ? (I !== -1 && ((C += encodeURIComponent(T.substring(I, F))), (I = -1)), (C += q))
              : I === -1 && (I = F)
          }
        }
      ...
      function b(T, w) {
        ...
        if ((I && ((C += I), (C += ":")), (F || I === "file") && ((C += h), (C += h)), F)) {
          ...
          ;((F = F.toLowerCase()),
            (z = F.lastIndexOf(":")),
            z === -1 ? (C += k(F, !1, !0)) : ((C += k(F.substr(0, z), !1, !0)), (C += F.substr(z))))
        }
        if (V) {
          if (V.length >= 3 && V.charCodeAt(0) === 47 && V.charCodeAt(2) === 58) {
            const z = V.charCodeAt(1)
            z >= 65 && z <= 90 && (V = `/${String.fromCharCode(z + 32)}:${V.substr(3)}`)
          } else if (V.length >= 2 && V.charCodeAt(1) === 58) {
            const z = V.charCodeAt(0)
            z >= 65 && z <= 90 && (V = `${String.fromCharCode(z + 32)}:${V.substr(2)}`)
          }
          C += k(V, !0, !1)
        }
        return (
      ...
      ;(function (T) {
        ;((T.joinPath = function (w, ...k) {
          ...
          (T.resolvePath = function (w, ...k) {
            ...
            C[0] !== P && ((C = P + C), (I = !0))
            let F = S.resolve(C, ...k)
            return (I && F[0] === P && !w.authority && (F = F.substring(1)), w.with({ path: F }))
          }),
          (T.dirname = function (w) {
            if (w.path.length === 0 || w.path === P) return w
            let k = S.dirname(w.path)
            return (k.length === 1 && k.charCodeAt(0) === 46 && (k = ""), w.with({ path: k }))
          }),
  ...
  class m1 {
    constructor(e, n, r) {
      ...
      try {
        ...
        n && ((n = Co(n)), n.endsWith("/") || (n = n + "/"), (this.folderUri = n))
      } catch {
    ...
    getSectionRecursive(e, n) {
      ...
      if (n.patternProperties) {
        for (const i of Object.keys(n.patternProperties))
          if (Rn(i)?.test(r)) return this.getSectionRecursive(e, n.patternProperties[i])
      } else {
  ...
  class g1 {
    ...
    loadSchema(e) {
      if (!this.requestService) {
        const n = M("Unable to load schema from '{0}'. No schema request service available", rn(e))
      ...
      return (
        ...
        this.requestService(e).then(
          (n) => {
            if (!n) {
              const a = M("Unable to load schema from '{0}': No content.", rn(e))
              return new nn({}, [a])
            }
            const r = []
          ...
          (n) => {
            ...
            return (
              ...
              new nn({}, [M("Unable to load schema from '{0}': {1}.", rn(e), r)])
            )
          }
        )
      )
    ...
    resolveSchemaContent(e, n) {
      ...
      if (s === "http://json-schema.org/draft-03/schema")
        return this.promise.resolve(new Po({}, [M("Draft-03 schemas are not supported.")], [], s))
      let a = new Set()
      const o = this.contextService,
        u = (p, y) => {
          ...
          return (
            ...
            y
              .split("/")
              .some((v) => ((v = v.replace(/~1/g, "/").replace(/~0/g, "~")), (x = x[v]), !x)),
            x
          )
        },
        l = (p, y, x) => (y.anchors || (y.anchors = d(p)), y.anchors.get(x)),
        h = (p, y) => {
          for (const x in y) y.hasOwnProperty(x) && x !== "id" && x !== "$id" && (p[x] = y[x])
        },
        f = (p, y, x, v) => {
          let b
          ;(v === void 0 || v.length === 0
            ...
            : v.charAt(0) === "/"
              ? (b = u(y, v))
              : (b = l(y, x, v)),
            b ? h(p, b) : r.push(M("$ref '{0}' in '{1}' can not be resolved.", v || "", x.uri)))
        },
        m = (p, y, x, v) => {
          ;(o &&
          ...
          return b.getUnresolvedSchema().then((_) => {
            if ((v.dependencies.add(y), _.errors.length)) {
              const N = x ? y + "#" + x : y
              r.push(M("Problems loading reference '{0}': {1}", N, _.errors[0]))
            }
        ...
        d = (p) => {
          ...
          return (
            this.traverseNodes(p, (x) => {
              ...
              ;(b && (y.has(b) ? r.push(M("Duplicate anchor declaration: '{0}'", b)) : y.set(b, x)),
    ...
    traverseNodes(e, n) {
      ...
      const r = new Set(),
        ...
        a = (...h) => {
          for (const f of h) if (Array.isArray(f)) for (const m of f) Ze(m) && u.push(m)
        },
        o = (h) => {
      ...
      switch (o) {
        ...
        case 13: {
          ...
          a.getTokenError() === 1 && d + 1 < t.lineCount
            ...
            : d < p && (u({ startLine: d, endLine: p, kind: Yt.Comment }), (s = d))
          break
        }
        case 12: {
          const p = t
...
`,
    ...
    return Oc(t.getText(), r, i).map((s) =>
      Ve.replace(W.create(t.positionAt(s.offset), t.positionAt(s.offset + s.length)), s.content)
    )
  }
  var se
  ;(function (t) {
  ...
  function v1(t, e) {
    const n = { ...e, keepLines: !1 },
      ...
      o = ei(a, n, void 0),
      u = Ee.applyEdits(a, o)
    return [Ve.replace(W.create(ee.create(0, 0), t.positionAt(t.getText().length)), u)]
  }
  function L1(t) {
    const e = t.getText(),
      n = it(e, !1)
    let r = new Fn(),
      ...
      v = !1
    for (; (o = n.scan()) !== 17; ) {
      if (x === !0 && o !== 14 && o !== 15 && o !== 12 && o !== 13 && s.endLineNumber === void 0) {
      ...
      for (let o = 0; o < s.length; o++) {
        ...
        if (u.lastProperty === !0 && o !== s.length - 1) {
          ...
          const d = u.commaIndex,
            ...
            x = { range: W.create(ee.create(y, d), ee.create(y, d + 1)), text: "" }
          Ee.update(f, [x], 1)
        }
  ...
  function Fo(t, e, n) {
    for (const r of e.childrenProperties) {
      if (r.type === se.Object) {
        ...
        t.push(new Vo(n + r.beginningLineNumber - e.beginningLineNumber + s, r.childrenProperties))
      }
      r.type === se.Array && Fo(t, r, n + r.beginningLineNumber - e.beginningLineNumber)
    }
  }
  class Vo {
    constructor(e, n) {
  ...
  function k1(t) {
    return t === "#" ? [] : t[0] !== "#" || t[1] !== "/" ? null : t.substring(2).split(/\//).map(R1)
  }
  function R1(t) {
  ...
  class M1 {
    ...
    _getTextDocument(e) {
      ...
      for (let r of n)
        if (r.uri.toString() === e) return Ee.create(e, this._languageId, r.version, r.getValue())
      return null
    }
  }
  const T1 = 47,
  ...
  function Oo(t) {
    ...
    for (const r of t)
      r.length === 0 ||
        ...
        (r.length === 2 && r.charCodeAt(0) === ni && r.charCodeAt(1) === ni ? e.pop() : e.push(r))

define("vs/nls.messages.it.js", ["./_commonjsHelpers-CT9FvmAN"], function (o) {
  "use strict"
  var e = {}
  /*!-----------------------------------------------------------
    ...
    return (
      i ||
        ...
        (globalThis._VSCODE_NLS_MESSAGES = [
          ...
          "Seleziona tutto",
          "Seleziona tutto",
          "Usa rendering basato su DOM",
          "Indica se i completamenti inline sono rinviati",
          "Selezionare la durata della sospensione per i suggerimenti inline",
          "Rinvia suggerimenti inline",
          "Annulla il rinvio dei suggerimenti inline",
          ...
          "Controlla se deve essere attivata l'analisi di Tree-sitter e se acquisire i dati di telemetria. L’impostazione di 'editor.experimental.preferTreeSitter' per linguaggi specifici avrà la precedenza.",
          "Controlla se deve essere attivata l'analisi Tree-sitter per css. Ciò avrà la precedenza su 'editor.experimental.treeSitterTelemetry' per css.",
          "Controlla se deve essere attivata l'analisi Tree-sitter per TypeScript. Ciò avrà la precedenza su 'editor.experimental.treeSitterTelemetry' per TypeScript.",
          "Controlla se deve essere attivata l'analisi Tree-sitter per ini. Ciò avrà la precedenza su 'editor.experimental.treeSitterTelemetry' per ini.",
          "Controlla se deve essere attivata l'analisi Tree-sitter per regex. Ciò avrà la precedenza su 'editor.experimental.treeSitterTelemetry' per regex.",
          ...
          "Se questa opzione è abilitata, nell'editor diff viene visualizzata una barra di navigazione speciale per le azioni di ripristino e anteprima.",
          ...
          "Se questa opzione è abilitata e l'editor usa la visualizzazione inline, verrà eseguito il rendering delle modifiche delle parole inline.",
          ...
          "Non archiviare la cronologia di ricerca dal widget di ricerca.",
          "Archivia la cronologia di ricerca nell'area di lavoro attiva",
          "Controlla la modalità di archiviazione della cronologia del widget di ricerca",
          "Non archiviare la cronologia dal widget di sostituzione.",
          "Archivia la cronologia di ricerca nell'area di lavoro attiva",
          "Controlla come deve essere archiviata la cronologia del widget di ricerca",
          "Controlla se il widget Trova deve cercare mentre digiti.",
          ...
          "Abilita lo scorrimento permanente con la barra orizzontale dell'editor.",
          "Abilita i suggerimenti per l'inlay nell'editor.",
          "I suggerimenti per l'inlay sono abilitati",
          "I suggerimenti per l'inlay vengono visualizzati per impostazione predefinita e vengono nascosti quando si tiene premuto {0}",
          "I suggerimenti per l'inlay sono nascosti per impostazione predefinita e vengono visualizzati solo quando si tiene premuto {0}",
          "I suggerimenti per l'inlay sono disabilitati",
          "Controlla le dimensioni del carattere dei suggerimenti per l'inlay nell'editor. Per impostazione predefinita, {0} viene usato quando il valore configurato è minore di {1} o maggiore delle dimensioni del carattere dell'editor.",
          "Controlla la famiglia di caratteri dei suggerimenti per l'inlay nell'editor. Se impostato su vuoto, viene usato {0}.",
          "Abilita il riempimento attorno ai suggerimenti per l'inlay nell'editor.",
          "Lunghezza complessiva massima dei suggerimenti per l'inlay, per una singola riga, prima che vengano troncati dall'editor. Impostare su `0` per non troncare mai",
 ...
 - I valori maggiori o uguali a 8 verranno usati come valori effettivi.`,
          ...
          "La minimappa è sempre visibile.",
          "La minimappa viene nascosta quando il mouse non si trova su di essa e viene visualizzata quando invece si trova su di essa.",
          "La minimappa viene visualizzata solo quando si scorre l'editor",
          ...
          "Controlla se mostrare l'evidenziazione della sintassi per i suggerimenti inline nell'editor.",
          ...
          "Gestisce la sospensione dei suggerimenti inline in modalità frammento.",
          "Controlla il ritardo minimo in millisecondi dopo il quale vengono visualizzati i suggerimenti inline dopo la digitazione.",
          "Disabilita i completamenti inline per gli ID estensione specificati separati da virgola.",
          "Gestisce l'invio delle informazioni sulla richiesta dal provider di suggerimenti inline.",
          "Controlla se attivare un comando quando cambia il provider di suggerimenti inline.",
          "Controlla se mostrare suggerimenti inline quando si verifica un conflitto di suggerimenti.",
          "Controlla la famiglia di caratteri dei suggerimenti inline.",
          "Controlla se la visualizzazione di un suggerimento sposterà il codice per fare spazio al suggerimento inline.",
          "Controlla se i suggerimenti più grandi possono essere visualizzati affiancati.",
          "I suggerimenti più grandi verranno mostrati visualizzati affiancati se lo spazio è sufficiente, altrimenti verranno mostrati di seguito.",
          "I suggerimenti più grandi non vengono mai mostrati affiancati e verranno sempre mostrati di seguito.",
          "Controlla se il suggerimento verrà visualizzato come compresso fino a quando non viene visualizzato.",
          ...
          "Controlla se consentire l'uso di altezze di riga variabili nell'editor.",
          "Controlla se consentire l'uso di tipi di carattere variabili nell'editor.",
          "Controlla se consentire l'uso di tipi di carattere variabili nell'editor in modalità di accessibilità.",
          "Contenuto editor",
          ...
          "Controlla se l'editor deve applicare automaticamente il rientro del contenuto incollato.",
          "Controlla se l'editor deve applicare automaticamente il rientro del contenuto incollato all'interno di una stringa. Questa impostazione ha effetto quando autoIndentOnPaste è true.",
          ...
          "Controlla lo stile del cursore in modalità di inserimento input.",
          "Controlla lo stile del cursore in modalità di inserimento input in sovrascrittura.",
          ...
          `Controlla l'altezza del cursore quando "#editor.cursorStyle#" è impostato su "line". L'altezza massima del cursore dipende dall'altezza della riga.`,
          "Controlla se l'editor deve consentire lo spostamento di selezioni tramite trascinamento della selezione.",
          "Indica se utilizzare l'API EditContext invece dell'area di testo per gestire l'input nell'editor.",
          "Indica se eseguire il rendering di contenuti avanzati dell'utilità per la lettura dello schermo quando è abilitata l'opzione 'editor.editContext'.",
          "Usa il rendering regolare basato su DOM.",
          "Usa accelerazione GPU.",
          "Controlla se usare l'accelerazione GPU sperimentale per il rendering dell'editor.",
          ...
          "Rendere lo scorrimento inerziale, particolarmente utile con il touchpad in Linux.",
          ...
          "Controlla cosa succede quando si clicca il pulsante centrale del mouse nell'editor.",
          ...
          "Controlla il ritardo in millisecondi dopo il quale vengono evidenziate le occorrenze.",
          "Controlla se l'operazione Incolla deve sovrascrivere.",
          ...
          "Deprecato. In alternativa, sa 'editor.linkedEditing'.",
          ...
          "Controlla se l'editor scorrerà quando si preme il pulsante centrale.",
          ...
          "Controlla il numero di caratteri che possono essere presenti nella selezione prima che non vengano più evidenziate le corrispondenze simili. Impostare su zero per indicare un numero illimitato.",
          "Controlla se l'editor deve evidenziare corrispondenze di selezione che si estendono su più righe.",
          ...
          "Controlla se l'editor eliminerà anche lo spazio vuoto di rientro della riga successiva durante l'eliminazione di una nuova riga.",
          ...
          'Controlla se il valore letterale `\\n` deve attivare un ritorno a capo automatico quando `#editor.wordWrap#` è abilitato.\r\n\r\nAd esempio:\r\n```c\r\nchar* str="hello\\nworld"\r\n```\r\nverrà visualizzato come\r\n```c\r\nchar* str="hello\\n\r\n           world"\r\n```',
          "Mostra gli elementi Decorator colore predefiniti solo quando nessuna estensione fornisce elementi Decorator a colori.",
          "Mostra sempre gli elementi Decorator a colori predefiniti.",
          "Non mostrare mai elementi Decorator a colori predefiniti.",
          ...
          "Il colore dei cursori dell'editor primario quando sono presenti più cursori.",
          "Il colore di sfondo dei cursori dell'editor primario quando sono presenti più cursori. Permette di personalizzare il colore di un carattere quando sovrapposto da un blocco cursore.",
          "Colore dei cursori dell'editor secondario quando sono presenti più cursori.",
          "Il colore di sfondo dei cursori dell'editor secondario quando sono presenti più cursori. Permette di personalizzare il colore di un carattere quando sovrapposto da un blocco cursore.",
          ...
          "Indica se la modalità inline è attiva",
          "Indica se la modifica è scrivibile nell'editor diff",
          "Indica se la modifica è scrivibile nell'editor diff",
          ...
          "Azione origine...",
          "Organizza import",
          'Organizza le importazioni nel file corrente. Questa opzione viene chiamata anche "Ottimizza importazioni" da alcuni strumenti',
          "Correggi tutto",
          ...
          "Abilitare l'attivazione {0} quando {1} è impostato su {2}. Le azioni codice devono essere impostate su {3} per essere attivate per le modifiche della finestra e dello stato attivo.",
          ...
          "Racchiudi tra",
          "Azione di origine",
          "Icona che genera il menu delle azioni codice dalla barra di navigazione quando non è presente spazio nell'editor.",
          "Icona che genera il menu delle azioni codice dalla barra di navigazione quando non c'è spazio nell'editor ed è disponibile una rapida.",
          "Icona che genera il menu delle azioni codice dalla barra di navigazione quando non c'è spazio nell'editor ed è disponibile una correzione con l'intelligenza artificiale.",
          "Icona che genera il menu delle azioni codice dalla barra di navigazione quando non c'è spazio nell'editor e sono disponibili una correzione con l'intelligenza artificiale e una correzione rapida.",
          "Icona che genera il menu delle azioni codice dalla barra di navigazione quando non c'è spazio nell'editor e sono disponibili una correzione con l'intelligenza artificiale e una correzione rapida.",
          "Esegui: {0}",
          ...
          "Mostra comandi CodeLens per la riga corrente",
          "Icona per chiudere la selezione colori",
          "Fare clic per attivare/disattivare le opzioni di colore (rgb/hsl/hex)",
          "Qui è disponibile una selezione colori.",
          "&&Mostra o sposta lo stato attivo su selezione colori autonoma",
          "Mostra o sposta lo stato attivo su selezione colori autonoma",
          "Mostrare o spostare lo stato attivo su una selezione colori autonoma che usa il provider di colori predefinito. Visualizza i colori hex/rgb/hsl.",
          "Nascondi selezione colori",
          "Nascondere la selezione colori autonoma.",
          "Inserisci colore con selezione colori autonoma",
          "Inserire colori hex/rgb/hs con la selezione colori autonoma con lo stato attivo.",
...
Esistono più modifiche per questo tipo; l'editor mostrerà una selezione. Se non esistono modifiche di questo tipo, l'editor mostrerà un messaggio di errore.`,
          `Elenco del tipo di modifica di incollaggio preferito per provare l'applicazione.\r
Verrà applicata la prima modifica corrispondente alle preferenze.`,
          ...
          "Risoluzione della modifica incolla per '{0}'. Fare clic per annullare",
          "Esecuzione dei gestori incolla. Fare clic per annullare ed eseguire incolla di base",
          "Configura l’azione Incolla predefinita",
...
{1}`,
          ...
          "Attiva/Disattiva importazione riduzione",
          "Livello riduzione {0}",
          ...
          "Simbolo {0} di {1}",
          "Statistiche foglio texture log",
          "Salva foglio texture",
          "Disegna glifo",
          "Sviluppatore: debug renderer GPU editor",
          ...
          "Esegui il comando",
          "Attiva un suggerimento inline nell'editor.",
          "Opzioni di attivazione dei suggerimenti inline.",
          "Nessun suggerimento inline disponibile.",
          "Accetta parola",
          "Accetta riga",
          "Accetta",
          "Accetta",
          ...
          "Sviluppatore: estrai stato suggerimenti inline",
          ...
          "Passa alla modifica inline successiva",
          "Nascondi suggerimento inline",
          "Mostra/Nascondi suggerimenti inline - Mostra compressi",
          ...
          "Indica se il cursore si trova su testo fantasma",
          "Indica se il cursore è in rientro",
          "Indica se l'editor ha una selezione",
          "Indica se il cursore si trova in corrispondenza di una modifica inline",
          "Indica se una modifica inline è visibile",
          "Controlla se la scheda deve passare direttamente a una modifica inline.",
          "Controlla se la scheda deve accettare la modifica inline.",
          "Indica se l'editor di codice corrente mostra un'anteprima delle modifiche incorporate",
          "Ispezionarlo nella visualizzazione accessibile ({0})",
          "Qui sono disponibili completamenti inline",
          "Suggerimento:",
          ...
          "Impostazioni",
          null,
          "Colore di sfondo per il testo originale nelle modifiche incorporate.",
          "Colore di sfondo per il testo modificato nelle modifiche incorporate.",
          "Colore di sfondo per le righe modificate nel testo originale delle modifiche incorporate.",
          "Colore sovrapposto per il testo modificato nel testo originale delle modifiche inline.",
          "Colore di sfondo per le righe modificate nel testo modificato delle modifiche inline.",
          "Colore sovrapposto per il testo modificato nel testo modificato delle modifiche inline.",
          "Colore primo piano per l'indicatore di navigazione di modifica inline principale.",
          "Colore del bordo per l'indicatore principale di modifica inline.",
          "Colore di sfondo per l'indicatore di navigazione di modifica inline principale.",
          "Colore primo piano per l'indicatore di navigazione di modifica inline secondario.",
          "Colore del bordo per l'indicatore secondario di modifica inline.",
          "Colore di sfondo per l'indicatore di navigazione di modifica inline secondario.",
          "Colore primo piano per l'indicatore di navigazione di modifica inline riuscito.",
          "Colore del bordo per l'indicatore di riuscita della modifica inline.",
          "Colore di sfondo per l'indicatore di navigazione di modifica inline riuscito.",
          "Colore di sfondo per l'indicatore di navigazione di modifica inline.",
          "Colore del bordo per il testo originale nelle modifiche incorporate.",
          "Colore del bordo per il testo modificato nelle modifiche incorporate.",
          "Colore del bordo modificato per il widget delle modifiche inline quando la scheda lo accetterà.",
          "Colore del bordo originale per il widget delle modifiche inline sul testo originale quando la scheda lo accetterà.",
          ...
          "Aggiungi cursori in basso",
          "Aggiungi cursori in alto",
          ...
          "Colore di sfondo della parte di rilegatura della barra di scorrimento permanente nell'editor di visualizzazione rapida.",
          ...
          null,
          "Usa offset basato su zero",
          "Aprire prima un editor di testo per passare a una riga o an offset.",
          "Digitare la posizione del carattere a cui passare (da 0 a {0}).",
          "Digitare la posizione del carattere a cui passare (da 1 a {0}).",
          "Premere 'INVIO' per passare alla riga {0} nella colonna {1}.",
          "Digitare un numero di riga a cui passare (da 1 a {0}).",
          "Premere 'INVIO' per passare alla riga {0} o immettere due punti (:) per aggiungere un numero di colonna.",
          "Premere 'INVIO' per passare alla riga {0} o immettere un numero di colonna (da 1 a {1}).",
          "Premere 'INVIO' per passare alla riga {0} nella colonna {1}.",
          ...
          "&&Scorrimento permanente",
          "&&Focus sullo scorrimento permanente dell'editor",
          "Attiva/disattiva scorrimento permanente dell'editor",
          ...
          "Focus sullo scorrimento permanente dell'editor",
          "Seleziona la riga di scorrimento permanente successiva dell'editor",
          "Seleziona la riga di scorrimento permanente precedente",
          "Vai alla riga di scorrimento permanente con stato attivo",
          ...
          "Altre informazioni",
          "Chiave di contesto true alla fine di una parola. Si noti che questa opzione è definita solo quando sono abilitati i completamenti a schede",
          ...
          "Determina se il tasto TAB sposta lo stato attivo intorno all'area di lavoro o inserisce il carattere di tabulazione nell'editor corrente. È anche denominato intercettazione delle tabulazioni, spostamento tra le tabulazioni, o modalità focus delle tabulazioni.",
          ...
          "Annulla modifiche",
          "Modifiche annullate",
          "È richiesta un'azione dell'utente chat",
          "È richiesta un'azione dell'utente chat",
          "Visualizza",
          "Guida",
          "Test",
...
[{1}] {2}`,
          ...
          "Configura le impostazioni di cui eseguire l'override per {0}.",
...
Ricevuto: '{1}'.`,
          ...
          "Controlla il numero di elementi permanenti visualizzati nell'albero quando {0} è abilitato.",
          ...
          'I problemi sono sospesi perché: "{0}"',
          'I problemi sono sospesi perché: "{0}" e altri {1}',
          "usate di recente",
          "comandi simili",
          "più usato",
          "altri comandi",
          ...
          "L'allineamento dell'inserimento rapido",
          ...
          "OK",
          "{0} (premere 'INVIO' per confermare oppure 'ESC' per annullare)",
          "Usato nel contesto di qualsiasi tipo di input rapido. Se si modifica un tasto di scelta rapida per questo comando, è necessario modificare anche tutti gli altri tasti di scelta rapida (varianti del modificatore) di questo comando.",
          ...
          "Usato nel contesto di un input rapido. Se si modifica un tasto di scelta rapida per questo comando, è necessario modificare anche tutti gli altri tasti di scelta rapida (varianti del modificatore) di questo comando.",
          ...
          "Colore di sfondo della parte di rilegatura della barra di scorrimento permanente nell'editor",
          "Colore di sfondo della barra di scorrimento permanente al passaggio del mouse nell'editor",
          "Colore del bordo della barra di scorrimento permanente nell'editor",
          " Colore ombreggiatura della barra di scorrimento permanente nell'editor",
          ...
          "Colore del bordo per una composizione IME.",
          ...
          "Sfondo di una casella di controllo disabilitata.",
          ...
          "Colore primo piano della notifica dell'attività di avviso",
          "Colore di sfondo della notifica dell'attività di avviso",
          "Colore primo piano della notifica dell'attività di errore",
          "Colore di sfondo della notifica dell'attività di errore",
          ...
          "Colore della linea per il grafico.",
          "Colore dell'asse del grafico.",
          "Linea di guida per il grafico.",
          ...
          "Questo colore deve essere trasparente, altrimenti oscurerà il contenuto",
          "Usare il colore predefinito.",
          "L'ID carattere deve contenere solo lettere, numeri, caratteri di sottolineatura e trattini.",
  ...
  var l = a()
  return o.getDefaultExportFromCjs(l)
})

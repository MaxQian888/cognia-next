...
/// Public across the crate boundary (ADR-0067): `codeserver::profile` and
/// `codeserver::process` read JSONC settings through it, and they stayed in
/// `app_lib` when this module moved out.

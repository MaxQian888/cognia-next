 ...
 * (flat keys from plugin.json, prefixed `plugin.strix-security.`), so components
...
export function registerStrixBundle(): void {
...
export function unregisterStrixBundle(): void {

 ...
 */
declare const OPENROUTER_CATALOG_STALE_MS: number
/** Wire the host's Dexie-backed catalog store. Called once at app boot. */
declare function setOpenRouterCatalogDb(db: OpenRouterCatalogDb): void
declare function getOpenRouterCatalog(): Promise<OpenRouterCatalogRow | undefined>
declare function saveOpenRouterCatalog(
  input: Parameters<OpenRouterCatalogDb["saveOpenRouterCatalog"]>[0]
): Promise<OpenRouterCatalogRow>
declare function isOpenRouterCatalogStale(maxAgeMs?: number, now?: number): Promise<boolean>

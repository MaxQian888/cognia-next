...
declare const DEFAULT_MIN_REQUEST_VOLUME = 10
/** Default upper clamp for Retry-After-derived cooldowns. */
declare const DEFAULT_MAX_COOLDOWN_MS = 600000
...
declare const INITIAL_CIRCUIT_BREAKER_STATE: CircuitBreakerState
...
interface CircuitBreakerRecordOptions {
...
interface CircuitBreakerFailureOptions extends CircuitBreakerRecordOptions {
...
export {
  ...
  type CircuitBreakerFailureOptions,

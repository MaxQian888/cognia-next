...
const REFACTOR_PLAYBOOK = defineSkill({
  ...
  source: {
    ...
    markdown: [
      ...
      "- Keep diffs small and reviewable; one module/concern per step. Do not commit: the pipeline commits after review and approval.",
      "",
      "## Never",
      "- Never weaken, skip, or delete a test to make it pass.",
      "- Never mix a rename/move with a logic change in the same step.",

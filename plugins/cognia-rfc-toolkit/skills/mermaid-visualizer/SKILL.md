...
description: Generate syntactically correct and visually clear Mermaid diagrams (flowcharts, sequence diagrams, state diagrams, mind maps, architecture diagrams). Use whenever a Mermaid code block is needed in Markdown, docs, or chat — the user asks for a diagram, mentions mermaid, or another skill (e.g. rfc-write-plan) needs to emit one. Built-in syntax-correction rules prevent common parse errors. Do not use for non-Mermaid output (images, excalidraw, drawio).
---
...
For complete syntax reference and edge cases, read `${COGNIA_PLUGIN_ROOT}/skills/mermaid-visualizer/references/syntax-rules.md`
...
For detailed syntax rules and troubleshooting, read:

- `${COGNIA_PLUGIN_ROOT}/skills/mermaid-visualizer/references/syntax-rules.md` - Complete syntax reference and error prevention

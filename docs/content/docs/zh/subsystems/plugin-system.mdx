...
5 张插件表在 [Dexie schema v15 引入](../data/storage)，并在后续版本中无修改地保留。
...
<Cards>
  <Card title="设置 UI" href="../ui/settings-ui" description="插件设置入口、扩展点的可视形态" />
  <Card title="技能系统" href="../chat/skills-system" description="插件可贡献内置技能与资源" />

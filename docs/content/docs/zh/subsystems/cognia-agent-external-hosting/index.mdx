...
# 通过 Zed ACP adapter 运行 Claude Code
...
`npx -y @zed-industries/claude-code-acp`。虽然 flag 接受 preset id，CLI process host 还会
应用 executable/package allowlist；Codex 与 Claude Code 是 v1 已验证目标。

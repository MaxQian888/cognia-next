...
<Cards>
  ...
  <Card title="Rust 层" href="./rust-layer" description="axum webhook 接收器、5 个签名校验器、OneBot 反向 WS 桥、Lark protobuf 长连接、媒体上传、AES-256-GCM 附件缓存、OS keyring、21 个 Tauri 命令" />

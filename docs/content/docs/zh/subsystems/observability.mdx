...
<Cards>
  <Card title="开发" href="../dev/development" description="本地调试 + 在浏览器/Tauri 控制台读日志" />
  <Card title="插件系统" href="./plugin-system" description="插件日志走哪个 origin" />
  <Card title="存储" href="../data/storage" description="IndexedDB 里日志表的位置" />
  <Card title="运行时 & Tauri" href="../core/runtime-and-tauri" description="log://log 事件 + 命令接口" />
</Cards>

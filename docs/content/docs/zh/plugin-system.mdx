...
5 张插件表在 [Dexie schema v15 引入](./storage#v15-插件表)，并在后续版本中无修改地保留至 v26。
...
| 调整市场 UX       | `components/plugin/`、`lib/plugin/package/`                              |

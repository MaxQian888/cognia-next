...
Dexie v160 新增 profile、generation、active pointer、job、trace、encrypted content、tombstone 与 migration journal。v161 新增 Memory 治理索引并迁移 job 状态。旧 confidence/expiry/staleness 明确保持 unknown；旧未审阅 procedural 进入 pending review。

...
pnpm start            # 启动 out/ 中的静态生产构建（构建后）
...
<Cards>
  <Card title="可观测性" href="../subsystems/observability" description="日志、追踪、Sentry 接线" />
  <Card title="shadcn/ui 接入" href="../ui/shadcn-ui-setup" description="57 个组件的工程约定" />
  <Card title="部署" href="./deployment" description="Web、桌面、文档站点的构建" />
  <Card title="架构" href="../core/architecture" description="所有约定背后的分层设计" />
</Cards>

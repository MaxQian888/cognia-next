...
<Callout type="info" title="ADRs">
  The four [Architecture Decision Records](../adr/0001-backup-schema-v3) are referenced from the
  relevant pages and explain **why** each subsystem looks the way it does.
</Callout>

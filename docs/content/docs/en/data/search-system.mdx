...
<Cards>
  <Card
    title="Storage"
    href="./storage"
    description="Where search settings live in the Dexie schema"
  />
  <Card
    title="Vector Store"
    href="./vector-store"
    description="Division of labor between vector retrieval and web search"
  />
  <Card
    title="Chat and Skills"
    href="./chat-and-skills"
    description="How the send path assembles search results"
  />
  <Card
    title="Document Processing"
    href="./document-processing"
    description="Local document parsing; complementary to web search"
  />
</Cards>

...
<Cards>
  <Card title="Chat & Skills" href="../chat/chat-and-skills" description="Exports come from chat sessions + messages" />
  <Card title="Backup & Data" href="./backup-and-data" description="Encrypted full-database snapshots use BackupPackageV3" />
  <Card title="Scheduler" href="../subsystems/scheduler" description="Batch exports can attach to scheduled tasks" />
</Cards>

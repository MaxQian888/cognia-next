...
<TLDR>
  ...
  [ADR-0018](../adr/0018-github-delivery).
</TLDR>
...
<Cards>
  <Card title="Setup & Credentials" href="./setup" description="GitHub App vs PAT, webhook URL via cloudflared, polling fallback, first-time plugin activation." />
  <Card title="Policy Reference" href="./policies" description="`GhPolicy` fields, decision paths for 6 action kinds, HITL branch, quiet-hours algorithm." />
  <Card title="13 action.github.* Nodes" href="./nodes" description="Parameter tables, output shapes, policy actions, error surfaces, Inspector examples." />
  <Card title="8 Built-in Templates" href="./templates" description="PR auto-review, Issue triage, Release suite (3 modes), CI failure diagnosis." />
  <Card title="Audit & Work Orders" href="./audit" description="`audit` schema, card fields, `workOrders` 6-column kanban, recent event stream." />
  <Card title="Usage & Quotas" href="./usage" description="Octokit throttling / retry, `GET /rate_limit` history, safe rate-limit recommendations." />
  <Card title="FAQ" href="./faq" description="Common errors, signature failures, App vs PAT, cloudflared troubleshooting, web-mode degradation." />
</Cards>
...
Per the ADR-0018 "plugin Dexie tables" convention, all tables are stored

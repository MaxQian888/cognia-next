...
<TypeTable
  type={{
    ...
    toolAllowList: {
      description: "Restrict tool calls to this allowlist (intersection if multiple skills set it).",
      type: "string[]",
    },
    resources: {
...
<Cards>
  <Card title="Sidecar & Claude SDK" href="./sidecar-and-claude-sdk" description="The Node host that handles claude_send." />
  <Card title="Employee Digital Twin" href="./employee-twin" description="The deepest character / send-time customisation surface." />
  <Card title="Plugin system" href="./plugin-system" description="How plugins extend skills / characters / MCP." />
  <Card title="Storage" href="./storage" description="The Dexie tables that back chat / characters / skills / teams." />
</Cards>

...
<Cards>
  <Card
    ...
    description="The user-facing surfaces that call claude_send."
  />
  <Card
    title="Plugin system"
    href="./plugin-system"
    description="How plugins extend the sidecar via MCP."
  />
  <Card
    title="Runtime & Tauri"
    href="./runtime-and-tauri"
    description="The Rust side that owns the sidecar lifecycle."
  />
</Cards>

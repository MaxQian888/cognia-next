...
<Files>
  ...
  <Folder name="UI + data">
    ...
    <File name="components/settings/sandbox/* — settings section (built but orphaned)" />
...
<Cards>
  ...
  <Card
    ...
    description="Composer shield, diagnostics audit cards, the orphaned settings section, onboarding"
  />
  <Card

...
that was never shipped and had no caller; it was removed. Running JS / TS / JSX / HTML / CSS in the
browser is `lib/native/code-execution-strategy.ts` (a `sandbox="allow-scripts"` `srcdoc` iframe),

...
<StatGrid>
  ...
  <Stat label="Default companion port" value="7890" hint="server.rs:51 — adjustable" />
...
| --- | --- | --- | --- | --- | --- |
| **Companion API** | `src-tauri/src/companion_api/` | `127.0.0.1` **or** `0.0.0.0` (toggle) + TLS | `7890` default | **device JWT** (HS256) | the mobile companion app |

...
(`lib/artifacts/reveal.ts:4`), triggered by `handleOpenInCanvas` on the chat artifact part
(`components/chat/message-parts/artifact-part.tsx:48`).
...
flowchart TB
  subgraph IN["Entry"]
    REVEAL["revealArtifactInWorkspace<br/>reveal.ts:4"]
  ...
  class SHELL,RAIL,PANEL,SIDE,REVEAL,EMPTY ui

...
<TLDR>
  ...
  `lib/plugin/core/context.ts:233`), by **declaring contributions** that ≈25 *bridges*
...
<StatGrid>
  ...
  <Stat label="Contribution bridges" value="~25" hint="lib/plugin/bridge/, dispatched by module-bridge-map" />
...
lib/plugin/
  ...
  bridge/        # ~25 bridges projecting plugin contributions into host subsystems
...
<Cards>
  ...
  <Card title="Contribution bridges" href="./bridges" description="~25 bridges projecting manifest/SDK contributions into chat, themes, fonts, Monaco, connectors, workflows; the module-bridge-map dispatch loop; kind-prefix namespacing" />

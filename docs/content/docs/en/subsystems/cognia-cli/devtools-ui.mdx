...
generation increased, and artifact revision matches the Rust-installed artifact. Activity,
attempt diagnostics, and structured runtime logs share that session/attempt identity. Advanced
diagnostics contains the implemented lifecycle, trigger-audit, and extension-point surfaces; the
old Hook/Profiler/Bus tabs are not part of the Dev Session flow.

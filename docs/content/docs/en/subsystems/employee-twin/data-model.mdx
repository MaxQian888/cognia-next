...
| --- | --- | --- |
| **Sources** | `TwinSource` (L64), `TwinSourceKind` (L28), `TwinSourceFormat` (L34), `TwinSourceStatus` (L62) | Registry of every raw artifact ingested. 22 formats across document / chat / email / code families. |
...
- **Document** → `markdown · pdf · docx · xlsx · pptx · odt · odp · html · csv · epub · rtf · code` (routed to `lib/document/document-processor`; `xlsx` also covers `.xls/.xlsm/.ods` spreadsheets).

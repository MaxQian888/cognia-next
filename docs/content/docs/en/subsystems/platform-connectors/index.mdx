...
<Cards>
  ...
  <Card title="Rust Layer" href="./rust-layer" description="The axum webhook receiver, the 5 signature verifiers, the OneBot reverse-WS bridge, the Lark protobuf long-connection, the AES-256-GCM attachment cache, the OS keyring, the 18 Tauri commands" />

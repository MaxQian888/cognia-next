...
<Status variant="stable">22 authenticated loopback routes · two CLI consumers · bidirectional transcript handoff</Status>
...
<TLDR>
  ...
  `cli-endpoint.json`, but they consume different parts of one 22-route loopback server. The
...
flowchart LR
  ...
  HTTP["cli_bridge<br/>127.0.0.1:ephemeral<br/>22 /api/dev routes"]
...
<Cards>
  <Card title="Transport and security" href="./transport-and-security" description="Endpoint discovery, all 22 routes, authentication, consumer ownership, and renderer request/response flow." />

...
<Cards>
  <Card title="Runtime & Tauri" href="./runtime-and-tauri" description="How the IPC bridge actually works in practice." />
  <Card title="Sidecar & Claude Agent SDK" href="./sidecar-and-claude-sdk" description="The JSON-lines protocol over stdio." />
  <Card title="Storage" href="./storage" description="Dexie schema v15 in detail." />
  <Card title="Plugin system" href="./plugin-system" description="The sandbox + permissions model." />
</Cards>

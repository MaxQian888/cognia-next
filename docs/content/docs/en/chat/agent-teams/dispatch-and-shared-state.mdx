...
<TLDR>
- One dispatch primitive: `dispatchTeammate` (`lib/ai/agent/team/teammate/dispatch-teammate.ts:171-344`) — shared by the task executor and every ultracode pattern via `dispatchStructured`.
...
<Status status="stable">lib/ai/agent/team/teammate/dispatch-teammate.ts:1-345</Status>
...
```typescript
// lib/ai/agent/team/teammate/dispatch-teammate.ts:218-225
const timeoutMs =
  args.timeoutMs ??
...
```typescript
// lib/ai/agent/team/teammate/dispatch-teammate.ts:299-321
...
```typescript
// lib/ai/agent/team/teammate/dispatch-teammate.ts:323-334
...
<Status status="stable">lib/ai/agent/team/teammate/teammate-pool.ts:1-260</Status>
...
```typescript
// lib/ai/agent/team/teammate/teammate-pool.ts:81-90
...
```typescript
// lib/ai/agent/team/teammate/teammate-pool.ts:191-219
...
<Status status="stable">lib/ai/agent/team/gates/budget-guard.ts:1-172</Status>
...
```typescript
// lib/ai/agent/team/gates/budget-guard.ts:97-131
...
<Status status="stable">lib/ai/agent/team/teammate/structured-dispatch.ts:1-83</Status>
...
```typescript
// lib/ai/agent/team/teammate/structured-dispatch.ts:50-81

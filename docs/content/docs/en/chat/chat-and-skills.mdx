...
- [Employee Digital Twin](../subsystems/employee-twin) — the deepest customisation surface.
- [Plugin system](../subsystems/plugin-system) — how plugins extend skills/characters/MCP.

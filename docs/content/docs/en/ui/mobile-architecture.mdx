...
<Callout type="info">
  This page corresponds to ADRs: [0014 — Capacitor Mobile Shell](../adr/0014-capacitor-mobile-shell), [0015 — Mobile V2 Completion](../adr/0015-mobile-v2-completion), [0012 — Transport Abstraction](../adr/0012-transport-abstraction), [0013 — Command Manifest](../adr/0013-command-manifest).
</Callout>
...
- **Gestures**: `components/mobile/interactions/` — `LongPress`, `PullToRefresh`, `SwipeRow`, all using the same pointer polyfill.

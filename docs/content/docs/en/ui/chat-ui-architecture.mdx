...
<Cards>
  ...
  <Card
    ...
    description="oklch tokens + next-intl translations"
  />
  <Card
    title="shadcn/ui Setup"
    href="./shadcn-ui-setup"
    description="All UI primitives used on this page"
  />
  <Card
    title="Canvas"
    href="./canvas"
    description="Target page for Artifact 'open' state navigation"
  />
  <Card

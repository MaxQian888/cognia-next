...
<Cards>
  ...
  <Card
    title="Skills System"
    href="./skills-system"
    description="Skill library management under ?section=skills"
  />
  <Card
    title="Character Management"
    href="./chat-and-skills"
    description="Character editing under ?section=characters"
  />
  <Card
    title="MCP Servers"
  ...
  <Card
    title="Plugin System"
    href="./plugin-system"
    description="Local plugin installation under ?section=plugins"
  />
  <Card
    title="Scheduler"
    href="./scheduler"
    description="Cron and history under ?section=scheduled-tasks"
  />
  <Card
  ...
  <Card
    ...
    href="./remote-control"
    description="Device linking under ?section=remote-control"
  />
  <Card
    title="Companion API"
    href="./companion-api"

...
<Cards>
  ...
  <Card title="WebRTC transport" href="./webrtc-transport" description="The single ECDSA/ECDH/AES-GCM signaling client, bounded DataChannel offerer, recovery controls, and Cloudflare Durable-Object rendezvous (ADR-0021)." />
</Cards>
...
fingerprint, a room descriptor, a separate signaling key, and a local Dexie cache — nothing more. It cannot run the agent

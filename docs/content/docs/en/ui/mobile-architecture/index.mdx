...
<Cards>
  ...
  <Card title="WebRTC transport" href="./webrtc-transport" description="The TS envelope twin (HMAC + canonical JSON + replay), the SignalingClient, the offerer role, the mobile/desktop controllers, and the Cloudflare-Worker rendezvous server with its Durable-Object rooms (ADR-0021)." />
</Cards>
...
fingerprint, a `rendezvousSecret`, and a local Dexie cache — nothing more. It cannot run the agent

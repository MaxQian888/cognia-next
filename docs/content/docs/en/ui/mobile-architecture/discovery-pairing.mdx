...
<StatGrid>
  ...
  <Stat label="Probe ports" value="7890·7891·7900·8443" hint="lan-scanner.ts:119" />
...
the TLS fingerprint via `healthz`. Default port `7890` (`:110`); the extra ports `[7890, 7891, 7900,

---
title: "ADR-0114: Unified Memory and RAG Infrastructure"
...
# ADR-0114: Unified Memory and RAG Infrastructure
...
Dexie v160 adds profiles, generations, active pointers, jobs, traces, encrypted content, tombstones, and a migration journal. Dexie v161 adds Memory governance indexes and migrates the job state model. Legacy confidence/expiry/staleness remains explicitly unknown. Legacy unreviewed procedural content becomes pending review.

...
async fn main() -> anyhow::Result<()> {
    ...
    if config.run_migrations {
        ...
        // Said out loud because "the schema is missing" and "I was told not to
        // create it" produce the same downstream errors otherwise.
        tracing::info!("DIAGNOSTIC_RUN_MIGRATIONS is off — assuming the schema is already applied");
    }
